...
CARGO_OPTIONAL=1
inherit cargo cflags-hardened chkl flag-o-matic toolchain-funcs perl-module shell-completion
inherit optfeature plocale python-single-r1 secure-version systemd meson
