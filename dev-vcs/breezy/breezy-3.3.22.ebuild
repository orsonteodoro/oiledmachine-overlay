...
# Generated by "convert-cargo-lock.sh 3.3.22 3.3.22"
CRATES="
aho-corasick-1.1.4
heck-0.5.0
lazy_static-1.5.0
...
SLOT="0"
IUSE+="
cext dev developer-docs doc fastimport git github launchpad paramiko pgp subunit
...
# * malloc(8192)
#
		sandbox-changes_no_usersandbox "To run tests with USE=paramiko"
	fi
	rust_pkg_setup
}
...
# USE="paramiko test -cext (-debug) -developer-docs -doc -fastimport -git -github
# -gpg -launchpad -ebuild_revision_1 -user-docs -workspace" PYTHON_TARGETS="python3_10
# -python3_11"
#
