...
DESCRIPTION="CMaNGOS Classic database for the Classic (Vanilla) Client"
HOMEPAGE="https://github.com/cmangos/classic-db"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
RDEPEND="
...
src_unpack() {
	...
	EGIT_REPO_URI="https://github.com/cmangos/classic-db.git"
	EGIT_BRANCH="master"
	EGIT_COMMIT="f0b7781eddcdc6e91811c82bbd0f0fdbe5a7b14f"
	git-r3_fetch
	git-r3_checkout
}
