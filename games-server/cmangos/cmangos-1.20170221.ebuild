...
src_unpack() {
	...
	EGIT_BRANCH="master"
	EGIT_COMMIT="a7a13b37a2692d1f06e5392a99879c556ad4cfbd"
	git-r3_fetch
	git-r3_checkout
	...
	if use sd2; then
		...
		EGIT_BRANCH="master"
		EGIT_COMMIT="fa5d683ca94a29993f8daaf001c02e8625e9dfb7"
		git-r3_fetch
		git-r3_checkout
	fi
	if use eluna; then
		...
		EGIT_BRANCH="master"
		EGIT_COMMIT="a5bbed301f56f7eab7b0479b4d2d84c495f57206"
		git-r3_fetch
		git-r3_checkout
	fi
}
