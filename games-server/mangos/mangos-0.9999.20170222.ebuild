...
src_unpack() {
	...
	EGIT_BRANCH="master"
	EGIT_COMMIT="c677a4872a3c4eb04422685cf97189c6ad0a6c6c"
	git-r3_fetch
	git-r3_checkout
}
...
src_prepare() {
	...
	epatch "${FILESDIR}/mangos-0.9999.20170222-singleton-header.patch"
	epatch "${FILESDIR}/mangos-0.9999.20170222-missing-headers-1.patch"
	epatch "${FILESDIR}/mangos-0.9999.20170222-map-header.patch"
