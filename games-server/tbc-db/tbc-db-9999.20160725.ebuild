...
src_unpack() {
	...
	EGIT_BRANCH="master"
	EGIT_COMMIT="a38dbd07f5ee604162507119b6c890dac5d01e05"
	git-r3_fetch
	git-r3_checkout
}
...
src_install() {
	...
	cp "${FILESDIR}/existinginstall-1-from-1.4.2.003-to-${PV}-tbcdb.sh" "${D}/usr/share/cmangos/1"
	...
	fperms 0755 "/usr/share/cmangos/1/existinginstall-1-from-1.4.2.003-to-${PV}-tbcdb.sh"
}
...
pkg_postinst() {
	...
	einfo ""
	einfo "If you installed tbc-db-9999.20140928.ebuild, consider existinginstall-1-from-1.4.2.003-to-1.5.0.105-tbcdb.sh for quick update."
}
