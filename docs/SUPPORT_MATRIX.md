...
| LTS [10]                 | gnu++17        | gnu++17          | gnu17        | gnu17          | 12          | 22 [4]        | gcc_slot_11_5, llvm_slot_22 [10]     | U22                     | SIMD, CUDA 13.4, ROCm 7.2, Vulkan                                       |
...
| LTS [11]                 | gnu++17        | gnu++17          | gnu17        | gnu17          | 13          | 19 [4]        | gcc_slot_13_4, llvm_slot_19 [11][1]  | U24                     | SIMD, CUDA 12.8, CUDA 12.9, Vulkan                                      |
| LTS [10]                 | gnu++17        | gnu++17          | gnu17        | gnu17          | 13          | 22 [4]        | gcc_slot_13_4, llvm_slot_22 [10][12] | U24                     | SIMD, CUDA 13.4, ROCm 7.2, Vulkan                                       |
...
| ---                                                                                      | ---                                                             | ---                                                                                                                                                |
| Security code audit refusal (human, AI, algorithmic code scanner)                        | Hard mask or ebuild removal                                     | Possibly threat actor involvement/evasion or contain a state level 0-day (e.g. Vault 7 or equivalent) or criminal malware |
| AI [security audit] refusal with no commit history of security fixes in memory unsafe language with at risk use cases | Hard mask or ebuild removal        | Unaudited, may contain at worst malicious code or a state level 0-day (e.g. Vault 7 or equivalent)                                                 |
| Projects with commit messages/code not in English                                        | Ebuild removal                                                  | Difficult to security audit or fix                                                                                                                 |
| Projects without commit messages                                                         | Ebuild removal                                                  | Difficult to security audit, determine, or verify if the release is secure independently and if effort is made by upstream to secure their product |
| Projects with weak/opposite/dodging remediation                                          | Package hard mask, USE flag mask, security warnings, or removal | High cost/risk if exploited, same inappropriate security policy in different parts of the code                                                     |
| Projects associated with the military industrial complex                                 | Security warnings or removal                                    | May contain state level threat actor(s) or at worst spyware/malware/backdoor or used as an decentralized attack primitive                          |
