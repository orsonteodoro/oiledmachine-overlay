...
| ---                                                                                      | ---                                                             | ---                                                                                            |
| Security code audit refusal (human, AI, algorithmic code scanner)                        | Hard mask or ebuild removal                                     | Possibly threat actor involvement, threat actor or security review evasion                     |
| AI [security audit] refusal with no commit history of security fixes in memory unsafe language with at risk use cases | Hard mask or ebuild removal                              | Unaudited, may contain at worst malicious code                                                 |
| Projects with commit messages/code not in English                                        | Ebuild removal                                                  | Difficult to security audit or fix issues                                                      |
| Projects without commit messages                                                         | Ebuild removal                                                  | Difficult to security audit, determine or verify if the release is secure independently if effort is made by upstream to secure their product                |
