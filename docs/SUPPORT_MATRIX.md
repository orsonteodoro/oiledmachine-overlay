...
| AI [security audit] refusal with no commit history of security fixes in memory unsafe language  | Hard mask or ebuild removal                              | Unaudited, may contain at worst malicious code                                                 |
