...
| Lib A (C++26, GCC16) depends on Lib B (C++17, GCC13)                 | Y        | The depender library A meets the >= C++ version of the dependee B library.  A rolling lib can link to LTS libs, but typically not in the opposite direction. | Hyprland libraries (e.g. hyprgraphics)         |
