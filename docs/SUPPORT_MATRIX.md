...
| ---                                                                                      | ---                                                             | ---                                                                                                   |
| Security code audit refusal (human, AI, algorithmic code scanner)                        | Hard mask or ebuild removal                                     | Possibly threat actor involvement/evasion or contain a state level 0-day (e.g. Vault 7 or equivalent) |
