...
| Low level vulnerabilities monitored                           | Double free, deadlock, heap overflow, integer overflow, memory leak, miscompilation, null pointer dereference, ROP gadgets, speculative execution, stack overflow, string format, uninitialized memory, use-after-free, type confusion |
