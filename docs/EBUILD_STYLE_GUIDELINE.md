...
| Default symmetric stream                                      | Post-quantum AES-256 (GCM/CTR); followed by legacy AES-128 (GCM/CTR)                                                      |
| Acceptable symmetric stream                                   | Post-quantum AES-256 (GCM/CTR), Chacha20 (256-bit); followed by legacy AES-128 (GCM, desktop), Chacha20 (256-bit, mobile) |
