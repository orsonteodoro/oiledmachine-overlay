...
| High level vulnerabilities monitored                          | Container/sandbox escapes, inappropriate configuration, inappropriate file permissions, prototype pollution, injection, TOCTOU, unsanitized input, unseen/zero-day, zero-click |
