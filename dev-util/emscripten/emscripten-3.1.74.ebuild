...
# https://github.com/emscripten-core/emscripten/blob/3.1.74/tools/config_template.py

# TC = toolchain
BINARYEN_SLOT="119" # Consider using Binaryen as part of SLOT_MAJOR for ABI/TC compatibility.
...
# Chrome min version:  https://github.com/emscripten-core/emscripten/blob/3.1.74/src/settings.js#L1904
# Firefox min version:  https://github.com/emscripten-core/emscripten/blob/3.1.74/src/settings.js#L1878
# Safari min version:  https://github.com/emscripten-core/emscripten/blob/3.1.74/src/settings.js#L1893
...
# See also https://github.com/emscripten-core/emscripten/blob/3.1.74/site/source/docs/building_from_source/toolchain_what_is_needed.rst
# For the required Binaryen, see also https://github.com/emscripten-core/emscripten/blob/3.1.74/tools/building.py#L41 EXPECTED_BINARYEN_VERSION
# For the required closure-compiler, see https://github.com/emscripten-core/emscripten/blob/3.1.74/package.json
...
# For the required LLVM, see https://github.com/emscripten-core/emscripten/blob/3.1.74/tools/shared.py#L50
# For the required Node.js, see https://github.com/emscripten-core/emscripten/blob/3.1.74/tools/shared.py#L43
RDEPEND+="
	${PYTHON_DEPS}
...
#	"${DISTDIR}/emscripten-commit-72dd53c.patch"
	"${FILESDIR}/${PN}-3.1.74-set-wrappers-path.patch"
...
# https://github.com/emscripten-core/emsdk/blob/3.1.74/emsdk_manifest.json
