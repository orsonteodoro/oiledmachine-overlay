...
# https://github.com/emscripten-core/emscripten/blob/3.1.4/package.json

# Keep emscripten.config.x.yy.zz updated if changed from:
# https://github.com/emscripten-core/emscripten/blob/3.1.4/tools/config_template.py
...
# See also https://github.com/emscripten-core/emscripten/blob/3.1.4/tools/building.py EXPECTED_BINARYEN_VERSION
...
# For the required closure-compiler, see https://github.com/emscripten-core/emscripten/blob/3.1.4/package.json
# For the required LLVM, see https://github.com/emscripten-core/emscripten/blob/3.1.4/tools/shared.py#L50
# For the required Node.js, see https://github.com/emscripten-core/emscripten/blob/3.1.4/tools/shared.py#L43
BINARYEN_V="104"
JDK_DEPEND="
|| (
