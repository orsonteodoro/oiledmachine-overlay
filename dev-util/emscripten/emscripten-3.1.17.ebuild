...
# TC = toolchain
BINARYEN_SLOT="109" # Consider using Binaryen as part of SLOT_MAJOR for ABI/TC compatibility.
...
# See also
# https://github.com/emscripten-core/emsdk/blob/3.1.17/.circleci/config.yml#L24
# https://github.com/emscripten-core/emsdk/blob/3.1.17/emsdk#L11
# https://github.com/emscripten-core/emsdk/blob/3.1.17/scripts/update_python.py#L34
# https://github.com/emscripten-core/emscripten/blob/3.1.17/requirements-dev.txt
# flake8 (3.7.8) - <= 3.7
...
# See also https://github.com/emscripten-core/emscripten/blob/3.1.17/site/source/docs/building_from_source/toolchain_what_is_needed.rst
# For the required Binaryen, see also https://github.com/emscripten-core/emscripten/blob/3.1.17/tools/building.py#L41 EXPECTED_BINARYEN_VERSION
# For the required closure-compiler, see https://github.com/emscripten-core/emscripten/blob/3.1.17/package.json
# For the required closure-compiler-nodejs node version, see https://github.com/google/closure-compiler/blob/v20220502/.github/workflows/ci.yaml#L43
...
# https://github.com/emscripten-core/emsdk/blob/3.1.17/emsdk_manifest.json
...
# OILEDMACHINE-OVERLAY-TEST:  passed (3.1.17)
