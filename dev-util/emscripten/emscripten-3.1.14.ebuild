...
# https://github.com/emscripten-core/emscripten/blob/3.1.14/site/source/docs/building_from_source/toolchain_what_is_needed.rst

# For the closure-compiler-npm version see:
# https://github.com/emscripten-core/emscripten/blob/3.1.14/package.json

# Keep emscripten.config.x.yy.zz updated if changed from:
# https://github.com/emscripten-core/emscripten/blob/3.1.14/tools/config_template.py
...
# See also https://github.com/emscripten-core/emscripten/blob/3.1.14/tools/building.py EXPECTED_BINARYEN_VERSION
...
# For the required closure-compiler, see https://github.com/emscripten-core/emscripten/blob/3.1.14/package.json
# For the required LLVM, see https://github.com/emscripten-core/emscripten/blob/3.1.14/tools/shared.py#L50
# For the required Node.js, see https://github.com/emscripten-core/emscripten/blob/3.1.14/tools/shared.py#L43
BINARYEN_V="109"
JDK_DEPEND="
|| (
