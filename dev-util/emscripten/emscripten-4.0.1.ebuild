...
# Chrome min version:  https://github.com/emscripten-core/emscripten/blob/4.0.1/src/settings.js#L1904
# Firefox min version:  https://github.com/emscripten-core/emscripten/blob/4.0.1/src/settings.js#L1878
# Safari min version:  https://github.com/emscripten-core/emscripten/blob/4.0.1/src/settings.js#L1893
...
#	"${DISTDIR}/emscripten-commit-72dd53c.patch"
	...
	"${FILESDIR}/${PN}-4.0.11-endian.patch"
)
