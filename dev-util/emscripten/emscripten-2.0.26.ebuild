...
# See also
# https://github.com/emscripten-core/emsdk/blob/2.0.26/.circleci/config.yml#L24
# https://github.com/emscripten-core/emsdk/blob/2.0.26/emsdk#L11
# https://github.com/emscripten-core/emsdk/blob/2.0.26/scripts/update_python.py#L34
# https://github.com/emscripten-core/emscripten/blob/2.0.26/requirements-dev.txt
# flake8 (3.7.8) - <= 3.7
...
# See also https://github.com/emscripten-core/emscripten/blob/2.0.26/site/source/docs/building_from_source/toolchain_what_is_needed.rst
...
# For the required closure-compiler-nodejs node version, see https://github.com/google/closure-compiler-npm/blob/v20210601.0.0/packages/google-closure-compiler/package.json
...
RDEPEND+="
	...
	closure-compiler? (
		>=dev-util/closure-compiler-npm-20210601.0.0:${CLOSURE_COMPILER_SLOT}[closure_compiler_java?,closure_compiler_native?,closure_compiler_nodejs?]
		closure_compiler_java? (
...
# https://github.com/emscripten-core/emsdk/blob/2.0.26/emsdk_manifest.json
