...
# See also
# https://github.com/emscripten-core/emsdk/blob/1.40.1/.circleci/config.yml#L24
# https://github.com/emscripten-core/emsdk/blob/1.40.1/emsdk#L11
# https://github.com/emscripten-core/emsdk/blob/1.40.1/scripts/update_python.py#L34
# https://github.com/emscripten-core/emscripten/blob/1.40.1/third_party/websockify/setup.py
# flake8 (3.7.8) - <= 3.7
...
RDEPEND+="
	...
	closure-compiler? (
		>=dev-util/closure-compiler-npm-20200224.0.0:${CLOSURE_COMPILER_SLOT}[closure_compiler_java?,closure_compiler_native?,closure_compiler_nodejs?]
		closure_compiler_java? (
