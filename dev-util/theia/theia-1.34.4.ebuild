...
# Initially generated from:  grep "resolved" /var/tmp/portage/dev-util/theia-1.34.4/work/theia-1.34.4/yarn.lock | cut -f 2 -d '"' | cut -f 1 -d "#" | sort | uniq
...
pkg_setup() {
ewarn
ewarn "Ebuild under maintenance."
ewarn "Testing for Yarn offline install conversion."
ewarn
die
