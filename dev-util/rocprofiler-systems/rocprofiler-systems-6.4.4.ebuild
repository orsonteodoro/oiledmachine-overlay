...
DYNINST_COMMIT_1="09e781d414c83b4ad587083d449a3e976546937d"
DYNINST_COMMIT_2="076d8bdef4f22639d16ca65cda9b909b6c726047" # timemory dep
DYNINST_TESTSUITE_COMMIT_1="e897b878d98db08019eb5a79d0241215a223f5cf" # dyninst (1) dep, committer-date:<=2025-03-28
...
ROCM_VERSION="${PV}"
LEGACY_TBB_SLOT=2
TIMEMORY_COMMIT="fad254dde56e6d6deb6f9a643000ab678726db30"
...
https://github.com/dyninst/testsuite/archive/${DYNINST_TESTSUITE_COMMIT_1}.tar.gz
	-> dyninst-testsuite-${DYNINST_TESTSUITE_COMMIT_1:0:7}.tar.gz
...
src_unpack() {
	...
	dep_prepare_cp "${WORKDIR}/testsuite-${DYNINST_TESTSUITE_COMMIT_1}" "${S}/external/dyninst/testsuite"
