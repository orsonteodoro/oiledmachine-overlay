...
inherit bash-completion-r1 estack flag-o-matic libcxx-slot libstdcxx-slot linux-info llvm-r1 toolchain-funcs python-single-r1
...
RDEPEND="
	...
	systemtap? ( dev-debug/systemtap[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP}] )
	tcmalloc? ( dev-util/google-perftools[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP}] )
