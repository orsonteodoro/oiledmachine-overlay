...
# Prevent:
# ld.bfd: /opt/rocm-6.0.2/lib/libhsa-runtime64.so: undefined reference to `hsaKmtGetAMDGPUDeviceHandle'
...
# ld.bfd: /usr/lib/gcc/x86_64-pc-linux-gnu/12/../../../../lib64/libyaml-cpp.so: undefined reference to `std::ios_base_library_init()@GLIBCXX_3.4.32'
	check_pkg_glibcxx "dev-cpp/yaml-cpp" "/usr/$(get_libdir)/libyaml-cpp.so" "${HIP_6_0_GCC_SLOT}"
