...
# https://github.com/ROCm-Developer-Tools/HIPIFY/blob/rocm-5.7.0/docs/hipify-clang.md#hipify-clang-dependencies
TEST_BDEPEND="
	|| (
		(
			...
			|| (
				...
				$(gen_llvm_rdepend 16.0.6)
				$(gen_llvm_rdepend 16.0.5)
				$(gen_llvm_rdepend 16.0.4)
...
PATCHES=(
	...
	"${FILESDIR}/HIPIFY-5.7.0-path-changes.patch"
