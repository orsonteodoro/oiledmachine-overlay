...
[tauri-plugin-deep-link]="plugins-workspace-%commit%/plugins/deep-link" # 0.0.0
[tauri-plugin-positioner]="plugins-workspace-%commit%/plugins/positioner" # 0.0.0
...
main() {
	...
	echo "Non-live:"
	echo
	echo -e "${s_nlive}" | sort | sed -e "/^gitlight-/d"
