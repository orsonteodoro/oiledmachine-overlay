...
# @ECLASS: ot-kernel-v6.12.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 6.12.x kernel
# @DESCRIPTION:
# The ot-kernel-v6.12 eclass defines specific applicable patching for the 6.12.x
# linux kernel.
...
# For *DEPENDs, see
# https://github.com/torvalds/linux/blob/v6.12/Documentation/process/changes.rst
# For compiler versions, see
# https://github.com/torvalds/linux/blob/v6.12/scripts/min-tool-version.sh#L26
...
# Using -r1 in ot-sources-6.12.1-r1.ebuild is not allowed.
# Using _p20260704 in ot-sources-6.12.1_p20260704.ebuild is not allowed.
...
if [[ "${PV}" =~ "_rc" ]] ; then
	# ot-sources-6.12_rc1.ebuild
	RC_PV=$(ver_cut 4 "${PV}")
	MY_PV="${KV_MAJOR_MINOR}_${RC_PV}"		# 6.12_rc1
	UPSTREAM_PV="${KV_MAJOR_MINOR}-${RC_PV}"	# 6.12-rc1
else
	# ot-sources-6.12.9999.ebuild
	# ot-sources-6.12.ebuild
	# ot-sources-6.12.1.ebuild
	RC_PV=""
	MY_PV="${PV}" #					# 6.12, 6.12.1, 6.12.9999
	UPSTREAM_PV="${PV}"				# 6.12, 6.12.1, 6.12.9999
fi
...
1ec451a4bbac7cc00b59f8ca504d6a8898615880
bd350950a2ebcba4afdfc8970a6747a3dd9f603b
856c3874536c066b0f02b38b24092610692959ff
a31b09c511dd58e5032a3c941638207281b20ce4
)
...
ewarn
ewarn "Upstream security update delay from live:  6-11 days"
