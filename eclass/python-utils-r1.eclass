			...
			case ${i} in
				...
				*)
					...
					then
						...
						# This section was modified by oiledmachine-overlay.
						eerror "Invalid implementation in PYTHON_COMPAT: ${i}"
						eerror "Set PYTHON_COMPAT_NO_STRICT=1 in /etc/portage/make.conf to continue."
						die
					fi
			esac
		done
