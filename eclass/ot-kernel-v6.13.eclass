...
# @ECLASS: ot-kernel-v6.13.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 6.13.x kernel
# @DESCRIPTION:
# The ot-kernel-v6.13 eclass defines specific applicable patching for the 6.13.x
# linux kernel.
...
# For *DEPENDs, see
# https://github.com/torvalds/linux/blob/v6.13/Documentation/process/changes.rst
# For compiler versions, see
# https://github.com/torvalds/linux/blob/v6.13/scripts/min-tool-version.sh#L26
...
CXX_STD="-std=gnu++14" # See https://github.com/torvalds/linux/blob/v6.13/tools/build/feature/Makefile#L331
