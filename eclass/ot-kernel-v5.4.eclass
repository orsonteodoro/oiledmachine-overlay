...
# See
# https://github.com/torvalds/linux/blob/v5.4/tools/build/feature/Makefile#L318
# https://github.com/torvalds/linux/blob/v5.4/tools/perf/Makefile.config#L276
# https://github.com/torvalds/linux/blob/v5.4/scripts/kconfig/qconf-cfg.sh
...
GCC_MAX_SLOT="14"
GCC_MIN_SLOT="11"
GCC_SLOT_NOT_KCP=( ${GCC_COMPAT2[@]} ) # Without kernel-compiler-patch
GCC_SLOT_KCP="${GCC_COMPAT2[0]}" # With kernel-compiler-patch
