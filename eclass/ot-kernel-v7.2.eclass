...
# @ECLASS: ot-kernel-v7.2.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 7.2.x kernel
# @DESCRIPTION:
# The ot-kernel-v7.2 eclass defines specific applicable patching for the 7.2.x
# linux kernel.
...
# https://github.com/torvalds/linux/blob/v7.2/scripts/min-tool-version.sh#L26
...
# Using -r1 in ot-sources-7.2.1-r1.ebuild is not allowed.
# Using _p20260704 in ot-sources-7.2.1_p20260704.ebuild is not allowed.
...
if [[ "${PV}" =~ "_rc" ]] ; then
	# ot-sources-7.2_rc1.ebuild
	RC_PV=$(ver_cut 4 "${PV}")
	MY_PV="${KV_MAJOR_MINOR}_${RC_PV}"		# 7.2_rc1
	UPSTREAM_PV="${KV_MAJOR_MINOR}-${RC_PV}"	# 7.2-rc1
else
	# ot-sources-7.2.9999.ebuild
	# ot-sources-7.2.ebuild
	# ot-sources-7.2.1.ebuild
	RC_PV=""
	MY_PV="${PV}" #					# 7.2, 7.2.1, 7.2.9999
	UPSTREAM_PV="${PV}"				# 7.2, 7.2.1, 7.2.9999
fi
...
# See
# https://github.com/torvalds/linux/blob/v7.2/tools/build/feature/Makefile#L331
# https://github.com/torvalds/linux/blob/v7.2/tools/perf/Makefile.config#L276
# https://github.com/torvalds/linux/blob/v7.2/scripts/kconfig/qconf-cfg.sh
...
# From https://github.com/torvalds/linux/compare/v7.2...zen-kernel:zen-kernel:7.2/zen-sauce
#
# Generated from:
...
# clang is default OFF based on https://github.com/torvalds/linux/blob/v7.2/Documentation/process/changes.rst
