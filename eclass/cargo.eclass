...
#	[<crate_name>]="<project_uri>;<commit-id>;<project-name>-<commit-id>"					# oiledmachine-overlay documentation
...
# @CODE
# declare -A GIT_CRATES=(
#	[<crate_name>]="<project_uri>;<commit-id>;<project-name>-<commit-id>/<crate-subdir>"			# oiledmachine-overlay documentation
...
# @CODE
# declare -A GIT_CRATES=(
#	[<crate_name>]="<project_uri>;<commit-id>;<project-name>-<commit-id>/<crate-subdir>;<host>"		# oiledmachine-overlay documentation
