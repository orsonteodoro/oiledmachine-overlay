...
# oiledmachine-overlay:  support https://gitlab.freedesktop.org for GIT_CRATES
	...
	if [[ ${git_crates_type} == "declare -A "* ]]; then
		...
		for crate in "${!GIT_CRATES[@]}"; do
			...
			case "${crate_uri}" in
				...
				;;
				https://gitlab.com/*|https://gitlab.freedesktop.org/*) # oiledmachine-overlay:  added gitlab.freedesktop.org
					repo_ext=".gl"
					repo_name="${crate_uri##*/}"
