...
KERNEL_RELEASE_DATE="20240724" # of first stable release
...
# clang is default OFF based on https://github.com/torvalds/linux/blob/v6.10/Documentation/process/changes.rst
