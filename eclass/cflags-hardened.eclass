...
inherit flag-o-matic toolchain-funcs verify-binutils
...
# sensitive-data
# server
# system-set (e.g. toolchain/login only packages in `emerge -pve @system`)
...
eerror
eerror "Set CFLAGS_HARDENED_SANITIZER_CC_NAME in /etc/portage/make.conf to"
eerror "either gcc or clang.  CFLAGS_HARDENED_SANITIZER_CC_NAME should be the"
...
eerror
eerror "Set CFLAGS_HARDENED_SANITIZER_CC_SLOT in /etc/portage/make.conf to one"
...
eerror "  CFLAGS_HARDENED_SANITIZER_CC_SLOT should be the same as"
