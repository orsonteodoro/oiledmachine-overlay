...
eerror "CFLAGS_HARDENED_SANITIZER_CC_NAME should be the same as DETECT_COMPILER_LTO_CC_NAME."
			die
		fi
...
eerror "CFLAGS_HARDENED_SANITIZER_CC_SLOT should be the same as DETECT_COMPILER_LTO_CC_SLOT."
			die
		fi
	fi
