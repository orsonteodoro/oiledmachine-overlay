...
# Using -r1 in ot-sources-6.18.1-r1.ebuild is not allowed.
# Using _p20260704 in ot-sources-6.18.1_p20260704.ebuild is not allowed.
...
if [[ "${PV}" =~ "_rc" ]] ; then
	# ot-sources-6.18_rc1.ebuild
	RC_PV=$(ver_cut 4 "${PV}")
	MY_PV="${KV_MAJOR_MINOR}_${RC_PV}"		# 6.18_rc1
	UPSTREAM_PV="${KV_MAJOR_MINOR}-${RC_PV}"	# 6.18-rc1
else
	# ot-sources-6.18.9999.ebuild
	# ot-sources-6.18.ebuild
	# ot-sources-6.18.1.ebuild
	RC_PV=""
	MY_PV="${PV}" #					# 6.18, 6.18.1, 6.18.9999
	UPSTREAM_PV="${PV}"				# 6.18, 6.18.1, 6.18.9999
fi
...
# https://elixir.bootlin.com/linux/v6.18.37/source/drivers/gpu/drm/amd/display/include/dal_types.h	DCN 4.0.1
# https://elixir.bootlin.com/linux/v6.18.37/source/drivers/gpu/drm/amd/amdgpu/amdgpu_vcn.c		VCN 5.0.1
# https://elixir.bootlin.com/linux/v6.18.37/source/drivers/gpu/drm/amd/amdgpu/gfx_v12_0.c		the last gfx version for gc_12_0_1 and others with .bin reference
...
ATH_FIRMWARE_RELEASE_DATE="20241010" # Based on presence of firmware-2.bin (QCN9274) file in https://github.com/torvalds/linux/blob/v6.18/drivers/net/wireless/ath/ath12k/hw.c
...
PATCH_ALLOW_O3_COMMIT="cd32ade31c0d6aa492e3af6249fa039521129a0d" # id from zen repo
...
PATCH_ZEN_SAUCE_BRANDING="963f039d266fb2d43626565b06ceb39690640095" # id from zen repo
...
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
963f039d266fb2d43626565b06ceb39690640095
64164f0372696265baef02378f2ce21a82a6c8ab
f1c5e9ab5887817c4ebd87a69d851953dd720c38
dbc40c577cbb482c1d5c92d97724a026113e4526
cd32ade31c0d6aa492e3af6249fa039521129a0d
eb68d2d67da641462df6344a9de5231a5db8956d
90e105d958b93d40324f13fec56a2e6051aad27e
39225a3130e280dcb47ea12877e95eb869c64e33
2a1c1620255001ad54205564e6104b7f3d79f058
f74d8d4853ac2ef38b916e6e96788296bde7f038
32af6da533c77f4310e477c3ee66646dd03cb4ad
6005dfdd28a5f80fe376324083e40cd18bac7cc2
0fefcdee661d3eb420f232311124d7f85f663a16
8714845a2b1b5f4398525048261e58cf3f87cf39
4ad8255385967917c640e6db77c0bc586ec6f637
c3f4f675371b19a163eff5ccb46915a554421c31
081953d744c06eb69253f10c95c08e61814e20eb
85a8f552737fc44b898a19ef15702f2177deed39
eb977217b0d0ff7df05ff1f8959cfc189e15d3a6
91a726c9add02c9571702356605e8b37bc80c549
814af653c907030e5d16e29856011db3d870f9c9
e6c9ad463edfd2435888df854bb7250371363b91
4219c19c3c0859e63182e4d4e4e1a07c80815f93
2b41f32a61a44e16ffcf949cd5b814effd48aa35
8b06f3835ec3bebb806e28d4a1b1eeea2813c50f
575a9bfe0dc2023270c6aa79edefea1b2e8d5f17
a958950c2711ba2fe80e8bcb898bbafadd49b10d
106748e12d5d93aa7ba61b7c914fcfcd0f460d2a
669f0096c96eda5618f4e42766c665f3ed341e92
0c87fdcd1f9f7f1a09e8928422160159b8966784
)
...
# wget -q -O - https://github.com/torvalds/linux/compare/e6c9ad463edfd2435888df854bb7250371363b91^..669f0096c96eda5618f4e42766c665f3ed341e92.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
eb977217b0d0ff7df05ff1f8959cfc189e15d3a6
91a726c9add02c9571702356605e8b37bc80c549
e6c9ad463edfd2435888df854bb7250371363b91
