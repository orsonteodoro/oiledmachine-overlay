...
# There are many ways to do a reset.
# make defconfig - we can just have the default drivers and settings and then add on top of that set.  This was the assumption before.
# make allnoconfig - we can set to n as possible at the very beginning and then add the bundles on top.  This is the preferred way of doing it.  This will be explored later.
...
# Generator:  for x in $(grep -o -E -e "CONFIG_[A-Za-z0-9_]+" ot-kernel-driver-bundle.eclass); do echo -e "\t\"${x}\"" ; done | sort | uniq
	...
	"CONFIG_INTEL_IOMMU"
	"CONFIG_INTEL_ISH_AHCI"
	"CONFIG_INTEL_ISH_FIRMWARE"
	"CONFIG_INTEL_ISH_HID"
	"CONFIG_INTEL_LPC"
	"CONFIG_INTEL_LPSS_PCI"
	"CONFIG_INTEL_MEI"
	...
	"CONFIG_SENSORS_AQUACOMPUTER_D5NEXT"
	"CONFIG_SENSORS_ASB100"
	"CONFIG_SENSORS_ASUS_EC"
	"CONFIG_SENSORS_ASUS_ROG_RYUJIN"
	...
	"CONFIG_SND_SSCAPE"
	"CONFIG_SND_TRIDENT"
	"CONFIG_SND_UMP_LEGACY_RAWMIDI"
	"CONFIG_SND_USB"
	"CONFIG_SND_USB_AUDIO"
	"CONFIG_SND_USB_AUDIO_MIDI_V2"
	"CONFIG_SND_VIA82XX"
	"CONFIG_SND_VIRTUOSO"
	...
	"CONFIG_TCP_CONG_BBR"
	"CONFIG_THERMAL"
	"CONFIG_THERMAL_INTEL"
	"CONFIG_THERMAL_INTEL_CPU"
	"CONFIG_TIGON3"
...
# @FUNCTION: ot-kernel-driver-bundle_clear_driver_set
# @DESCRIPTION:
...
|"graphics:sm_120a"\
	...
	# Deferred early boot framebuffer choices to ot-kernel_gpu_driver_fallback.
