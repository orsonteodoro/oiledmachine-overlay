...
# @ECLASS: cmake-static-libs.eclass
# @MAINTAINER: orsonteodoro@hotmail.com
# @BLURB: cmake-static-libs multibuild helper
# @DESCRIPTION:
# The cmake-static-libs eclass helps build both static and shared.
...
# ECMAKE_LIB_TYPE contains the implementination of cmake-static-libs to process like EPYTHON
# BUILD_DIR contains the path to the instance of the copied sources
_cmake-static-libs_multibuild_wrapper() {
...
# @FUNCTION: cmake-static-libs_foreach_impl
# @DESCRIPTION:  This will execute a callback for each cmake-static-libs implementation
cmake-static-libs_foreach_impl() {
	debug-print-function ${FUNCNAME} "${@}"

	local MULTIBUILD_VARIANTS
	_cmake-static-libs_obtain_impls

	multibuild_foreach_variant _cmake-static-libs_multibuild_wrapper "${@}"
}

# @FUNCTION: cmake-static-libs_copy_sources
...
# @FUNCTION: _cmake-static-libs_obtain_impls
