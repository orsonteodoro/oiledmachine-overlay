...
# @ECLASS: ot-kernel-v7.3.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 7.3.x kernel
# @DESCRIPTION:
# The ot-kernel-v7.3 eclass defines specific applicable patching for the 7.3.x
# linux kernel.
...
# https://github.com/torvalds/linux/blob/v7.3/Documentation/process/changes.rst
# For compiler versions, see
# https://github.com/torvalds/linux/blob/v7.3/scripts/min-tool-version.sh#L26
...
# Using -r1 in ot-sources-7.3.1-r1.ebuild is not allowed.
# Using _p20260704 in ot-sources-7.3.1_p20260704.ebuild is not allowed.
...
if [[ "${PV}" =~ "_rc" ]] ; then
	# ot-sources-7.3_rc1.ebuild
	RC_PV=$(ver_cut 4 "${PV}")
	MY_PV="${KV_MAJOR_MINOR}_${RC_PV}"		# 7.3_rc1
	UPSTREAM_PV="${KV_MAJOR_MINOR}-${RC_PV}"	# 7.3-rc1
else
	# ot-sources-7.3.9999.ebuild
	# ot-sources-7.3.ebuild
	# ot-sources-7.3.1.ebuild
	RC_PV=""
	MY_PV="${PV}" #					# 7.3, 7.3.1, 7.3.9999
	UPSTREAM_PV="${PV}"				# 7.3, 7.3.1, 7.3.9999
fi
...
# https://github.com/torvalds/linux/blob/v7.2-rc1/drivers/gpu/drm/amd/display/include/dal_types.h	DCN 4.2b
# https://github.com/torvalds/linux/blob/v7.2-rc1/drivers/gpu/drm/amd/amdgpu/amdgpu_vcn.c		VCN 5.3.0
# https://github.com/torvalds/linux/blob/v7.2-rc1/drivers/gpu/drm/amd/amdgpu/gfx_v12_0.c		the last gfx version for gc_12_0_1 and others with .bin reference
...
ATH_FIRMWARE_RELEASE_DATE="20260421" # Based on QCC2072 commit messages in https://github.com/torvalds/linux/blob/v7.0/drivers/net/wireless/ath/ath12k/
IVPU_FIRMWARE_RELEASE_DATE="20250307" # Based on presence of added vpu_37xx_v1 bin referenced in https://github.com/torvalds/linux/blob/v7.2/drivers/accel/ivpu/ivpu_fw.c
RTL_BT_FIRMWARE_RELEASE_DATE="20250106" # Based on rtl8723cs_xx_config bin referenced in https://github.com/torvalds/linux/blob/v7.2/drivers/bluetooth/btrtl.c
...
RTL8XXXU_FIRMWARE_RELEASE_DATE="20230517" # Based on latest added rtl8192fufw bin from https://github.com/torvalds/linux/blob/v7.2/drivers/net/wireless/realtek/rtl8xxxu/
RTLWIFI_FIRMWARE_RELEASE_DATE="20241010" # Based on latest added rtl8192dufw bin from https://github.com/torvalds/linux/blob/v7.2/drivers/net/wireless/realtek/rtlwifi/
RTW_FIRMWARE_RELEASE_DATE="20250630" # Based on latest added rtw8922a_fw-4 bin drivers from https://github.com/torvalds/linux/blob/v7.2/drivers/net/wireless/realtek/rtw89
...
# See
# https://github.com/torvalds/linux/blob/v7.3/tools/build/feature/Makefile#L331
# https://github.com/torvalds/linux/blob/v7.3/tools/perf/Makefile.config#L276
# https://github.com/torvalds/linux/blob/v7.3/scripts/kconfig/qconf-cfg.sh
...
PATCH_ALLOW_O3_COMMIT="4552ae443b368caad94ec1a5dfb1e92047dc62a6" # id from zen repo
...
PATCH_BFQ_DEFAULT="793c7ea2382961df39fcae8149fc429d0c288182" # id from zen repo
PATCH_KCP_COMMIT="" # id from zen repo ; aka more-uarches
PATCH_KYBER_DEFAULT="548c3c159818b09dbe498a798bd6eeb559d9b90a" # id from zen repo
PATCH_OPENRGB_COMMIT="" # id from zen repo
PATCH_TRESOR_VER="3.18.5"
PATCH_ZEN_SAUCE_BRANDING="7daae93672603ef9f099ee5786adb38400e6610b" # id from zen repo
...
# From https://github.com/torvalds/linux/compare/v7.3...zen-kernel:zen-kernel:7.3/zen-sauce
#
# Generated from:
# wget -q -O - https://github.com/torvalds/linux/compare/7daae93672603ef9f099ee5786adb38400e6610b^..299e73098bef8870b60c6ce830084457d222b0f5.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
7daae93672603ef9f099ee5786adb38400e6610b
429980f9a64cd983a4ad0c636518e1a4217c7303
6e7e8c5b6aade5864e8800d8cd4e594f04b5d00f
4552ae443b368caad94ec1a5dfb1e92047dc62a6
f6ac9623fc5daa2aa6763bdb02a6f2248b20ab83
e2a626c293d7650eb49bb3c48983a4cd0ae58cc0
752877a21842fa2516d157993f620651a0ab3ddc
418d24d861201d3afe6e913aed887da826131891
6bedec045374a0e841dc8eedcd4ffcc9345481dc
a52b5b942a2b35e4b421b9be756903eb3d88f4ed
6030c5c5983f054ba3a04693cfd327de4744e1cf
4d5bffd696f6fdf4fe84499093a006512e475650
3948334070051d9a4c5dfefdbc20af3bc2cfd714
19fdd62d5f96da5dfb77904d03b218a008c5247a
6279c4d72828524749bee064543032a9d9f237b2
90bc67c2e07c9e58e190f11b8256c10652102aac
793c7ea2382961df39fcae8149fc429d0c288182
faabc222990250f183a2710f7eb59633c3b73786
548c3c159818b09dbe498a798bd6eeb559d9b90a
cbdf3e9ef622c54998e0b0b5a48cacf339fb6289
28014767dba9f5dee31d295292c185a771fdfb1a
277b51bc972b7fd5fefaae78a71765290f1ae7e1
79d00fb04ebe13d6dc9f2be9a3c77329ea3b96b0
f8197953b0e73d8c1a9b6aeff91451bd44e7adae
4a1464c145e8162532c11d3d078e5ef6cf523212
299e73098bef8870b60c6ce830084457d222b0f5
)
...
# wget -q -O - https://github.com/torvalds/linux/compare/90bc67c2e07c9e58e190f11b8256c10652102aac^..299e73098bef8870b60c6ce830084457d222b0f5.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
90bc67c2e07c9e58e190f11b8256c10652102aac
793c7ea2382961df39fcae8149fc429d0c288182
#faabc222990250f183a2710f7eb59633c3b73786
...
# clang is default OFF based on https://github.com/torvalds/linux/blob/v7.3/Documentation/process/changes.rst
...
ewarn "code in a security-critical context, or introduced unfuzzed code paths"
ewarn "with unseen vulnerabilies that should have been caught by the fuzzer,"
ewarn "crashes or kernel panics from incomplete or partial implementations"
ewarn "like driving on an unfinished bridge."
ewarn
ewarn
ewarn "Purpose of access to live"
ewarn
