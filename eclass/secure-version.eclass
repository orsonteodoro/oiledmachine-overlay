...
CPP_HTTPLIB_PV=${CPP_HTTPLIB_PV:-"0.54.1"}
...
ELECTRON_PV=${ELECTRON_PV:-"44.4.1"} # node 24.21.0, chromium 152.0.7977.78;  Deprecated use NODE_24_ELECTRON_PV
...
GRAPHICSMAGICK_PV=${GRAPHICSMAGICK_PV:-"1.3.48"}
...
FFMPEG_9_0_PV=${FFMPEG_8_1_PV:-"9.0.1"}
...
LINUX_KERNEL_7_3_RC_PV=${LINUX_KERNEL_7_3_RC_PV:-"7.3_rc3"}
LINUX_KERNEL_7_2_PV=${LINUX_KERNEL_7_2_PV:-"7.2.6"}
LINUX_KERNEL_6_18_PV=${LINUX_KERNEL_6_18_PV:-"6.18.52"}
LINUX_KERNEL_6_12_PV=${LINUX_KERNEL_6_12_PV:-"6.12.110"}
