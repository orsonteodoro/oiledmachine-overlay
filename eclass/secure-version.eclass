...
BUBBLEWRAP_PV=${BUBBLEWRAP_PV:-"0.12.0"}
...
CHROMIUM_PV=${CHROMIUM_PV:-"149.0.7827.200"} # Stable
...
DOUBLE_CONVERSION_PV=${DOUBLE_CONVERSION_PV:-"3.4.0"}
ELECTRON_PV=${ELECTRON_PV:-"42.5.0"}
...
LINUX_KERNEL_7_2_PV=${LINUX_KERNEL_7_2_PV:-"7.2_rc1"}
LINUX_KERNEL_7_1_PV=${LINUX_KERNEL_7_1_PV:-"7.1.2"}
LINUX_KERNEL_6_18_PV=${LINUX_KERNEL_6_18_PV:-"6.18.37"}
...
LINUX_FIRMWARE_PV=${LINUX_FIRMWARE_PV:-"20250729"} # Do not change the format
LILV_PV=${LILV_PV:-"0.28.0"}
LV2_PV=${LV2_PV:-"9999"}
LZ4_PV=${LZ4_PV:-"9999"}
MBEDTLS_PV=${MBEDTLS_PV:-"9999"}
...
NCURSES_PV=${NCURSES_PV:-"ncurses-6.5_p20251213"}
...
NODEJS_26_PV=${NODEJS_26_PV:-"26.4.0"}
