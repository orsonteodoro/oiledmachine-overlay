...
# overflow
# race
# reject [Fail-Secure hints, improper/inadequate validation vulnerability, validation bypass hint]
# segfault
# stack overflow
# toctou
# uaf
...
BOEHM_GC_PV=${BOEHM_GC_PV:-"8.2.12"}
...
CEF_PV=${CEF_PV:-"154.0.22"}
CEF_BIN_PV=${CEF_BIN_PV:-"154.0.22"}
CEF_BIN_PV_CHROMIUM=${CEF_BIN_PV_CHROMIUM:-"154.0.8037.17"} # keep in sync
CEF_BIN_PV_REV=${CEF_BIN_PV_REV:-"8559582"} # keep in sync
...
DISCORD_PV=${DISCORD_PV:-"1.0.152"}			# https://discord.com/download at the top of the page, stable
DISCORD_CANARY_PV=${DISCORD_CANARY_PV:-"1.0.1601"}	# https://support.discord.com/hc/en-us/articles/360035675191-Discord-Testing-Clients at the "Where can i download these clients?" > Linux section
DISCORD_PTB_PV=${DISCORD_PTB_PV:-"1.0.206"}		# https://ptb.discord.com/ at the the bottom of the page
...
EMBREE_PV=${EMBREE_PV:-"9999"}
ENET_PV=${ENET_PV:-"9999"}
FIREFOX_RAPID_PV=${FIREFOX_RAPID_PV:-"156.0"}
FIREFOX_ESR_PV=${FIREFOX_ESR_PV:-"153.3"}
FIREFOX_ESR_153_PV=${FIREFOX_ESR_PV:-"153.3"}
FIREFOX_ESR_140_PV=${FIREFOX_ESR_PV:-"140.16"}
FIREFOX_ESR_115_PV=${FIREFOX_ESR_PV:-"115.41"}
...
GLIB_PV=${GLIB_PV:-"2.90.9999"}
GLIBMM_PV=${GLIBMM_PV:-"2.89.1"}
...
FFMPEG_9_0_PV=${FFMPEG_8_1_PV:-"9.0.2"}
...
GO_PV=${GO_PV:-"1.26.5"} # Same as golang
...
HARDENED_MALLOC_PV=${HARDENED_MALLOC_PV:-"2026081300"}
HDF5_PV=${HDF5_PV:-"9999"}
HIGHWAY_PV=${HIGHWAY_PV:-"9999"}
HYPHEN_PV=${HYPHEN_PV:-"2.8.9"}
HYPRLAND_PV=${HYPRLAND_PV:-"0.56.1"}
HYPRLANG_PV=${HYPRLANG_PV:-"9999"}
HYPRTOOLKIT_PV=${HYPRTOOLKIT_PV:-"9999"}
HYPRUTILS_PV=${HYPRUTILS_PV:-"9999"}
ICEAUTH_PV=${ICEAUTH_PV:-"1.0.2"}
ICU_PV=${ICU_PV:-"79.1.9999"}
INKSCAPE_PV=${INKSCAPE_PV:-"1.4.4"}
IMAGEMAGICK_PV=${IMAGEMAGICK_PV:-"9999"}
IMATH_PV=${IMATH_PV:-"3.2.2"}
...
LIBDEFLATE_PV=${LIBDEFLATE_PV:-"1.26"}
...
LIBMICROHTTPD_PV=${LIBMICROHTTPD_PV:-"1.0.10"}
...
LIBQALCULATE_PV=${LIBQALCULATE_PV:-"5.12.0"}
...
LIBSECCOMP_PV=${LIBSECCOMP_PV:-"2.6.1"}
LIBSECRET_PV=${LIBSECRET_PV:-"0.21.3"}
LIBSEPOL_PV=${LIBSEPOL_PV:-"9999"}
LIBSIXEL_PV=${LIBSIXEL_PV:-"1.8.7_p2"}
LIBSM_PV=${LIBSM_PV:-"1.2.4"}
LIBSODIUM_PV=${LIBSODIUM_PV:-"1.0.22-r100"}
...
LIBULTRAHDR_PV=${LIBULTRAHDR_PV:-"9999"}
...
LINUX_KERNEL_7_3_RC_PV=${LINUX_KERNEL_7_3_RC_PV:-"7.3_rc4"}
LINUX_KERNEL_7_2_PV=${LINUX_KERNEL_7_2_PV:-"7.2.7"}
LINUX_KERNEL_6_18_PV=${LINUX_KERNEL_6_18_PV:-"6.18.53"}
LINUX_KERNEL_6_12_PV=${LINUX_KERNEL_6_12_PV:-"6.12.111"}
LINUX_KERNEL_6_6_PV=${LINUX_KERNEL_6_6_PV:-"6.6.157"}
LINUX_KERNEL_6_1_PV=${LINUX_KERNEL_6_1_PV:-"6.1.188"}
LINUX_KERNEL_5_15_PV=${LINUX_KERNEL_5_15_PV:-"5.15.221"}
LINUX_KERNEL_5_10_PV=${LINUX_KERNEL_5_10_PV:-"5.10.270"}
LINUX_FIRMWARE_PV=${LINUX_FIRMWARE_PV:-"20260815"} # Do not change the YYYYMMDD format
...
MIMALLOC1_PV=${MIMALLOC1_PV:-"1.15.1"}
MIMALLOC2_PV=${MIMALLOC2_PV:-"2.5.1"}
MIMALLOC3_PV=${MIMALLOC3_PV:-"3.5.1"}
...
NOCTALIA_5_PV=${NOCTALIA_5_PV:-"5.9999"}
NOCTALIA_QS_PV=${NOCTALIA_QS_PV:-"9999"}
NODEJS_26_PV=${NODEJS_26_PV:-"26.10.0"}
NODEJS_24_PV=${NODEJS_24_PV:-"24.21.0"}
NODEJS_22_PV=${NODEJS_22_PV:-"22.23.3"}
NSPR_PV=${NSPR_PV:-"4.39"}
NSS_PV=${NSS_PV:-"3.129"}
NUMACTL_PV=${NUMACTL_PV:-"9999"}
PAMBASE_PV=${PAMBASE_PV:-"20251104"}
PGVECTOR_PV=${PGVECTOR_PV:-"0.8.6"}
OFONO_PV=${OFONO_PV:-"2.17"}
OGRE_PV=${OGRE_PV:-"9999"}
OLLAMA_PV=${OLLAMA_PV:-"0.32.4"}
ONNXRUNTIME_PV=${ONNXRUNTIME_PV:-"1.29.0"}
OPENAL_PV=${OPENAL_PV:-"1.25.2"}
OPENBLAS_PV=${OPENBLAS_PV:-"9999"}
OPENCOLORIO_PV=${OPENCOLORIO_PV:-"9999"}
OPENCORE_AMR_PV=${OPENCORE_AMR_PV:-"0.1.6"}
OPENCV4_PV=${OPENCV4_PV:-"4.9999"}
OPENCV5_PV=${OPENCV4_PV:-"5.9999"}
OPENEXR_PV=${OPENEXR_PV:-"9999"}
OPENIMAGEIO_3_0_PV=${OPENIMAGEIO_3_0_PV:-"3.0.9999"}
OPENIMAGEIO_3_1_PV=${OPENIMAGEIO_3_1_PV:-"3.1.9999"}
OPENJPEG_PV=${OPENJPEG_PV:-"2.5.4-r1"}
OPENJPH_PV=${OPENJPH_PV:-"0.30.0"}
OPENLDAP_PV=${OPENLDAP_PV:-"9999"}
OPENRC_PV=${OPENRC_PV:-"9999"}
...
OPENSUBDIV_PV=${OPENSUBDIV_PV:-"9999"}
OPENUSD_25_PV=${OPENUSD_26_PV:-"25.11"}
OPENUSD_26_PV=${OPENUSD_26_PV:-"26.9999"}
...
PROXYCHAINS_PV=${PROXYCHAINS_PV:-"9999"}
...
PG_SEARCH_PV=${PG_SEARCH_PV:-"0.25.0"}
POSTGRES_LIVE_PV=${POSTGRES_LIVE_PV:-"9999"}
POSTGRES_19_PV=${POSTGRES_19_PV:-"19_beta2"}
POSTGRES_18_PV=${POSTGRES_18_PV:-"18.4"}
POSTGRES_17_PV=${POSTGRES_17_PV:-"17.10"}
POSTGRES_16_PV=${POSTGRES_16_PV:-"16.14"}
...
SPEEXDSP_PV=${SPEEXDSP_PV:-"1.2.1"}
SPIDERMONKEY_153_PV=${SPIDERMONKEY_153_PV:-"153.3.0"}
SPIDERMONKEY_140_PV=${SPIDERMONKEY_153_PV:-"140.16.0"}
SPIRV_HEADERS_PV=${SPIRV_HEADERS_PV:-"9999"}
SPIRV_TOOLS_PV=${SPIRV_TOOLS_PV:-"9999"}
SRT_PV=${SRT_PV:-"9999"}
SQLITE_PV=${SQLITE_PV:-"9999"}
SUBRANDR_PV=${SUBRANDR_PV:-"9999"}
SUBVERSION_PV=${SUBVERSION_PV:-"9999"}
SUDO_PV=${SUDO_PV:-"9999"}
SVT_AV1_PV=${SVG_AV1_PV:-"9999"}
SWAY_PV=${SWAY_PV:-"9999"}
SWAYBG_PV=${SWAYBG_PV:-"1.2.2"}
SYSTEMD_PV=${SYSTEMD_PV:-"9999"}
TABBED_PV=${TABBED_PV:-"0.8"}
TAGLIB_PV=${TAGLIB_PV:-"9999"}
TAR_PV=${TAR:-"9999"}
TBB_PV=${TBB_PV:-"9999"}
TESSERACT_PV=${TESSERACT_PV:-"9999"}
TIFF_PV=${TIFF_PV:-"9999"}
TINYXML_PV=${TINYXML_PV:-"9999"}
...
VIPS_PV=${VIPS_PV:-"8.18.6"}
VO_AMRWBENC_PV=${VO_AMRWBENC_PV:-"9999"}
VSCODE_PV=${VSCODE_PV:-"1.123.1"}
VULKAN_PV=${VULKAN_PV:-"1.4.362.0"} # Same as VULKAN_HEADERS_PV, VULKAN_LOADER_PV, VULKAN_TOOLS_PV
...
WEBKIT_GTK_PV=${WEBKIT_GTK_PV:-"2.52.6"}
WEBKIT_GTK_STABLE_PV=${WEBKIT_GTK_PV:-"2.52.6"}
