...
MITIGATION_DATE="Jan 8, 2025" # Advisory date
MITIGATION_LAST_UPDATE=1736383020 # From `date +%s -d "2025-01-08 16:37"` from earliest timestamp corresponding to the weekly release in link below
...
# Medium and low are shown optionally.
	...
	"CVE-2024-45828;CE, DoS;High to Critical"
	"CVE-2024-57798;UAF, DoS;Medium to High"
	"CVE-2024-41149;UAF;Medium to High"
	"CVE-2024-50051;UAF;Medium to High"
	"CVE-2024-57849;UAF;Medium to High"
	"CVE-2024-52319;DT, ID;High"
	"CVE-2024-51729;DT, ID;High"
	"CVE-2024-57876;DT;Medium to High"
	"CVE-2024-57850;DT;Medium to High"
	"CVE-2024-57804;DT;Medium to High"
	"CVE-2024-57793;ID;Medium to High"
	...
	"CVE-2024-57877;UM;?"
	"CVE-2024-57874;UM;?"
	"CVE-2024-57880;OOB;Medium"
	"CVE-2024-57792;OOB;Medium"
	"CVE-2024-52332;OOB;Medium"
	"CVE-2024-56368;OOB;Medium"
	"CVE-2024-41935;DoS;Medium"
	"CVE-2024-57881;DoS;Medium"
	"CVE-2024-57872;DoS;Medium"
	"CVE-2024-57839;DoS;Medium"
	"CVE-2024-57843;DoS;Medium"
	"CVE-2024-57809;DoS;Medium"
	"CVE-2024-57838;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-57807;DoS;Medium"
	"CVE-2024-57806;DoS;Medium" # if oops=panic
	"CVE-2024-57805;DoS;Medium"
	"CVE-2024-57800;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-57799;DoS;Medium"
	"CVE-2024-53690;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-53685;DoS;Medium"
	"CVE-2024-49573;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-49571;DoS;Medium"
	"CVE-2024-49568;DoS;Medium"
	"CVE-2024-47408;DoS;Medium"
	"CVE-2024-57791;DoS;Medium"
	"CVE-2024-56788;DoS;Medium"
	"CVE-2024-56372;DoS;Medium"
	"CVE-2024-56369;DoS;Medium"
	"CVE-2024-55916;DoS;Medium"
	"CVE-2024-55881;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-54680;DoS;Medium"
	"CVE-2024-54455;DoS;Medium"
	"CVE-2024-54193;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-46896;DoS;Medium"
	"CVE-2024-55642;DoS;Medium"
	"CVE-2024-55641;DoS;Medium"
	"CVE-2024-54683;DoS;Medium"
	"CVE-2024-54460;DoS;Medium"
	"CVE-2024-54191;DoS;Medium"
	"CVE-2024-53689;DoS;Medium"
	"CVE-2024-53682;DoS;Medium"
	"CVE-2024-53687;DoS;Medium" # if panic_on_warn=1 for < 5.14
	"CVE-2024-48875;DoS;Medium"
	"CVE-2024-48873;DoS;Medium"
	"CVE-2024-47809;DoS;Medium"
	"CVE-2024-47794;DoS;Medium"
	"CVE-2024-47143;DoS;Medium"
	"CVE-2024-47141;DoS;Medium"
	"CVE-2024-43098;DoS;Medium"
	...
	"CVE-2024-56787;DoS;Medium"
	"CVE-2024-56785;DoS;Medium"
	"CVE-2024-56783;DoS;Medium"
	"CVE-2024-56781;DoS;Medium"
	"CVE-2024-56782;DoS;Medium"
	"CVE-2024-56780;DoS;Medium"
	"CVE-2024-56779;DoS;Medium"
	"CVE-2024-56778;DoS;Medium"
	"CVE-2024-56777;DoS;Medium"
	"CVE-2024-56776;DoS;Medium"
	"CVE-2024-56774;DoS;Medium"
	"CVE-2024-56773;DoS;Medium"
	"CVE-2024-56771;DoS;Medium" # if panic_on_warn=1
	"CVE-2024-56770;DoS;Medium"
