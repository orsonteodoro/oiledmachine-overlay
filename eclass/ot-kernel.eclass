...
# Medium and low are shown optionally.
	...
	"CVE-2025-21672;DoS;Medium"
	"CVE-2025-21670;DoS;Medium"
	"CVE-2025-21669;DoS;Medium"
	"CVE-2025-21667;DoS;Medium"
	"CVE-2025-21666;DoS;Medium"
	"CVE-2025-21683;DoS;Medium"
	"CVE-2025-21682;DoS;Medium"
	"CVE-2025-21676;DoS;Medium"
	"CVE-2025-21675;DoS;Medium"
	"CVE-2025-21674;DoS;Medium"
	"CVE-2025-21665;DoS;Medium"
	"CVE-2024-57948;;"
	"CVE-2025-21668;;"
	"CVE-2025-21681;;"
	"CVE-2025-21679;;"
...
ewarn
ewarn "CVE-2024-31068 - DoS                     # Intel® CPUs microcode update available"
ewarn "CVE-2024-36293 - DoS                     # Intel® CPUs microcode update available"
ewarn "CVE-2023-43758 - PE, DoS, DT, ID         # Intel® CPUs microcode update available"
ewarn "CVE-2023-34440 - PE, DoS, DT, ID         # Intel® CPUs microcode update available"
ewarn "CVE-2024-24582 - PE, DoS, DT, ID         # Intel® CPUs microcode update available"
ewarn "CVE-2024-29214 - PE, DoS, DT, ID         # Intel® CPUs microcode update available"
ewarn "CVE-2024-28127 - PE, DoS, DT, ID         # Intel® CPUs microcode update available"
ewarn "CVE-2024-39279 - DoS                     # Intel® CPUs microcode update available"
ewarn "CVE-2024-31157 - ID                      # Intel® CPUs microcode update available"
ewarn "CVE-2024-28047 - ID                      # Intel® CPUs microcode update available"
ewarn "CVE-2024-39355 - DoS                     # Intel® CPUs microcode update available"
ewarn "CVE-2024-37020 - DoS                     # Intel® CPUs microcode update available"
ewarn "CVE-2024-0179 - CE, DoS, DT, ID          # AMD CPUs BIOS firmware update available"
ewarn "CVE-2024-21925 - CE, DoS, DT, ID         # AMD CPUs BIOS firmware update available"
ewarn
}
