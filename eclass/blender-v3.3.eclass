...
# https://github.com/blender/blender/blob/v3.3.21/build_files/build_environment/install_deps.sh

# Last change was Aug 24, 2022 for:
# https://github.com/blender/blender/blob/v3.3.21/build_files/cmake/config/blender_release.cmake
# used for REQUIRED_USE section.

# Last change was Oct 16, 2023 for:
# https://github.com/blender/blender/blob/v3.3.21/build_files/build_environment/cmake/versions.cmake
# used for *DEPENDs.

# HIP:  https://github.com/blender/blender/blob/v3.3.21/intern/cycles/cmake/external_libs.cmake#L47

# GPU lib versions:  https://github.com/blender/blender/blob/v3.3.21/build_files/config/pipeline_config.yaml
...
# CC-BY-SA-4.0 - The splash screen chosen license is found in https://www.blender.org/download/demo-files/ )
...
RDEPEND+="
	...
	openvdb? (
		abi9-compat? (
			|| (
				=media-gfx/openvdb-11*[${PYTHON_SINGLE_USEDEP},abi9-compat,blosc]
				=media-gfx/openvdb-10*[${PYTHON_SINGLE_USEDEP},abi9-compat,blosc]
				=media-gfx/openvdb-9*[${PYTHON_SINGLE_USEDEP},abi9-compat,blosc]
			)
		)
...
# For details see,
# https://github.com/blender/blender/tree/v3.3.21/build_files/cmake/config
