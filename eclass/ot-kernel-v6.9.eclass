...
# @ECLASS: ot-kernel-v6.9.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 6.9.x kernel
# @DESCRIPTION:
# The ot-kernel-v6.9 eclass defines specific applicable patching for the 6.9.x
# linux kernel.
...
# For *DEPENDs, see
# https://github.com/torvalds/linux/blob/v6.9/Documentation/process/changes.rst
# For compiler versions, see
# https://github.com/torvalds/linux/blob/v6.9/scripts/min-tool-version.sh#L26
...
# From https://github.com/torvalds/linux/compare/v6.9...zen-kernel:zen-kernel:6.9/zen-sauce
#
# Generated from:
