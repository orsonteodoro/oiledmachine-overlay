...
# @ECLASS: ot-kernel-v6.14.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 6.14.x kernel
# @DESCRIPTION:
# The ot-kernel-v6.14 eclass defines specific applicable patching for the 6.14.x
# linux kernel.
...
# For *DEPENDs, see
# https://github.com/torvalds/linux/blob/v6.14/Documentation/process/changes.rst
# For compiler versions, see
# https://github.com/torvalds/linux/blob/v6.14/scripts/min-tool-version.sh#L26
...
CXX_STD="-std=gnu++14" # See https://github.com/torvalds/linux/blob/v6.14/tools/build/feature/Makefile#L331
...
PATCH_ALLOW_O3_COMMIT="1ccaaefbf26c9b2968c2e80427f720e9fc1ece50" # id from zen repo
...
PATCH_BFQ_DEFAULT="d3b2ab943a1de0838c4bd515dbed45f8f1c3c2cc" # id from zen repo
PATCH_KCP_COMMIT="90b69178f6a866c7f3330c2006f6b5396146192c" # id from zen repo ; aka more-uarches
PATCH_KYBER_DEFAULT="d941bedf16b95646be26364f00cf46c6649608a6" # id from zen repo
PATCH_OPENRGB_COMMIT="" # id from zen repo
PATCH_TRESOR_VER="3.18.5"
PATCH_ZEN_SAUCE_BRANDING="311c453db751b5a01c83edf61f5748ecd3471056" # id from zen repo
...
# From https://github.com/torvalds/linux/compare/v6.14...zen-kernel:zen-kernel:6.14/zen-sauce
#
# Generated from:
# wget -q -O - https://github.com/torvalds/linux/compare/311c453db751b5a01c83edf61f5748ecd3471056^..364ae676d7695faebb72009f89a1ed042c351033.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
311c453db751b5a01c83edf61f5748ecd3471056
6d141e3121676e9ca50d6465a622b9a5d572219a
1f9910c9a54b424ad0cd415b981986937618c4ec
bcf31bf72f05feac7b2d4bed47829411c5397781
90b69178f6a866c7f3330c2006f6b5396146192c
02b4d790bb05e24e7408a147f33e4e9ca0b805fa
f4f448a305e9d705b9a0da102ddfd58bfaac5cc0
17190525fdc9c9f73fe22832ab0631e9e1bbad6d
feaa876f3116fd1880f5d50e86a8e68e28f12ae7
c565850b129d2b7ddda91f5a5658fc4e765083b9
2b801ae725ae05be994d374efdce8fc2e828687f
961e73a1c97139f47560b3d55e15442bc09fef7f
3777b5340ebf0460e6fb79205b294dd4333c9d8b
d00df0f150c9d04cd229d42e0af906db3dfb5190
f03da22e562a7d65a97926a76f61daeef8a1eb0d
e2de6c995871deb31796af9e8a1f49c772bb2cea
5f93b67c4e2fa81be5cee3edd8ec056407d25f26
80b06f0f0bba019632e40c11231987a7e996c340
ac35b7af0aac6a9eb996962130a99c9af75c8b08
8bf253ea1b48fe101dc0161824b9a7d85f420b84
d3b2ab943a1de0838c4bd515dbed45f8f1c3c2cc
d941bedf16b95646be26364f00cf46c6649608a6
d0ce01e1def080e52770f9a899476bb840807b37
f1fd33efd4b70519ff51b78c62d6fdf7d4f69620
75f2a8831bd24a35d9853b11dabc06a138c5e445
b82d80a4195f179b9c0d0c80f662a7f42ed21ce8
7227af3e01f9ae5a2bcdc9aa652c973438938eb3
91187cefc66b9c186a78d7bd996088fc74c66c99
779648709dc797dac595e3007b4c7c3fee254537
ef87b1cb12134c34eed834315b03c4a6747b5716
cb33a6dc022faa07ac1e1cd544567b28a7e9afeb
53af25ba2daed6e2664a680250e2b32eac46bb89
327cf6f8e3bd04395c70cfa4d89ed10113affdf2
594d7f9d017ee7d4611c7d9812f3c6d4484175b5
364ae676d7695faebb72009f89a1ed042c351033
)
...
# wget -q -O - https://github.com/torvalds/linux/compare/8bf253ea1b48fe101dc0161824b9a7d85f420b84^..cb33a6dc022faa07ac1e1cd544567b28a7e9afeb.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
8bf253ea1b48fe101dc0161824b9a7d85f420b84
d3b2ab943a1de0838c4bd515dbed45f8f1c3c2cc
d941bedf16b95646be26364f00cf46c6649608a6
...
# clang is default OFF based on https://github.com/torvalds/linux/blob/v6.14/Documentation/process/changes.rst
