...
# -Z harden-sls=all                                              1.00          # security-critical    ; estimated security score 99
# -Z harden-sls=indirect-jmp                                     1.00          # balanced             ; estimated security score 65
# -Z harden-sls=none                                             1.00          # performance-critical ; estimated security score 0
# -Z harden-sls=return                                           1.00          # balanced             ; estimated security score 88
# -Z sanitizer=address                                  1.50  -  4.0 (ASan); 1.01 - 1.1 (GWP-ASan)
# -Z sanitizer=cfi                                      1.10  -  2.0
# -Z sanitizer=hwaddress                                1.15  -  1.50 (ARM64)
# -Z sanitizer=leak                                     1.05  -  1.5
# -Z sanitizer=memory                                   3.00  - 11.00
# -Z sanitizer=safestack                                1.01  -  1.20
# -Z sanitizer=shadow-call-stack                        1.01  -  1.15
# -Z sanitizer=thread                                   4.00  - 16.00
