...
# @ECLASS: ot-kernel-v6.17.eclass
# @MAINTAINER:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @AUTHOR:
# Orson Teodoro <orsonteodoro@hotmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Eclass for patching the 6.17.x kernel
# @DESCRIPTION:
# The ot-kernel-v6.17 eclass defines specific applicable patching for the 6.17.x
# linux kernel.
...
# https://github.com/torvalds/linux/blob/v6.17/Documentation/process/changes.rst
# For compiler versions, see
# https://github.com/torvalds/linux/blob/v6.17/scripts/min-tool-version.sh#L26
...
# See
# https://github.com/torvalds/linux/blob/v6.17/tools/build/feature/Makefile#L331
# https://github.com/torvalds/linux/blob/v6.17/tools/perf/Makefile.config#L276
# https://github.com/torvalds/linux/blob/v6.17/scripts/kconfig/qconf-cfg.sh
...
PATCH_KYBER_DEFAULT="defa856afbb59545e83809c49242cc35129d3303" # id from zen repo
PATCH_OPENRGB_COMMIT="" # id from zen repo
PATCH_TRESOR_VER="3.18.5"
PATCH_ZEN_SAUCE_BRANDING="02ca47b710a5ea289e1a63b8db7f6053c5f34815" # id from zen repo
...
# From https://github.com/torvalds/linux/compare/v6.17...zen-kernel:zen-kernel:6.17/zen-sauce
#
# Generated from:
# wget -q -O - https://github.com/torvalds/linux/compare/02ca47b710a5ea289e1a63b8db7f6053c5f34815^..c962d79d9e0133c53f1b88081abc3e3ad54265a0.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
02ca47b710a5ea289e1a63b8db7f6053c5f34815
332c0f76c995d92d920da1a7ba19825db065a713
e6ee819a897b33f392a5fd0774d8cf5c7886d056
0b7ff9ce1af3206c716ea6eb2b7ffe4144ffd290
b5c17941c5004019052131ecb99ec23b95e5a8a2
dec49e0a39ad2cfad8c6f867d81a13f4fc2eabd1
2321c3fe69e4430adaa1dc45ac11c9685c3c58ea
be12070350a151ffb964c562e58983b16962df6d
69f73106b713eb0f9afe85b73d37dc439b69ca17
02555fb16f1a7b5a8acdcd05a85ddfaab426657d
cb314f7f1567a050802b069e9e9af6ebeeb02bb5
c9c703c370bb8ec08f6016c226dc5aaa2bffc9f2
acb74ee12c0a0e4768d90f4b38747e6df55abefb
7d39cd3c8140be85612f63b4f7988b8db011bac4
d228052440e803d92954523748bd16be3b859d45
fdacf75dca77ba024024d012a44c2859a282fbb9
17c176c665a69ab485dd68ce409b9ab36b9c2e0c
12fecea5e0af8217ca530e8587c9b35836d26bec
3e38cf82c20abb39d810154ae50ae4f5e56b8b30
8028b431ef43dc6ffe5ade68e14f3ebb2a47589e
4b756419599e7b5079e976d79160e1d4e39f340a
defa856afbb59545e83809c49242cc35129d3303
53a454727fe795e4e4806fed94883d0d81fc6800
fea9c3ad3b4086f71964ddbfa2e5b62bbf7b32c2
2c08464fec53534f091b04ac0b9c1aa2c5907950
0b2cb965a682ba763d0b3a801b0f1a91a592ab5f
1ff67eb536fdf053dbbb04e410096f1d43f21a72
fa0111ed8f00b72ed31a59e74c464c9c217145df
c962d79d9e0133c53f1b88081abc3e3ad54265a0
)
...
# wget -q -O - https://github.com/torvalds/linux/compare/3e38cf82c20abb39d810154ae50ae4f5e56b8b30^..c962d79d9e0133c53f1b88081abc3e3ad54265a0.patch \
#	| grep -E -o -e "From [0-9a-z]{40}" | cut -f 2 -d " "
3e38cf82c20abb39d810154ae50ae4f5e56b8b30
8028b431ef43dc6ffe5ade68e14f3ebb2a47589e
defa856afbb59545e83809c49242cc35129d3303
...
# clang is default OFF based on https://github.com/torvalds/linux/blob/v6.17/Documentation/process/changes.rst
