...
KEYWORDS="
amd64 arm arm64 ~hppa ~ia64 ~mips ~ppc ppc64 ~s390 ~sparc x86 ~amd64-linux
...
S="${WORKDIR}/mysql"
SRC_URI="
https://cdn.mysql.com/Downloads/MySQL-$(ver_cut 1-2)/${PN}-boost-${PV}.tar.gz
...
https://dev.gentoo.org/~whissi/dist/mysql/${PN}-${PATCHSET_VER%:*}-patches-${PATCHSET_VER#*:}.tar.xz
"
...
einfo "Test coverage open file limit:"
