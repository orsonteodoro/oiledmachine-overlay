...
inherit cflags-hardened check-compiler-switch check-reqs cmake dot-a edo eapi9-ver flag-o-matic libcxx-slot libstdcxx-slot linux-info multiprocessing toolchain-funcs prefix verify-sig
