...
* What it means for CUDA users is that if you want your AI girlfriend (LLM) to have hardware accelerated text-to-speech (TTS) capabilities stick to GCC 12 and CUDA 11.8.
