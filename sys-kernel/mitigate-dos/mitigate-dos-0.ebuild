...
EOL_VERSIONS=(
	...
	"6.0" "6.2" "6.3" "6.4" "6.5" "6.7" "6.8" "6.9" "6.10"
)
...
MULTISLOT_KERNEL_BLOCK_43854=("5.15.165" "6.1.103" "6.6.44" "6.10.3")
...
MULTISLOT_KERNEL_BPF_49850=("6.1.113" "6.6.54" "6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_CRYPTO_KEYS=("6.1.113" "6.6.54" "6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_EXFAT_47677=("6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_F2FS_44942=("6.6.47" "6.10.6")
MULTISLOT_KERNEL_F2FS_930c6ab=("6.6.54" "6.10.13" "6.11.2")
MULTISLOT_KERNEL_F2FS_49859=("6.1.113" "6.6.54" "6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_FUSE_47746=("6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_IOMMU_IOPF=("6.10.7" "6.11")
...
MULTISLOT_KERNEL_IWLWIFI_49857=("6.11.2")
...
MULTISLOT_KERNEL_KVM_47744=("6.6.54" "6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_MT7996E_47681=("6.6.54" "6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_NTFS3_42299=("6.1.103" "6.6.44" "6.10.3" "6.11")
...
MULTISLOT_KERNEL_NFSD_46696=("6.10.8")
...
MULTISLOT_KERNEL_PCI_46750=("4.19.322" "5.4.284" "5.10.226" "5.15.167" "6.1.110" "6.6.51" "6.10.10")
...
MULTISLOT_KERNEL_TCP_c8770db=("4.19.V" "5.4.V" "5.10.V" "5.15.V" "6.1.V" "6.6.54" "6.10.13" "6.11.2")
...
MULTISLOT_KERNEL_V4L2_43833=("6.1.103" "6.6.44" "6.10.3")
...
# tcp? c8770db # Unofficial: DoS NPD
...
all_rdepend() {
	...
	if _use tcp ; then
		if ! _use custom-kernel ; then
			gen_patched_kernel_driver_list ${MULTISLOT_KERNEL_TCP_c8770db[@]}
		fi
	fi
	if _use tipc ; then
		if ! _use custom-kernel ; then
...
einfo
	...
	if use tcp ; then
		check_kernel_version "net/tcp" "${CVE_TCP_c8770db}" ${MULTISLOT_KERNEL_TCP_c8770db[@]}
	fi
	if use tipc ; then
