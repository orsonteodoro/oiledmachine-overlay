...
ACTIVE_VERSIONS=("5.4" "5.10" "5.15" "6.1" "6.6" "6.12" "6.13" "6.14" "6.15")
...
MULTISLOT_LATEST_KERNEL_RELEASE=("5.4.292" "5.10.236" "5.15.180" "6.1.135" "6.6.88" "6.12.25" "6.13.12" "6.14.4" "6.15_rc3")
