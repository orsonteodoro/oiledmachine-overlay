...
ACTIVE_VERSIONS=("5.10" "5.15" "6.1" "6.6" "6.12" "6.18" "6.19" "7.0" "7.1" "7.2")
STABLE_OR_MAINLINE_VERSIONS=("7.0" "7.1" "7.2")
ALL_VERSIONS=(
	"0"
	"1"
	"2"
...
MULTISLOT_LATEST_KERNEL_RELEASE=("5.10.259" "5.15.210" "6.1.176" "6.6.143" "6.12.94" "6.18.37" "7.0.14" "7.1.2" "7.2_rc1")
