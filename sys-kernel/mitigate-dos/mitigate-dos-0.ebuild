...
ACTIVE_VERSIONS=("5.10" "5.15" "6.1" "6.6" "6.12" "6.18" "6.19" "7.0")
STABLE_OR_MAINLINE_VERSIONS=("7.0")
ALL_VERSIONS=(
	"0"
	"1"
	"2"
	...
	"6.0" "6.1" "6.2" "6.3" "6.4" "6.5" "6.6" "6.7" "6.8" "6.9" "6.11" "6.12" "6.13" "6.14" "6.15" "6.16" "6.17" "6.18" "6.19" "7.0"
)
EOL_VERSIONS=(
	"0"
	"1"
...
MULTISLOT_LATEST_KERNEL_RELEASE=("5.10.253" "5.15.203" "6.1.169" "6.6.135" "6.12.83" "6.18.24" "7.0.1")
