...
EBUILD_REV="ebuild_revision_12"
GENPATCHES_VER="52" # can be live only when 9999
PATCH_PROJC_VER="6.18-r1"
PATCH_RT_VER="6.18.37-rt6"

inherit ot-kernel-v6.18

# See also,
# https://github.com/orsonteodoro/oiledmachine-overlay/blob/master/eclass/ot-kernel.eclass
# https://github.com/orsonteodoro/oiledmachine-overlay/blob/master/eclass/ot-kernel-v6.18.eclass
...
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.17 (20260313) with builder profile with -O2 and -march=native, KFENCE on, KCFI on, UBSAN on, -D_FORTIFY_SOURCE on
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.17 (20260313) with hardened profile with -O2 and -march=native, KASAN on, KCFI on, UBSAN on, -D_FORTIFY_SOURCE on
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.22 (20260414) with hardened profile with -O2 and -march=native, KASAN on, KCFI on, UBSAN on, -D_FORTIFY_SOURCE on
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.22 (20260414) with builder profile with -O2 and -march=native, KFENCE on, KCFI on, UBSAN on, -D_FORTIFY_SOURCE on
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.26 (20260504) with builder profile with -O2 and -march=native, KFENCE on, KCFI on, UBSAN on, -D_FORTIFY_SOURCE on
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.26 (20260511) with gaming profile with -O3 and -march=native, scx_lavd 1.1.0 on
# OILEDMACHINE-OVERLAY-TEST:  FAIL stack size build time issue (interactive) 6.18.42 (20260806) with builder profile
