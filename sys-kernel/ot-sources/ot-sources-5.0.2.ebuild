...
# author	Mario Kleiner <mario.kleiner.de@gmail.com>	2019-02-09 07:52:55 +0100
# committer	Nicholas Kazlauskas <nicholas.kazlauskas@amd.com>	2019-02-25 09:55:49 -0500
# drm/amd/display: Use vrr friendly pageflip throttling in DC.
#KERNEL_COMMIT="e5620a6b4b1c908723548d7f0a0bdc15e1a7ce03" # The last landed AMD patch in mainline.  I assumed everything before it was commited.
...
IUSE="-zentune +o3 muqss +pds +bfq +amd amd-staging-drm-next cfs +graysky2 +ukms tresor tresor_aesni tresor_i686 tresor_x86_64 tresor_sysfs"
REQUIRED_USE="!ukms ^^ ( muqss pds cfs ) tresor_sysfs? ( || ( tresor_i686 tresor_x86_64 tresor_aesni ) ) tresor? ( ^^ ( tresor_i686 tresor_x86_64 tresor_aesni ) ) tresor_i686? ( tresor ) tresor_x86_64? ( tresor ) tresor_aesni? ( tresor ) amd-staging-drm-next? ( amd )"
