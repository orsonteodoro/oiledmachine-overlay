...
AMD_COMMIT_LAST_STABLE="cea52b372f400ab44830b882426ba28badca8534" # amd-18.50 branch latest commit equivalent
# 2019-03-20	drm/amdgpu: add thick tile mode settings for Oland of gfx6
...
SRC_URI="${KERNEL_URI}
	 ...
	 ${TRESOR_SRC_URL}
	 ${KERNEL_PATCH_URLS[@]}
	 https://gitlab.com/alfredchen/linux-bmq/commit/1b66bf997e19f3fa59e0871cce0de4778e91bce3.diff -> bmq-0.92-fix-yield-1b66bf99.patch
	 https://gitlab.com/alfredchen/linux-bmq/commit/3ecf5a1208068d3dbaa3e2901a134effb0071177.diff -> bmq-0.92-rework-yield-3ecf5a12.patch
	 "
...
function apply_bmq() {
	...
	# D3 studder fix
	#_dpatch "${PATCH_OPS} -R" "${DISTDIR}/bmq-0.92-fix-yield-1b66bf99.patch"
	_dpatch "${PATCH_OPS} -R" "${DISTDIR}/bmq-0.92-rework-yield-3ecf5a12.patch"
}
