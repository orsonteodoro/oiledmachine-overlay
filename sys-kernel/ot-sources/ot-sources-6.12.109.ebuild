...
GENPATCHES_VER="120" # can be live only when 9999
PATCH_PROJC_VER="6.12-r2"
PATCH_RT_VER="6.12.100-rt20"
...
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.12.69 (2026010) with builder profile, _FORTIFY_SOURCE on, kcfi on, ubsan on, kfence on.
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.12.76 (20260307) with builder profile, _FORTIFY_SOURCE on, kcfi on, ubsan on, kfence on.
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.12.76 (20260308) with hardened profile, _FORTIFY_SOURCE on, kcfi on, ubsan on, kasan on.
...
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.12.101 (20260806) with hardened profile, _FORTIFY_SOURCE on, kcfi off, ubsan off, kasan off, kfence off, max uptime on, usb autoseconds secs -1, lockdown lsm off.
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.12.108 (20260806) with hardened profile, _FORTIFY_SOURCE on, kcfi off, ubsan off, kasan off, kfence off, max uptime on, usb autoseconds secs -1, lockdown lsm off.
