...
# OILEDMACHINE-OVERLAY-TEST:  PASS (interactive) 6.18.26 (20260603) with builder profile with -O2 and -march=native, KFENCE on, KCFI on, UBSAN on, -D_FORTIFY_SOURCE on
