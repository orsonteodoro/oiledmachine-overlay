...
PKG_VER_DKMS="5.11.19.98-1290604"
...
DKMS_PKG_VER="${MY_RPR}"
DC_VER="3.2.140"
AMDGPU_VERSION="5.11.19.21.30"
ROCK_VER="4.3.0" # See changes in kfd keywords and tag ;  https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/tree/rocm-4.3.0/drivers/gpu/drm/amd/amdkfd

PATCHES=( "${FILESDIR}/amdgpu-dkms-20.40.1147287-makefile-recognize-gentoo.patch"
	  "${FILESDIR}/amdgpu-dkms-21.10.1247438-enable-mmu_notifier.patch"
	  "${FILESDIR}/amdgpu-dkms-21.30.1290604-no-firmware-install-and-no-dracut-changes.patch"
...
pkg_pretend() {
	ewarn "Kernels 5.0.x <= x <= 5.11.x are only supported."
