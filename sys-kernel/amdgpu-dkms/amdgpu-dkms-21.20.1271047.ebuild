...
PKG_VER_DKMS="5.11.5.26-1271047"
...
DKMS_PKG_VER="${MY_RPR}"
DC_VER="3.2.131"
AMDGPU_VERSION="5.11.5.21.20"
ROCK_VER="4.2.0" # See changes in kfd keywords and tag ;  https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/tree/rocm-4.2.0/drivers/gpu/drm/amd/amdkfd
...
PATCHES=( "${FILESDIR}/amdgpu-dkms-20.40.1147287-makefile-recognize-gentoo.patch"
	  ...
	  "${FILESDIR}/amdgpu-dkms-21.20.1271047-no-firmware-install-and-no-dracut-changes.patch"
