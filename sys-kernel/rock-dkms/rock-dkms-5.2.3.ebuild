...
DCN_VER="3.1.6" # See https://github.com/ROCm/ROCK-Kernel-Driver/blob/rocm-5.2.3/drivers/gpu/drm/amd/display/include/dal_types.h#L61
DKMS_MODULES=(
# Keep in sync with https://github.com/ROCm/ROCK-Kernel-Driver/blob/rocm-5.2.3/drivers/gpu/drm/amd/dkms/dkms.conf
...
KVS=(
# See https://github.com/ROCm/ROCm/blob/docs/5.2.3/docs/release/gpu_os_support.md#supported-distributions
...
# See also https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-5.2.3/drivers/gpu/drm/amd/dkms/sources
...
_copy_modules() {
	# Keep in sync with https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-5.2.3/drivers/gpu/drm/amd/dkms/dkms.conf
	IFS=$'\n'
...
einfo "CONFIG_GCC_VERSION:  ${CONFIG_GCC_VERSION}"
	...
	if ver_test ${kv} -ge 5.15 ; then
		...
		# "/" breaks with 5.4
		# Default M=/var/lib/dkms/amdgpu/5.2/build
		args+=( --dkmstree "/" )
		build_root="/rock_build"
	fi
	_build_clean
