...
AMDGPU_FIRMWARE_PV="6.12.12.604012"
GC_VER="12.0.1" # See https://github.com/ROCm/amdgpu/blob/rocm-6.4.3/drivers/gpu/drm/amd/amdgpu/gfx_v12_0.c
DC_VER="3.2.320" # See https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-6.4.3/drivers/gpu/drm/amd/display/dc/dc.h#L48
DCN_VER="4.0.1" # See https://github.com/ROCm/ROCK-Kernel-Driver/blob/rocm-6.4.3/drivers/gpu/drm/amd/display/include/dal_types.h#L61
KFD_IOCTL_VER="1.17" # See https://github.com/ROCm/amdgpu/blob/rocm-6.4.3/include/uapi/linux/kfd_ioctl.h
PSP_VER="14.0.5" # no kicker, See https://github.com/ROCm/amdgpu/blob/rocm-6.4.3/drivers/gpu/drm/amd/amdgpu/psp_v14_0.c
VCN_VER="5.0.1" # See https://github.com/ROCm/amdgpu/blob/rocm-6.4.3/drivers/gpu/drm/amd/amdgpu/amdgpu_vcn.c#L65

DKMS_MODULES=(
# Keep in sync with https://github.com/ROCm/ROCK-Kernel-Driver/blob/rocm-6.4.3/drivers/gpu/drm/amd/dkms/dkms.conf
...
KV="6.12.0" # See https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-6.4.3/Makefile#L2
KVS=(
...
# Compatible but not supported kernel versions:  4.18, 5.14, 6.5, 6.8, 6.11
...
"
PATCHES=(
	"${FILESDIR}/rock-dkms-6.4.3-kbuild-recognize-gentoo.patch"
...
# See also https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-6.4.3/drivers/gpu/drm/amd/dkms/sources
...
_copy_modules() {
	# Keep in sync with https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-6.4.3/drivers/gpu/drm/amd/dkms/dkms.conf
	IFS=$'\n'
