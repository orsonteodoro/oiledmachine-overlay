...
DCN_VER="3.2.1" # See https://github.com/ROCm/ROCK-Kernel-Driver/blob/rocm-5.6.1/drivers/gpu/drm/amd/display/include/dal_types.h#L61
DKMS_MODULES=(
# Keep in sync with https://github.com/ROCm/ROCK-Kernel-Driver/blob/rocm-5.6.1/drivers/gpu/drm/amd/dkms/dkms.conf
...
KVS=(
# See https://github.com/ROCm/ROCm/blob/rocm-5.6.1/docs/release/gpu_os_support.md#supported-linux-distributions
...
einfo "CONFIG_GCC_VERSION:  ${CONFIG_GCC_VERSION}"
	...
	if ver_test ${kv} -ge 5.15 ; then
		...
		# "/" breaks with 5.4
		# Default M=/var/lib/dkms/amdgpu/5.6/build
		args+=( --dkmstree "/" )
		build_root="/rock_build"
	fi
	_build_clean
...
# OILEDMACHINE-OVERLAY-STATUS:  builds-without-problems (5.6.1, 20231119, kernel 5.15.138)
# OILEDMACHINE-OVERLAY-TEST:  needs-retest (5.6.1, 20231121, kernel 5.15.138)
# OILEDMACHINE-OVERLAY-STATUS:  builds-without-problems (5.6.1, 20231119, kernel 5.4.260) w/ot-sources changes to /usr/src/linux-5.4.260-builder/scripts/Makefile.build at multi-used-m patch
