...
# For depends see:
# https://github.com/chromium/chromium/tree/124.0.6367.60/build/linux/sysroot_scripts/generated_package_lists				; Last update 20231117
...
# https://github.com/chromium/chromium/blob/124.0.6367.60/build/install-build-deps.py
...
# /var/tmp/portage/www-client/chromium-124.0.6367.60/work/chromium-124.0.6367.60/third_party/libjpeg_turbo/jconfig.h		L7	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-124.0.6367.60/work/chromium-124.0.6367.60/third_party/libwebp/src/configure.ac		L1	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-124.0.6367.60/work/chromium-124.0.6367.60/third_party/openh264/src/meson.build		L2
# /var/tmp/portage/www-client/chromium-124.0.6367.60/work/chromium-124.0.6367.60/third_party/opus/README.chromium		L3	; newer than generated_package_lists, live
#   https://gitlab.xiph.org/xiph/opus/-/commit/8cf872a1											; see tag
# /var/tmp/portage/www-client/chromium-124.0.6367.60/work/chromium-124.0.6367.60/third_party/zstd/README.chromium			; live version
...
# https://github.com/chromium/chromium/blob/124.0.6367.60/tools/clang/scripts/update.py#L38C41-L38C49 \
# grep 'CLANG_REVISION = ' ${S}/tools/clang/scripts/update.py -A1 | cut -c 18- # \
VENDORED_CLANG_VER="llvmorg-19-init-2941-ga0b3dbaf-22"
# https://github.com/chromium/chromium/blob/124.0.6367.60/tools/rust/update_rust.py#L37 \
...
# See https://github.com/chromium/chromium/blob/124.0.6367.60/media/gpu/args.gni#L24
#
...
#   https://github.com/chromium/chromium/blob/124.0.6367.60/sandbox/linux/BUILD.gn
#
CPU_FLAGS_ARM=(
	neon
)
...
#
#   https://github.com/chromium/chromium/blob/124.0.6367.60/media/filters/BUILD.gn#L160
#   https://github.com/chromium/chromium/blob/124.0.6367.60/media/media_options.gni#L38
#   https://github.com/chromium/chromium/blob/124.0.6367.60/media/base/supported_types.cc#L203
#   https://github.com/chromium/chromium/blob/124.0.6367.60/media/base/supported_types.cc#L284
#
# Codec upstream default:
#   https://github.com/chromium/chromium/blob/124.0.6367.60/tools/mb/mb_config_expectations/chromium.linux.json#L89
#

#
# For cfi-vcall, cfi-icall defaults status, see \
#   https://github.com/chromium/chromium/blob/124.0.6367.60/build/config/sanitizers/sanitizers.gni
# For cfi-cast default status, see \
#   https://github.com/chromium/chromium/blob/124.0.6367.60/build/config/sanitizers/sanitizers.gni#L123
# For pgo default status, see \
#   https://github.com/chromium/chromium/blob/124.0.6367.60/build/config/compiler/pgo/pgo.gni#L15
# For libcxx default, see \
#   https://github.com/chromium/chromium/blob/124.0.6367.60/build/config/c++/c++.gni#L14
...
pre_build_checks() {
	...
	if use official ; then
	# https://github.com/chromium/chromium/blob/124.0.6367.60/docs/linux/build_instructions.md#system-requirements
...
einfo "Using the bundled toolchain"
	...
	# is_debug=false.
	#
	# See https://github.com/chromium/chromium/blob/124.0.6367.60/build/config/compiler/compiler.gni#L276
	#
	...
	# List obtained from /var/tmp/portage/www-client/chromium-124.0.6367.60/work/chromium-124.0.6367.60/build/linux/unbundle/
...
ewarn
	...
	# See https://github.com/chromium/chromium/blob/124.0.6367.60/media/media_options.gni#L19
...
einfo "Using ThinLTO"
	...
	# See https://github.com/chromium/chromium/blob/124.0.6367.60/build/config/sanitizers/BUILD.gn#L196
	# See https://github.com/chromium/chromium/blob/124.0.6367.60/tools/mb/mb_config.pyl#L2950
...
einfo
	...
	# See also https://github.com/chromium/chromium/blob/124.0.6367.60/docs/pgo.md
...
pkg_postinst() {
	...
	if ! use headless; then
		if use vaapi ; then
	# It says 3 args:
	# https://github.com/chromium/chromium/blob/124.0.6367.60/docs/gpu/vaapi.md#vaapi-on-linux
einfo
