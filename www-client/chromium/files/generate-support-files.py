...
def main():
    ...
    abi = os.environ['GENERATE_SUPPORT_ABI']
    menu_name = os.environ['GENERATE_SUPPORT_MENU_NAME']
    sym_name = os.environ['GENERATE_SUPPORT_SYM_NAME']
    ...
    context = {
        ...
        "USR_BIN_SYMLINK_NAME": f"{sym_name}",
    }
