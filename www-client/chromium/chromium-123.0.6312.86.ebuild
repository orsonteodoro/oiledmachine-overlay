...
# 122.0.6261.128 -> 123.0.6312.58

# For depends see:
# https://github.com/chromium/chromium/tree/123.0.6312.58/build/linux/sysroot_scripts/generated_package_lists				; Last update 20231117
...
# https://github.com/chromium/chromium/blob/123.0.6312.58/build/install-build-deps.py

#
# Additional DEPENDS versioning info:
#
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/dav1d/version/vcs_version.h#L2					; newer than generated_package_lists
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/fontconfig/include/config.h#L290                                 ; newer than generated_package_lists *missing
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/libaom/source/config/config/aom_version.h#L19			; newer than generated_package_lists
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/libpng/pnglibconf.h						; older than generated_package_lists *recheck
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/libxml/linux/config.h#L160					; older than generated_package_lists *recheck
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/libxslt/linux/config.h#L116					; newer than generated_package_lists
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/node/update_node_binaries#L18
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/re2/README.chromium#L4						; newer than generated_package_lists, (live) [rounded in ebuild]
# https://github.com/chromium/chromium/blob/123.0.6312.58/third_party/zlib/zlib.h#L40
# https://github.com/chromium/chromium/blob/123.0.6312.58/tools/rust/update_rust.py#L35						; commit
#   https://github.com/rust-lang/rust/blob/340bb19fea20fd5f9357bbfac542fad84fc7ea2b/src/version						; live version
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/flac/BUILD.gn			L122	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/freetype/src/CMakeLists.txt	L165	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/harfbuzz-ng/src/configure.ac	L3	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/icu/source/configure		L585	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/libdrm/src/meson.build		L24	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/libjpeg_turbo/jconfig.h		L7	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/libwebp/src/configure.ac		L1	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/third_party/openh264/src/meson.build		L2
...
# LLVM 19
CR_CLANG_USED="7c4c2746" # Obtained from \
# https://github.com/chromium/chromium/blob/123.0.6312.58/tools/clang/scripts/update.py#L42 \
# https://github.com/llvm/llvm-project/commit/7c4c2746
...
MITIGATION_URI="https://chromereleases.googleblog.com/2024/03/stable-channel-update-for-desktop_26.html"
...
VENDORED_CLANG_VER="llvmorg-19-init-2319-g7c4c2746-1"
# grep 'RUST_REVISION = ' ${S}/tools/rust/update_rust.py -A1 | cut -c 17- # \
VENDORED_RUST_VER="340bb19fea20fd5f9357bbfac542fad84fc7ea2b-3"
ZLIB_PV="1.3"
...
#   https://github.com/chromium/chromium/blob/123.0.6312.58/sandbox/linux/BUILD.gn
#
CPU_FLAGS_ARM=(
	neon
)
...
#
#   https://github.com/chromium/chromium/blob/123.0.6312.58/media/filters/BUILD.gn#L160
#   https://github.com/chromium/chromium/blob/123.0.6312.58/media/media_options.gni#L38
#   https://github.com/chromium/chromium/blob/123.0.6312.58/media/base/supported_types.cc#L203
#   https://github.com/chromium/chromium/blob/123.0.6312.58/media/base/supported_types.cc#L284
#
# Codec upstream default:
#   https://github.com/chromium/chromium/blob/123.0.6312.58/tools/mb/mb_config_expectations/chromium.linux.json#L89
#

#
# For cfi-vcall, cfi-icall defaults status, see \
#   https://github.com/chromium/chromium/blob/123.0.6312.58/build/config/sanitizers/sanitizers.gni
# For cfi-cast default status, see \
#   https://github.com/chromium/chromium/blob/123.0.6312.58/build/config/sanitizers/sanitizers.gni#L123
# For pgo default status, see \
#   https://github.com/chromium/chromium/blob/123.0.6312.58/build/config/compiler/pgo/pgo.gni#L15
# For libcxx default, see \
#   https://github.com/chromium/chromium/blob/123.0.6312.58/build/config/c++/c++.gni#L14
...
pre_build_checks() {
	...
	if use official ; then
	# https://github.com/chromium/chromium/blob/123.0.6312.58/docs/linux/build_instructions.md#system-requirements
...
# https://github.com/llvm/llvm-project/blob/7c4c2746/compiler-rt/include/profile/InstrProfData.inc#L653
...
einfo "Using the bundled toolchain"
	...
	# is_debug=false.
	#
	# See https://github.com/chromium/chromium/blob/123.0.6312.58/build/config/compiler/compiler.gni#L276
	#
	...
	# List obtained from /var/tmp/portage/www-client/chromium-123.0.6312.58/work/chromium-123.0.6312.58/build/linux/unbundle/
...
einfo "Using ThinLTO"
	...
	# See https://github.com/chromium/chromium/blob/123.0.6312.58/build/config/sanitizers/BUILD.gn#L196
	# See https://github.com/chromium/chromium/blob/123.0.6312.58/tools/mb/mb_config.pyl#L2950
...
einfo
	...
	# See also https://github.com/chromium/chromium/blob/123.0.6312.58/docs/pgo.md
...
pkg_postinst() {
	...
	if ! use headless; then
		if use vaapi ; then
	# It says 3 args:
	# https://github.com/chromium/chromium/blob/123.0.6312.58/docs/gpu/vaapi.md#vaapi-on-linux
einfo
