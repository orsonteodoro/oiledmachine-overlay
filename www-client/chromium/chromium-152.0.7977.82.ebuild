...
# 143.0.7499.169 -> 143.0.7499.192
# 143.0.7499.192 -> 144.0.7559.59
# 144.0.7559.59 -> 144.0.7559.109
# 144.0.7559.109 -> 144.0.7559.132
# 144.0.7559.132 -> 145.0.7632.45
...
# 145.0.7632.159 -> 146.0.7680.71
# 146.0.7680.71 -> 146.0.7680.75
# 146.0.7680.75 -> 146.0.7680.80
# 146.0.7680.80 -> 146.0.7680.153
# 146.0.7680.153 -> 146.0.7680.164
# 146.0.7680.164 -> 146.0.7680.177
# 146.0.7680.177 -> 147.0.7727.55
# 147.0.7727.55 -> 147.0.7727.137
# 147.0.7727.137 -> 148.0.7778.96
# 147.0.7778.96 -> 148.0.7778.167
# 148.0.7778.167 -> 149.0.7827.102
# 149.0.7827.102 -> 149.0.7827.114
# 149.0.7827.114 -> 150.0.7871.46
# 150.0.7871.46 -> 150.0.7871.114
# 150.0.7871.114 -> 150.0.7871.128
# 150.0.7871.128 -> 150.0.7871.181
# 150.0.7871.181 -> 151.0.7922.108
# 151.0.7922.108 -> 151.0.7922.137
# 151.0.7922.137 -> 151.0.7922.173
# 151.0.7922.173 -> 152.0.7977.82

#
# For depends see:
#
# https://github.com/chromium/chromium/tree/152.0.7977.82/build/linux/sysroot_scripts/generated_package_lists				# Stable, Last update 20250523, D11
...
# https://github.com/chromium/chromium/blob/152.0.7977.82/build/install-build-deps.py							# Stable
#
...
#
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/abseil-cpp/README.chromium					# Live
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/brotli/README.chromium						# Live
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/crc32c/README.chromium						# Stable used instead.  The commit id is newer than the suggested version but both are old.
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/dav1d/version/vcs_version.h#L2					# Live
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/flatbuffers							# Stable.  See also include/flatbuffers/base.h and goldens/cpp/basic_generated.h
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/highway								# Stable
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/jsoncpp								# Stable used instead.  Both the submodule and version are old, but the submodule is newer.
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/libaom/source/config/config/aom_version.h#L19			# Stable
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/libpng/png.h#L288							# Stable
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/libsecret								# Stable used instead.  The revision is newer than the suggested version.
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/libusb								# Stable
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/libvpx								# Live
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/libwebp								# Live, used the version suggested in cpe prefix not the commit
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/libxml/linux/config.h#L86						# Live
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/libxslt/linux/config.h#L116					# Stable
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/node/update_node_binaries#L18					# Stable, marked no for security-critical by upstream
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/re2								# Live.  Submodule is newer commit than readme.
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/simdutf								# Stable used instead.  The version listed is newer than the revision, so the version is used.
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/snappy								# Stable used instead.  The submodule is newer than the version.git.revision listed in readme, but
#																	# it is older than the latest commit tag.
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/sqlite/README.chromium						# Stable used instead.  Upstream uses custom fork.
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/spirv-headers							# Live.  Relaxed stable version used.
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/spirv-tools							# Live.  Relaxed stable version used.
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/wayland								# Stable
# https://github.com/chromium/chromium/tree/152.0.7977.82/third_party/wayland-protocols							# Stable used instead.  The submodule is old.
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/woff2/README.chromium						# Live
# https://github.com/chromium/chromium/blob/152.0.7977.82/third_party/zlib/zlib.h#L40							# Stable
# https://github.com/chromium/chromium/blob/152.0.7977.82/tools/rust/update_rust.py#L35							#


#   https://github.com/rust-lang/rust/blob/4c4205163abcbd08948b3efab796c543ba1ea687/src/version						# Live
# /usr/share/chromium/152.0.7977.82/sources/third_party/expat/README.chromium								# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/ffmpeg/README.chromium								# Live but old
# /usr/share/chromium/152.0.7977.82/sources/third_party/flac/BUILD.gn								L122	# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/fontconfig/src/fontconfig/fontconfig.h.in				L56     # Stable used instead, upstream provided old version id
# /usr/share/chromium/152.0.7977.82/sources/third_party/freetype/src/CMakeLists.txt						L165	# Live.  The readme is confusing.  The commit is used instead.
# /usr/share/chromium/152.0.7977.82/sources/third_party/harfbuzz/README.chromium							# Stable used instead, upstream provided old revision than tagged.
# /usr/share/chromium/152.0.7977.82/sources/third_party/icu/source/configure							L609	# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/libdrm/src/meson.build							L24	# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/libjpeg_turbo/src/jconfig.h						L7	# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/libyuv/README.chromium								# Live snapshot, main branch
# /usr/share/chromium/152.0.7977.82/sources/third_party/ninja/README.chromium								# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/openh264/src/meson.build						L2	# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/opus/README.chromium							L3	# Stable used instead of suggested old commit
#   https://gitlab.xiph.org/xiph/opus/-/commit/55513e81d8f606bd75d0ff773d2144e5f2a732f5							# Stable
# /usr/share/chromium/152.0.7977.82/sources/third_party/zstd/README.chromium								# Live
...
#
# https://github.com/chromium/chromium/blob/152.0.7977.82/DEPS#L542									# Live, for libcxx
#
# /usr/share/chromium/152.0.7977.82/sources/third_party/libc++/src/include/__configuration/compiler.h					# Stable, update LIBCXX_SLOT_MIN
...
# https://github.com/chromium/chromium/blob/152.0.7977.82/tools/clang/scripts/update.py#L42
...
#
# /usr/share/chromium/152.0.7977.82/sources/third_party/ffmpeg/libavutil/version.h
# /usr/share/chromium/152.0.7977.82/sources/third_party/ffmpeg/libavcodec/version*.h
# /usr/share/chromium/152.0.7977.82/sources/third_party/ffmpeg/libavformat/version*.h
#

# The unbundle build files logic is in
# /usr/share/chromium/152.0.7977.82/sources/build/linux/unbundle/replace_gn_files.py

# Use `USE="-system-clang -system-rust" ebuild chromium-toolchain-152.0.7977.82.ebuild digest clean unpack prepare compile install merge` to obtain numbers.
TC_COUNT_EXPECTED_CLANG=433
TC_COUNT_EXPECTED_GN=1305
TC_COUNT_EXPECTED_RUST=6991
SOURCES_COUNT_EXPECTED=572682
...
CFLAGS_HARDENED_VULNERABILITY_HISTORY="CE DF HO II IO ISPE IV NPD OOBA OOBR OOBW PE RC SO UAF TC"
CHROMIUM_SOURCES_PREFIX="/usr/share/chromium/${PV}/sources"
CHROMIUM_TOOLCHAIN=1
CHROMIUM_TOOLCHAIN_PREFIX="/usr/share/chromium/${PV%.*}.x/toolchain"
...
RE2_SLOT="20250512"
# https://github.com/chromium/chromium/blob/152.0.7977.82/tools/rust/update_rust.py#L37 \
...
OPENPOWER_PATCHES_COMMIT="a85b64f07b489b8c6fdb13ecf79c16c56c560fc6" # Same as PPC64_HASH
...
CHROMIUM_LANGS="${_CHROMIUM_LANGS[@]}"
...
MITIGATION_DATE="Sep 3, 2026" # Official annoucement (blog)
MITIGATION_LAST_UPDATE=1788381600 # From `date +%s -d "Sep 2, 2026 1:40 PM PDT"` From blog date
...
LLVM_COMPAT=(
	...
	# The latest slot *must* be used because any of the LTS will fail on of
	# the ~15 sanitizers tests.  The code generated from the failed ones may
	# result in miscompilation vulnerability that leads to sandbox escape.
...
is_cromite_compatible() {
	...
	if ver_test "${CROMITE_PV%%.*}" "-eq" "${PV%%.*}" && ver_test "${PV%.*}.${c4_min}" -le "${CROMITE_PV}" && ver_test "${CROMITE_PV}" -le "${PV%.*}.${c4_max}" ; then
		return 0
	else
		return 1
	fi
...
is_ungoogle_chromium_compatible() {
	...
	if ver_test "${UNGOOGLED_CHROMIUM_PV%%.*}" "-eq" "${PV%%.*}" && ver_test "${PV%.*}.${c4_min}" -le "${UNGOOGLED_CHROMIUM_PV%-*}" && ver_test "${UNGOOGLED_CHROMIUM_PV%-*}" -le "${PV%.*}.${c4_max}" ; then
		return 0
	else
		return 1
	fi
...
if is_cromite_compatible ; then
	...
	SRC_URI+="
		cromite? (
https://github.com/uazo/cromite/archive/refs/tags/v${CROMITE_PV}-${CROMITE_HASH}.tar.gz
...
# See https://github.com/chromium/chromium/blob/152.0.7977.82/media/gpu/args.gni#L24
#
...
#   https://github.com/chromium/chromium/blob/152.0.7977.82/sandbox/linux/BUILD.gn
#
...
#
#   https://github.com/chromium/chromium/blob/152.0.7977.82/media/filters/BUILD.gn#L160
#   https://github.com/chromium/chromium/blob/152.0.7977.82/media/media_options.gni#L38
#   https://github.com/chromium/chromium/blob/152.0.7977.82/media/base/supported_types.cc#L203
#   https://github.com/chromium/chromium/blob/152.0.7977.82/media/base/supported_types.cc#L284
#
# Codec upstream default:
#   https://github.com/chromium/chromium/blob/152.0.7977.82/tools/mb/mb_config_expectations/chromium.linux.json#L89
#

#
# For cfi-vcall, cfi-icall defaults status, see \
#   https://github.com/chromium/chromium/blob/152.0.7977.82/build/config/sanitizers/sanitizers.gni
# For cfi-cast default status, see \
#   https://github.com/chromium/chromium/blob/152.0.7977.82/build/config/sanitizers/sanitizers.gni#L123
# For pgo default status, see \
#   https://github.com/chromium/chromium/blob/152.0.7977.82/build/config/compiler/pgo/pgo.gni#L15
# For libcxx default, see \
#   https://github.com/chromium/chromium/blob/152.0.7977.82/build/config/c++/c++.gni#L14
...
COMMON_SNAPSHOT_DEPEND="
	...
	system-re2? (
		>=dev-libs/re2-0.2025.11.05:${RE2_SLOT}=[${LIBCXX_USEDEP_LTS},${LIBSTDCXX_USEDEP_LTS},${MULTILIB_USEDEP}]
	)
	system-simdutf? (
...
# For M149+ pipewire is a mandatory build-time dependency, but it's optional at
# runtime for most configurations.
RDEPEND+="
	${COMMON_DEPEND}
...
pre_build_checks() {
	...
	# https://github.com/chromium/chromium/blob/152.0.7977.82/docs/linux/build_instructions.md#system-requirements
...
eerror
eerror "The live merge time is old for ${pkg_name}."
eerror "Re-emerge =dev-lang/${pkg_name}-9999 or switch to Rust 1.96.0 or later to continue."
eerror
...
verify_compiler_flags_hardening() {
	...
	# system-* is marked security-critical by upstream in README.chromium.
		...
		"system-zlib:virtual/zlib:untrusted-data"
...
ewarn "This ebuild is still under maintenance."
	...
	local tc_count_expected_clang=${TC_COUNT_EXPECTED_RUST}
	local tc_count_expected_gn=${TC_COUNT_EXPECTED_GN}
	local tc_count_expected_rust=${TC_COUNT_EXPECTED_RUST}
	local tc_count_actual_clang=0
	local tc_count_actual_gn=0
	local tc_count_actual_rust=0
...
ewarn
ewarn "Actual file count (gn):  ${tc_count_actual_gn}"
ewarn "Actual file count (clang):  ${tc_count_actual_clang}"
ewarn "Actual file count (rust):  ${tc_count_actual_rust}"
ewarn "Actual file count (total):  ${tc_count_actual_total}"
ewarn
ewarn "Expected file count (gn):  ${tc_count_expected_gn}"
...
einfo
	...
	if use official ; then
	# Upstream default
	# 5% performance penalty, SSP-basic, performance-critical
		CFLAGS_HARDENED_SSP_LEVEL="1"
	else
	# Overlay default
	# 10% performance penalty, SSP-strong, security-critical
...
einfo "Unpacking test fonts ..."
		tar xf "${testfonts_tar}" -C "${testfonts_dir}" \
			|| die "Failed to unpack testfonts"
	fi
...
# Generated from `find /var/tmp/portage/www-client/chromium-152.0.7977.82/work/chromium-patches-151-1 | sort -V`
...
"${FILESDIR}/extra-patches/${PN}-151.0.7922.108-mold-unbundle.patch"					# Same as cr151-mold-unbundle.patch
		...
		COPIUM_PATCHSET=(
# Generated from `find /var/tmp/portage/www-client/chromium-152.0.7977.82/work/copium | sort -V`
...
einfo "Adding SupportedLaneCount"
	...
	# Apply the OpenPOWER patches (check for page size and isa 3.0)
			openpower_patches=(
				$(grep -E "^ppc64le|^upstream" "${patchset_dir}/series" | grep -v "${page_size_patch}" |
...
apply_oiledmachine_overlay_patchset() {
	[[ "${OILEDMACHINE_OVERLAY_PATCHSET:-1}" == "1" ]] || return
...
einfo "Applying the oiledmachine-overlay patchset ..."
	...
	PATCHES+=(
		...
		"${FILESDIR}/extra-patches/${PN}-152.0.7977.82-opus-optionalize-simd.patch"
		"${FILESDIR}/extra-patches/${PN}-148.0.7778.167-libwebp-optionalize-simd.patch"
...
einfo "Removing ${x} from cromite"
	...
	# The official USE flag in this ebuild fork tries to be exact as upstream.
		sed -i \
...
eerror
	...
	# See https://github.com/chromium/chromium/blob/152.0.7977.82/build/toolchain/cc_wrapper.gni#L36
	if ! use system-clang ; then
...
get_bindgen_libclang_path() {
	...
	if use system-clang ; then
		echo "${ESYSROOT}/usr/lib/llvm/${LLVM_SLOT}/$(get_libdir)"
	else
		echo "${ESYSROOT}${CHROMIUM_TOOLCHAIN_PREFIX}/clang/lib/clang/23/lib"
	fi
}
...
ewarn "For proper hardening, disable the pgo USE flag."
	...
	# See https://github.com/chromium/chromium/blob/152.0.7977.82/build/config/sanitizers/BUILD.gn#L196
	# See https://github.com/chromium/chromium/blob/152.0.7977.82/tools/mb/mb_config.pyl#L2950
...
_configure_performance_pgo(){
	...
	# See also https://github.com/chromium/chromium/blob/152.0.7977.82/docs/pgo.md
...
get_host_cpu() {
	...
	#
	# The vendored Clang may make x86-64 Level 2 ISA default but the AIs
	# assistants disagree with each other.
	#
	# TODO:  Review the claim with actual vendored Clang code review for the
	# march default.
	#
...
_configure_v8() {
	...
	# See L553 in /usr/share/chromium/152.0.7977.82/sources/v8/BUILD.gn
			if \
				[[ \
					"${ARCH}"  == "amd64" \
						|| \
...
_configure_features() {
	...
	# List obtained from /usr/share/chromium/152.0.7977.82/sources/build/linux/unbundle/
...
ewarn "Unbundling libs and lowering security"
	...
	# entries, etc. This enables slotting the ebuild.
		...
		"enable_openxr=false"							# https://github.com/chromium/chromium/tree/152.0.7977.82/device/vr#platform-support
...
#		"enable_speech_service=false"						# It is enabled but missing backend either local service or remote service.
		"enable_vr=false"							# https://github.com/chromium/chromium/blob/152.0.7977.82/device/vr/buildflags/buildflags.gni#L32
	...
	# It helps with the automated detection of ABI mismatches and prevents silent errors.
			...
			# Link pipewire directly instead of dynamic loading
	...
	# See https://github.com/chromium/chromium/blob/152.0.7977.82/media/media_options.gni#L19
...
ewarn "The system-re2 USE flag is experimental with multislot re2.  Consider disabling the system-re2 USE flag if it fails."
	...
	# System features
	# See also /usr/share/chromium/152.0.7977.82/sources/build/linux/unbundle/replace_gn_files.py
	myconf_gn+=(
	# Set used by distros
...
pkg_postinst() {
	...
	if ! use headless && [[ -z "${REPLACING_VERSIONS}" ]] ; then
		if use vaapi ; then
	# It says 3 args:
	# https://github.com/chromium/chromium/blob/152.0.7977.82/docs/gpu/vaapi.md#vaapi-on-linux
einfo
...
# OILEDMACHINE-OVERLAY-TEST: PASSED (interactive) 144.0.7559.80 (20260318) with ungoogled-chromium (146.0.7680.80-1), system-clang 23 (7319544), system-libcxx 23 (7319544), system-rust 1.96.0 (b41f22de2), and mold 2.40.4
# OILEDMACHINE-OVERLAY-TEST: PASSED (interactive) 146.0.7680.164 (20260330) with ungoogled-chromium (146.0.7680.164-1), system-clang 23 (7319544), system-libcxx 23 (7319544), system-rust 1.96.0 (b41f22de2), and mold 2.40.4
