...
# For depends see:
#
# https://github.com/chromium/chromium/tree/146.0.7680.80/build/linux/sysroot_scripts/generated_package_lists				# Stable, Last update 20250523, D11
...
# https://github.com/chromium/chromium/blob/146.0.7680.80/build/install-build-deps.py							# Stable
#
...
# https://github.com/chromium/chromium/blob/146.0.7680.80/third_party/abseil-cpp/README.chromium					# Live
# https://github.com/chromium/chromium/blob/146.0.7680.80/third_party/brotli/README.chromium						# Stable
# https://github.com/chromium/chromium/blob/146.0.7680.80/third_party/crc32c/README.chromium						# Stable
# https://github.com/chromium/chromium/blob/146.0.7680.80/third_party/dav1d/version/vcs_version.h#L2					# Stable
# https://github.com/chromium/chromium/tree/146.0.7680.80/third_party/flatbuffers							# Stable
# https://github.com/chromium/chromium/tree/146.0.7680.80/third_party/highway								# Live
# https://github.com/chromium/chromium/tree/146.0.7680.80/third_party/jsoncpp								# Stable, use commit to obtain closest tag.  The submodule is a newer version.
# https://github.com/chromium/chromium/blob/146.0.7680.80/third_party/libaom/source/config/config/aom_version.h#L19			# Stable
# https://github.com/chromium/chromium/blob/146.0.7680.80/third_party/libpng/png.h#L288							# Stable
# https://github.com/chromium/chromium/tree/146.0.7680.80/third_party/libsecret								# Stable
...
# /usr/share/chromium/146.0.7680.80/sources/third_party/harfbuzz-ng/README.chromium								# Stable
# /usr/share/chromium/146.0.7680.80/sources/third_party/icu/source/configure								L585	# Stable
# /usr/share/chromium/146.0.7680.80/sources/third_party/libdrm/src/meson.build								L24	# Stable
# /usr/share/chromium/146.0.7680.80/sources/third_party/libjpeg_turbo/src/jconfig.h							L7	# Stable
# /usr/share/chromium/146.0.7680.80/sources/third_party/libyuv/README.chromium								# Live snapshotable, main branch
# /usr/share/chromium/146.0.7680.80/sources/third_party/openh264/src/meson.build							L2	# Stable
...
#
# /usr/share/chromium/146.0.7680.80/sources/third_party/libc++/src/include/__configuration/compiler.h					# Stable, update LIBCXX_SLOT_MIN
...
# https://github.com/chromium/chromium/blob/146.0.7680.80/tools/clang/scripts/update.py#L42
...
#
# /usr/share/chromium/146.0.7680.80/sources/third_party/ffmpeg/libavutil/version.h
# /usr/share/chromium/146.0.7680.80/sources/third_party/ffmpeg/libavcodec/version*.h
# /usr/share/chromium/146.0.7680.80/sources/third_party/ffmpeg/libavformat/version*.h
#

# The unbundle build files logic is in
# /usr/share/chromium/146.0.7680.80/sources/build/linux/unbundle/replace_gn_files.py

TC_COUNT_EXPECTED_CLANG=422
TC_COUNT_EXPECTED_GN=1074
TC_COUNT_EXPECTED_RUST=7087
SOURCES_COUNT_EXPECTED=539190
...
RE2_SLOT="20250512"
# https://github.com/chromium/chromium/blob/146.0.7680.80/tools/rust/update_rust.py#L37 \
...
QT6_PV="6.4.2"
UNGOOGLED_CHROMIUM_PV="146.0.7680.80-1"
...
MITIGATION_DATE="Mar 13, 2026" # Official annoucement (blog)
...
# See https://github.com/chromium/chromium/blob/146.0.7680.80/media/gpu/args.gni#L24
#
...
#   https://github.com/chromium/chromium/blob/146.0.7680.80/sandbox/linux/BUILD.gn
#
...
#
#   https://github.com/chromium/chromium/blob/146.0.7680.80/media/filters/BUILD.gn#L160
#   https://github.com/chromium/chromium/blob/146.0.7680.80/media/media_options.gni#L38
#   https://github.com/chromium/chromium/blob/146.0.7680.80/media/base/supported_types.cc#L203
#   https://github.com/chromium/chromium/blob/146.0.7680.80/media/base/supported_types.cc#L284
#
# Codec upstream default:
#   https://github.com/chromium/chromium/blob/146.0.7680.80/tools/mb/mb_config_expectations/chromium.linux.json#L89
#

#
# For cfi-vcall, cfi-icall defaults status, see \
#   https://github.com/chromium/chromium/blob/146.0.7680.80/build/config/sanitizers/sanitizers.gni
# For cfi-cast default status, see \
#   https://github.com/chromium/chromium/blob/146.0.7680.80/build/config/sanitizers/sanitizers.gni#L123
# For pgo default status, see \
#   https://github.com/chromium/chromium/blob/146.0.7680.80/build/config/compiler/pgo/pgo.gni#L15
# For libcxx default, see \
#   https://github.com/chromium/chromium/blob/146.0.7680.80/build/config/c++/c++.gni#L14
...
pre_build_checks() {
	...
	# https://github.com/chromium/chromium/blob/146.0.7680.80/docs/linux/build_instructions.md#system-requirements
...
eerror
	...
	# See https://github.com/chromium/chromium/blob/146.0.7680.80/build/toolchain/cc_wrapper.gni#L36
	if ! use system-clang ; then
...
ewarn "For proper hardening, disable the pgo USE flag."
	...
	# See https://github.com/chromium/chromium/blob/146.0.7680.80/build/config/sanitizers/BUILD.gn#L196
	# See https://github.com/chromium/chromium/blob/146.0.7680.80/tools/mb/mb_config.pyl#L2950
...
_configure_performance_pgo(){
	...
	# See also https://github.com/chromium/chromium/blob/146.0.7680.80/docs/pgo.md
...
_configure_v8() {
	...
	# See L553 in /usr/share/chromium/146.0.7680.80/sources/v8/BUILD.gn
			if \
				[[ \
					"${ARCH}"  == "amd64" \
						|| \
...
_configure_features() {
	...
	# List obtained from /usr/share/chromium/146.0.7680.80/sources/build/linux/unbundle/
...
ewarn "Unbundling libs and lowering security"
	...
	# entries, etc. This enables slotting the ebuild.
		...
		"enable_openxr=false"							# https://github.com/chromium/chromium/tree/146.0.7680.80/device/vr#platform-support
...
#		"enable_speech_service=false"						# It is enabled but missing backend either local service or remote service.
		"enable_vr=false"							# https://github.com/chromium/chromium/blob/146.0.7680.80/device/vr/buildflags/buildflags.gni#L32
	...
	# See https://github.com/chromium/chromium/blob/146.0.7680.80/media/media_options.gni#L19
...
ewarn "The system-re2 USE flag is experimental with multislot re2.  Consider disabling the system-re2 USE flag if it fails."
	...
	# System features
	# See also /usr/share/chromium/146.0.7680.80/sources/build/linux/unbundle/replace_gn_files.py
	myconf_gn+=(
	# Set used by distros
...
pkg_postinst() {
	...
	if ! use headless && [[ -z "${REPLACING_VERSIONS}" ]] ; then
		if use vaapi ; then
	# It says 3 args:
	# https://github.com/chromium/chromium/blob/146.0.7680.80/docs/gpu/vaapi.md#vaapi-on-linux
einfo
