...
# For depends see:
# https://github.com/chromium/chromium/tree/134.0.6998.35/build/linux/sysroot_scripts/generated_package_lists				; Last update 20240501
...
# https://github.com/chromium/chromium/blob/134.0.6998.35/build/install-build-deps.py

#
# Additional DEPENDS versioning info:
#
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/dav1d/version/vcs_version.h#L2					; newer than generated_package_lists *
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/libaom/source/config/config/aom_version.h#L19			; newer than generated_package_lists *
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/libpng/png.h#L288							; newer than generated_package_lists
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/libxml/linux/config.h#L86						; older than generated_package_lists *
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/libxslt/linux/config.h#L116					; newer than generated_package_lists *
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/node/update_node_binaries#L18					; *
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/re2/README.chromium#L4						; newer than generated_package_lists, (live) [rounded in ebuild]
# https://github.com/chromium/chromium/blob/134.0.6998.35/third_party/zlib/zlib.h#L40
# https://github.com/chromium/chromium/blob/134.0.6998.35/tools/rust/update_rust.py#L35							; commit
#   https://github.com/rust-lang/rust/blob/8a1f8039a7ded79d3d4fe97b110016d89f2b11e2/src/version						; live version
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/flac/BUILD.gn			L122	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/fontconfig/src/fontconfig/fontconfig.h L54 ; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/freetype/src/CMakeLists.txt	L165	; newer than generated_package_lists *
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/third_party/harfbuzz-ng/README.chromium	; newer than generated_package_lists *
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/icu/source/configure		L585	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/libdrm/src/meson.build		L24	; newer than generated_package_lists *
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/libjpeg_turbo/jconfig.h		L7	; newer than generated_package_lists
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/libwebp/src/configure.ac		L1	; newer than generated_package_lists *
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/openh264/src/meson.build		L2
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/opus/README.chromium		L3	; newer than generated_package_lists, live
#   https://gitlab.xiph.org/xiph/opus/-/commit/8cf872a186b96085b1bb3a547afd598354ebeb87							; see tag
# /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/third_party/zstd/README.chromium			; live version *
...
# https://github.com/chromium/chromium/blob/134.0.6998.35/DEPS#L512									; live
...
CROMITE_COMMIT="387be3e56b1132799a2508ab8ab5a7e5e2635a7e" # Based on most recent either tools/under-control/src/RELEASE or build/RELEASE
CROMITE_PV="134.0.6998.35"
...
# https://github.com/chromium/chromium/blob/134.0.6998.35/tools/clang/scripts/update.py#L42 \
...
LLVM_MAX_SLOT="${LLVM_COMPAT[0]}" # Max is the same slot listed in https://github.com/chromium/chromium/blob/134.0.6998.35/tools/clang/scripts/update.py#L42
...
MESA_PV="20.3.5"
MITIGATION_DATE="Mar 4, 2025" # Official annoucement (blog)
MITIGATION_LAST_UPDATE=1740513300 # From `date +%s -d "2025-02-25 11:55 AM PST"` From tag in GH
MITIGATION_URI="https://chromereleases.googleblog.com/2025/03/stable-channel-update-for-desktop.html"
VULNERABILITIES_FIXED=(
	"CVE-2025-1914;DoS, DT, ID;High"
	"CVE-2025-1918;DoS, DT, ID;High"
	"CVE-2025-1919;DoS, DT, ID;High"
	"CVE-2025-1916;SE, DoS, DT, ID;High"
	"CVE-2025-1915;SE, DT, ID;High"
	"CVE-2025-1923;SE, UI, DT;Medium"
	"CVE-2025-1922;SE, UI, DT;Medium"
	"CVE-2025-1917;UI, DT;Medium"
	"CVE-2025-1921;ID;Medium"
)
...
PYTHON_REQ_USE="xml(+)"
QT6_PV="6.4.2"
UNGOOGLED_CHROMIUM_PV="134.0.6998.35-1"
...
# See https://github.com/chromium/chromium/blob/134.0.6998.35/media/gpu/args.gni#L24
#
...
#   https://github.com/chromium/chromium/blob/134.0.6998.35/sandbox/linux/BUILD.gn
#
CPU_FLAGS_ARM=(
	bti
	neon
...
#
#   https://github.com/chromium/chromium/blob/134.0.6998.35/media/filters/BUILD.gn#L160
#   https://github.com/chromium/chromium/blob/134.0.6998.35/media/media_options.gni#L38
#   https://github.com/chromium/chromium/blob/134.0.6998.35/media/base/supported_types.cc#L203
#   https://github.com/chromium/chromium/blob/134.0.6998.35/media/base/supported_types.cc#L284
#
# Codec upstream default:
#   https://github.com/chromium/chromium/blob/134.0.6998.35/tools/mb/mb_config_expectations/chromium.linux.json#L89
#

#
# For cfi-vcall, cfi-icall defaults status, see \
#   https://github.com/chromium/chromium/blob/134.0.6998.35/build/config/sanitizers/sanitizers.gni
# For cfi-cast default status, see \
#   https://github.com/chromium/chromium/blob/134.0.6998.35/build/config/sanitizers/sanitizers.gni#L123
# For pgo default status, see \
#   https://github.com/chromium/chromium/blob/134.0.6998.35/build/config/compiler/pgo/pgo.gni#L15
# For libcxx default, see \
#   https://github.com/chromium/chromium/blob/134.0.6998.35/build/config/c++/c++.gni#L14
...
COMMON_SNAPSHOT_DEPEND="
	...
	system-libaom? (
		>=media-libs/libaom-3.11.0[${MULTILIB_USEDEP}]
		media-libs/libaom:=
	)
	system-libjpeg-turbo? (
	...
	system-libxslt? (
		>=dev-libs/libxslt-1.1.43[${MULTILIB_USEDEP}]
		dev-libs/libxslt:=
	)
	system-re2? (
...
pre_build_checks() {
	...
	if use official ; then
	# https://github.com/chromium/chromium/blob/134.0.6998.35/docs/linux/build_instructions.md#system-requirements
...
einfo "Using the bundled toolchain"
	...
	# is_debug=false.
	#
	# See https://github.com/chromium/chromium/blob/134.0.6998.35/build/config/compiler/compiler.gni#L276
	#
	...
	# List obtained from /var/tmp/portage/www-client/chromium-134.0.6998.35/work/chromium-134.0.6998.35/build/linux/unbundle/
...
ewarn
	...
	myconf_gn+=" enable_openxr=false"	# https://github.com/chromium/chromium/tree/134.0.6998.35/device/vr#platform-support
	myconf_gn+=" enable_vr=false"		# https://github.com/chromium/chromium/blob/134.0.6998.35/device/vr/buildflags/buildflags.gni#L32
...
ewarn "The new V8 Sandbox [for the JavaScript engine] (2024) will be automagic off.  Consider using 64-bit only."
	...
	# See https://github.com/chromium/chromium/blob/134.0.6998.35/media/media_options.gni#L19
...
einfo "Using Mold without LTO"
	...
	# See https://github.com/chromium/chromium/blob/134.0.6998.35/build/config/sanitizers/BUILD.gn#L196
	# See https://github.com/chromium/chromium/blob/134.0.6998.35/tools/mb/mb_config.pyl#L2950
...
einfo
	...
	# See also https://github.com/chromium/chromium/blob/134.0.6998.35/docs/pgo.md
...
eerror
	...
	# See https://github.com/chromium/chromium/blob/134.0.6998.35/build/toolchain/cc_wrapper.gni#L36
	if ! use system-toolchain ; then
...
pkg_postinst() {
	...
	if ! use headless; then
		if use vaapi ; then
	# It says 3 args:
	# https://github.com/chromium/chromium/blob/134.0.6998.35/docs/gpu/vaapi.md#vaapi-on-linux
einfo
