...
MITIGATION_DATE="Jun 30, 2026" # Official annoucement (blog)
MITIGATION_LAST_UPDATE=1782257820 # From `date +%s -d "Jun 23, 2026 4:37 PM PDT"` From tag in GH or upstream repo
MITIGATION_URI="https://chromereleases.googleblog.com/2026/06/stable-channel-update-for-desktop_0175352312.html"
...
einfo "Applying the distro patchset ..."
	...
	if use system-clang ; then
		PATCHES+=(
			...
			"${WORKDIR}/chromium-patches-${PATCH_VER}/common/cr150-module-sysroot.patch"
