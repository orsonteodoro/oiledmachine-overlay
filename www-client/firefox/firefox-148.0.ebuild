...
MITIGATION_DATE="Feb 24, 2026" # Advisory date
MITIGATION_LAST_UPDATE=1771884300 # From `date +%s -d "2026-02-23 14:05"` from ftp date matching version in report
MITIGATION_URI="https://www.mozilla.org/en-US/security/advisories/mfsa2026-06/"
SEVERITY_LABEL="Severity:"
VULNERABILITIES_FIXED=(
	"CVE-2026-2757;ZC, DoS, DT, ID;Critical"
	"CVE-2026-2794;ID;High"
	"CVE-2026-2758;ZC, UAF, DoS, DT, ID;Critical"
	"CVE-2026-2759;ZC, DoS, DT, ID;Critical"
	"CVE-2026-2795;ZC, UAF, DoS, DT, ID;Critical"
	...
	"CVE-2026-2796;ZC, DoS, DT, ID;Critical"
	"CVE-2026-2797;ZC, UAF, DoS, DT, ID;Critical"
	...
	"CVE-2026-2798;UAF, DoS, DT, ID;High"
	"CVE-2026-2769;UAF, DoS, DT, ID;High"
	"CVE-2026-2799;ZC, UAF, DoS, DT, ID;Critical"
...
CDEPEND="
	...
	system-icu? (
		>=dev-libs/icu-78.1[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP},${MULTILIB_USEDEP}]
		dev-libs/icu:=
	)
	system-jpeg? (
