...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils multilib multilib-minimal multilib-build mozconfig-v6.45 pax-utils fdo-mime autotools virtualx mozlinguas-v2
