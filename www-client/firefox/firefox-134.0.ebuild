...
# https://www.mozilla.org/en-US/firefox/133.0/system-requirements/
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/moz.configure
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/dom/media/platforms/ffmpeg//FFmpegRuntimeLinker.cpp L41 [y component in x.y.z subslot in ebuild.  >= n0.8 for 53]
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/build/moz.configure/nss.configure L12
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/gfx/graphite2/include/graphite2/Font.h L31
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/gfx/harfbuzz/moz.yaml
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/intl/icu/source/common/unicode/uvernum.h L63
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/ipc/chromium/src/third_party/libevent/configure.ac L8
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/media/libaom/config/aom_version.h L7 [old]
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/media/libjpeg/jconfig.h L7
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/media/libpng/png.h L281
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/media/libvpx/config/vpx_version.h L8
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/media/libwebp/moz.yaml L16
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/modules/freetype2/include/freetype/freetype.h L5175
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/nsprpub/pr/include/prinit.h L35
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/third_party/dav1d/meson.build L26
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/third_party/pipewire/pipewire/version.h L49
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/taskcluster/kinds/toolchain/nasm.yml
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/taskcluster/kinds/toolchain/node.yml
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/taskcluster/kinds/toolchain/rust.yml
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/taskcluster/kinds/fetch/toolchains.yml
#   Keyword searches:  cbindgen-, llvm-, pkgconf-, zlib
# /var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0/taskcluster
#   Keyword search:  gtk
...
SRC="/var/tmp/portage/www-client/firefox-133.0/work/firefox-133.0"
grep -E \
	-e "[0-9]+\.[0-9]+(\.[0-9]+)?" \
	-e "dependency" \
	-e "find_library" \
...
MITIGATION_LAST_UPDATE=1736202180 # From `date +%s -d "2025-01-06 14:23"` from ftp date matching version in report
MITIGATION_URI="https://www.mozilla.org/en-US/security/advisories/mfsa2025-01/"
SEVERITY_LABEL="Severity:"
VULNERABILITIES_FIXED=(
	"CVE-2025-0242;ZC,CE,DT,ID;Medium"
	"CVE-2025-0244;ZC,ID;Medium"
	"CVE-2025-0238;ZC,ID;Medium"
	"CVE-2025-0243;CE,DT,ID;Medium"
	"CVE-2025-0237;PE,DT,ID;Medium"
	"CVE-2025-0246;DT,ID;Medium"
	"CVE-2025-0241;DoS,DT;Medium"
	"CVE-2025-0247;CE,DT;?"
	"CVE-2025-0239;DT;Medium"
	"CVE-2025-0240;DT;Medium"
	"CVE-2025-0245;ID;Low"
)
MOZ_ESR=
MOZ_LANGS=(
