...
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/moz.configure
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/dom/media/platforms/ffmpeg//FFmpegRuntimeLinker.cpp L41  [y component in x.y.z subslot in ebuild.  >= n0.8 for 53]
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/build/moz.configure/nss.configure L12
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/gfx/graphite2/include/graphite2/Font.h L31
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/gfx/harfbuzz/configure.ac L3
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/intl/icu/source/common/unicode/uvernum.h L63
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/ipc/chromium/src/third_party/libevent/configure.ac L8
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/media/libaom/config/aom_version.h L7 [old]
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/media/libjpeg/jconfig.h L7
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/media/libpng/png.h L281
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/media/libvpx/config/vpx_version.h L8
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/media/libwebp/moz.yaml L16
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/modules/freetype2/include/freetype/freetype.h L5223
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/nsprpub/pr/include/prinit.h L35
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/third_party/dav1d/meson.build L26
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/third_party/pipewire/pipewire/version.h L49
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/taskcluster/kinds/toolchain/nasm.yml
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/taskcluster/kinds/toolchain/node.yml
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/taskcluster/kinds/toolchain/rust.yml
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/taskcluster/kinds/fetch/toolchains.yml
#   Keyword searches:  cbindgen-, llvm-, pkgconf-, zlib
# /var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0/taskcluster
#   Keyword search:  gtk
...
SRC="/var/tmp/portage/www-client/firefox-128.4.0e/work/firefox-128.4.0"
grep -E \
	-e "[0-9]+\.[0-9]+(\.[0-9]+)?" \
	-e "dependency" \
	-e "find_library" \
...
VULNERABILITIES_FIXED=(
	...
	"CVE-2024-10461;DT, ID;Moderate"
	"CVE-2024-10462;DT, ID;Moderate"
	"CVE-2024-10463;ID;Moderate"
	"CVE-2024-10468;DoS;Moderate"
	"CVE-2024-10464;DoS;Low"
	"CVE-2024-10465;DT, ID;Low"
	"CVE-2024-10466;DoS;Low"
	"CVE-2024-10467;CE, DT;Moderate"
)
MOZ_ESR="yes"
MOZ_LANGS=(
