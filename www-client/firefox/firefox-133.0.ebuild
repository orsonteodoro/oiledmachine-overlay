...
VULNERABILITIES_FIXED=(
	...
	"CVE-2024-11705;ZC, DoS, DT, ID;Critical"
	"CVE-2024-11691;DoS, DT, ID;High"
	"CVE-2024-11700;DoS, DT, ID;High"
	"CVE-2024-11697;DoS, DT, ID;High"
	"CVE-2024-11699;DoS, DT, ID;High"
	"CVE-2024-11694;DT, ID;Medium"
	"CVE-2024-11695;DT, ID;Medium"
	"CVE-2024-11703;DT, ID;Medium"
	"CVE-2024-11702;ID;High"
	"CVE-2024-11701;DT;Medium"
	"CVE-2024-11692;DT;Medium"
	"CVE-2024-11708;DT;Medium"
	"CVE-2024-11706;DoS;Medium"
...
gen_ffmpeg_royalty_free_depends() {
	...
	for s in ${FFMPEG_COMPAT} ; do
		echo "
			(
				!<dev-libs/openssl-3
				media-video/ffmpeg:${s}[${MULTILIB_USEDEP},-amr,-cuda,dav1d?,-fdk,-kvazaar,-nvdec,-nvenc,-openh264,openssl,opus?,-patent_status_nonfree,vaapi?,vpx?,-x264,-x265]
			)
			(
				media-video/ffmpeg:${s}[${MULTILIB_USEDEP},-amr,-cuda,dav1d?,-fdk,-kvazaar,-nvdec,-nvenc,-openh264,-openssl,opus?,-patent_status_nonfree,vaapi?,vpx?,-x264,-x265]
			)
