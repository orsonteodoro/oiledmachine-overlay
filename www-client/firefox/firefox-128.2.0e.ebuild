...
# https://www.mozilla.org/en-US/firefox/128.2.0/system-requirements/
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/moz.configure
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/dom/media/platforms/ffmpeg//FFmpegRuntimeLinker.cpp L41  [y component in x.y.z subslot in ebuild.  >= n0.8 for 53]
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/build/moz.configure/nss.configure L12
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/gfx/graphite2/include/graphite2/Font.h L31
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/gfx/harfbuzz/configure.ac L3
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/intl/icu/source/common/unicode/uvernum.h L63
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/ipc/chromium/src/third_party/libevent/configure.ac L8
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/media/libaom/config/aom_version.h L7 [old]
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/media/libjpeg/jconfig.h L7
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/media/libpng/png.h L281
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/media/libvpx/config/vpx_version.h L8
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/media/libwebp/moz.yaml L16
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/modules/freetype2/include/freetype/freetype.h L5223
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/nsprpub/pr/include/prinit.h L35
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/third_party/dav1d/meson.build L26
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/third_party/pipewire/pipewire/version.h L49
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/taskcluster/ci/fetch/toolchains.yml
#   Keyword searches:  cbindgen-, llvm-, pkgconf-, rust-
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/taskcluster/ci/packages/
#   Keyword search:  gtk
# /var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0/taskcluster/ci/toolchain/
...
SRC="/var/tmp/portage/www-client/firefox-128.2.0e/work/firefox-128.2.0"
grep -E \
	-e "[0-9]+\.[0-9]+(\.[0-9]+)?" \
	-e "dependency" \
	-e "find_library" \
...
MITIGATION_URI="https://www.mozilla.org/en-US/security/advisories/mfsa2024-40/"
MOZ_ESR="yes"
MOZ_LANGS=(
...
ewarn "The oiledmachine-overlay patchset is not ready.  Skipping."
	...
	_eapply_oiledmachine_set "${FILESDIR}/extra-patches/${PN}-106.0.2-disable-broken-flags-js.patch"
	...
	_eapply_oiledmachine_set "${FILESDIR}/extra-patches/${PN}-115e-allow-ffmpeg-decode-av1.patch"
	_eapply_oiledmachine_set "${FILESDIR}/extra-patches/${PN}-115e-disable-ffvpx.patch"

	# Prevent tab crash
	_eapply_oiledmachine_set "${FILESDIR}/extra-patches/${PN}-106.0.2-disable-broken-flags-dom-bindings.patch"

	# Prevent video seek bug
	_eapply_oiledmachine_set "${FILESDIR}/extra-patches/${PN}-106.0.2-disable-broken-flags-ipc-chromium-chromium-config.patch"
