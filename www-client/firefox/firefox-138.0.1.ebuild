...
# https://www.mozilla.org/en-US/firefox/138.0.1/system-requirements/
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/moz.configure
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/dom/media/platforms/ffmpeg//FFmpegRuntimeLinker.cpp L41 [y component in x.y.z subslot in ebuild.  >= n0.8 for 53]
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/build/moz.configure/nss.configure L12
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/gfx/graphite2/include/graphite2/Font.h L31
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/gfx/harfbuzz/moz.yaml
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/intl/icu/source/common/unicode/uvernum.h L63
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/ipc/chromium/src/third_party/libevent/configure.ac L8
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/media/libaom/config/aom_version.h L7 [old]
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/media/libjpeg/jconfig.h L7
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/media/libpng/png.h L281
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/media/libvpx/config/vpx_version.h L8
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/media/libwebp/moz.yaml L16
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/modules/freetype2/include/freetype/freetype.h L5175
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/nsprpub/pr/include/prinit.h L35
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/third_party/dav1d/meson.build L26
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/third_party/pipewire/pipewire/version.h L49
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/taskcluster/kinds/toolchain/nasm.yml
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/taskcluster/kinds/toolchain/node.yml
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/taskcluster/kinds/toolchain/rust.yml
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/taskcluster/kinds/fetch/toolchains.yml
#   Keyword searches:  cbindgen-, llvm-, pkgconf-, zlib
# /var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1/taskcluster
#   Keyword search:  gtk
...
SRC="/var/tmp/portage/www-client/firefox-138.0.1/work/firefox-138.0.1"
grep -E \
	-e "[0-9]+\.[0-9]+(\.[0-9]+)?" \
	-e "dependency" \
	-e "find_library" \
...
MITIGATION_LAST_UPDATE=1746087420 # From `date +%s -d "2025-05-01 01:17"` from ftp date matching version in report
MITIGATION_URI="https://www.mozilla.org/en-US/security/advisories/mfsa2025-28/"
SEVERITY_LABEL="Severity:"
VULNERABILITIES_FIXED=(
	# 20250429
	"CVE-2025-2817;PE, DoS, DT, ID;High"
	"CVE-2025-4082;MC, OOB;"
	"CVE-2025-4083;ZC, SE, DT, ID;Critical"
	"CVE-2025-4085;EP, ID;"
	"CVE-2025-4086;ZC, DT, ID;Medium"
	"CVE-2025-4087;MC, OOB;"
	"CVE-2025-4088;ZC, XSRF, DT, ID;Medium"
	"CVE-2025-4089;CE, DT, ID;Medium"
	"CVE-2025-4090;ZC, DT, ID;Medium"
	"CVE-2025-4091;ZC, MC, CE, DT, ID;Medium"
	"CVE-2025-4092;ZC, MC, CE, DT, ID;Medium"
)
MOZ_ESR=
MOZ_LANGS=(
