...
RDEPEND="dev-libs/libxml2
	...
	javascript? ( dev-libs/nsgenbind
                      =dev-lang/spidermonkey-1.8.7-r3 )
	jpeg? ( virtual/jpeg
		amd64? ( abi_x86_32? ( app-emulation/emul-linux-x86-baselibs ) ) )
...
src_prepare() {
	...
	netsurf_src_prepare
	cd ${WORKDIR}
        sed -i "s|mozjs185|mozjs187|g" netsurf-3.0-abi_x86_x32.x32/framebuffer/Makefile.target
        sed -i "s|mozjs185|mozjs187|g" netsurf-3.0-abi_x86_x32.x32/gtk/Makefile.target
        sed -i "s|mozjs185|mozjs187|g" netsurf-3.0/framebuffer/Makefile.target
	sed -i "s|mozjs185|mozjs187|g" netsurf-3.0/gtk/Makefile.target
}
