...
inherit autotools cflags-hardened check-compiler-switch chkl flag-o-matic flag-o-matic-om libcxx-slot libstdcxx-slot multilib postgres secure-version systemd
