...
inherit autotools cflags-hardened check-reqs chkl flag-o-matic multiprocessing pax-utils
inherit python-utils-r1 secure-version toolchain-funcs verify-sig
