...
#end program
#EOF
#/usr/lib64/rocm/5.1/bin/flang hello.f90 -L/usr/lib64/rocm/5.1/llvm/lib64 -o hello.exe
#LD_LIBRARY_PATH="/usr/lib64/rocm/5.1/llvm/lib64" ./hello.exe
