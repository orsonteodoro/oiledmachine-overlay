...
src_compile() {
	local gcc_slot="${HIP_5_4_GCC_SLOT}"
	gcc_slot="${gcc_slot%%.*}"
...
#end program
#EOF
#/usr/lib64/rocm/5.4/bin/flang hello.f90 -L/usr/lib64/rocm/5.4/llvm/lib64 -o hello.exe
#LD_LIBRARY_PATH="/usr/lib64/rocm/5.4/llvm/lib64" ./hello.exe
