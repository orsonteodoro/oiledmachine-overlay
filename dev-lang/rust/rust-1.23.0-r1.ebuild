...
IUSE+=" ${_ABIS}"
# you can choose only one either x86_64 or x86 because there is no eselect to switch between x86_64 or x86 rust
# 32 bit rust is used for 32 bit Firefox on 64 bit multilib.
REQUIRED_USE+=" ^^ ( ${_ABIS} )"
IUSE+=" ycmd"
...
#multilib is required for 32 bit firefox on 64 bit
multilib_src_configure() {
	...
	local rust_target_name="CHOST_${_ARCH}"
