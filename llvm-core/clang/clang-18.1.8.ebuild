...
inherit check-compiler-switch chkl cmake dhms flag-o-matic git-r3 hip-versions libstdcxx-slot llvm.org llvm-utils multilib
...
PDEPEND+="
	...
	~llvm-runtimes/clang-runtime-${LLVM_VERSION}:${LLVM_MAJOR}
"
RESTRICT="
	!test? (
		test
