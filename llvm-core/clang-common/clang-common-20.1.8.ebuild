...
bootstrap-prefix cet default-compiler-rt default-libcxx default-lld emacs
...
PDEPEND="
	...
	>=llvm-runtimes/clang-runtime-${LLVM_VERSION}:${LLVM_MAJOR}[default-compiler-rt(-)?,default-libcxx(-)?,default-lld(-)?,llvm-libunwind(-)?]
	default-compiler-rt? (
		!llvm-libunwind? (
