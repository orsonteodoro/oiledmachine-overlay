...
if [[ "${PV}" =~ "9999" ]] ; then
	FALLBACK_COMMIT="b829f838fc5d8c93437faa5db44a5396b67893de"
	EGIT_BRANCH="main"
...
IUSE+="
audit bluetooth +concheck connection-sharing debug dhclient dhcpcd elogind
gnutls gtk-doc +introspection iptables iwd libedit +modemmanager nbft +nss
