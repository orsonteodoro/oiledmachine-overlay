...
CFLAGS_HARDENED_VULNERABILITY_HISTORY="BOR CE DOS MC ML OF OOBW SO UAF"

inherit cflags-hardened systemd optfeature secure-version toolchain-funcs

if [[ ${PV} == 9999 ]]; then
	EGIT_BRANCH="master"
	EGIT_REPO_URI="https://github.com/NetworkConfiguration/dhcpcd.git"
	FALLBACK_COMMIT="1f5937625511ee806b314d3223717ed087b42dc4"
