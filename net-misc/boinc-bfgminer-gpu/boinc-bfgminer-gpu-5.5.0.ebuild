...
DESCRIPTION="Modular Bitcoin GPU miner in C"
...
IUSE="adl examples hardened keccak +libusb lm_sensors ncurses +opencl proxy proxy_getwork proxy_stratum screen scrypt +sha256d +udev udev-broad-rules unicode"
...
src_install() {
	...
	mv "${D}"/usr/bin/bfgminer-rpc "${D}"/usr/bin/bfgminer-gpu-rpc
}
