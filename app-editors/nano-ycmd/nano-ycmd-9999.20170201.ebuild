...
COMMIT="eaaf08e4a1e3732f0a6478986f87d97a050c158f"
...
src_configure() {
	...
	*-gnu*|*-uclibc*) myconf+=( "--with-wordbounds" ) ;; #467848
	...
	PYTHON_PATH="/usr/bin/${EPYTHON}" RACERD_PATH="/usr/bin/racerd" RUST_SRC_PATH="/usr/share/rust/src" GODEF_PATH="/usr/bin/godef" GOCODE_PATH="/usr/bin/gocode" YCMD_PATH="/usr/$(get_libdir)/${EPYTHON}/site-packages/ycmd" \
	econf \
		--bindir="${EPREFIX}"/bin \
		--htmldir=/trash \
