...
CFLAGS_HARDENED_USE_CASES="critical-security sensitive-data untrusted-data"
CFLAGS_HARDENED_VULNERABILITY_HISTORY="DOS"
PYTHON_COMPAT=( python3_{11..14} )
TMPFILES_OPTIONAL=1

inherit cflags-hardened linux-info meson-multilib python-any-r1 readme.gentoo-r1 systemd tmpfiles virtualx
