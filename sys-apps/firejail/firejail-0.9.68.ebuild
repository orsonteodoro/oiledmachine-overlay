...
# Generated by:
#find "${S}/etc"/{profile-m-z,profile-a-l} -name "*.profile" \
#	| cut -f 11 -d "/" \
#	| sed -e "s|\.profile||g" \
#	| sed -e "s|\.|_|g" \
#	| sort \
...
FIREJAIL_PROFILES=(
0ad 1password 2048-qt 7z 7za 7zr abiword abrowser acat adiff agetpkg
akonadi_control akregator alacarte alienarena alienarena-wrapper alpine alpinef
als amarok amule amuled android-studio anki anydesk aosp apack apktool
...
bitwarden blackbox bleachbit blender blender-2_8 bless blobby blobwars bluefish
...
bsdtar Builder build-systems-common bundle bunzip2 bzcat bzflag bzip2
...
celluloid checkbashisms cheese Cheese cherrytree chromium chromium-browser
chromium-browser-privacy chromium-common chromium-common-hardened_inc
chromium-freeworld cin cinelerra cksum clamav clamdscan clamdtop clamscan
clamtk clawsker claws-mail clementine clion clion-eap clipgrab clipit cliqz
clocks cmake cmus code code-oss codium cointop cola colorful colorful-wrapper
...
cower coyim cpio crawl crawl-tiles crow cryptocat Cryptocat curl cvlc cyberfox
Cyberfox darktable dbus-send dconf dconf-editor ddgr ddgtk deadbeef default
deluge desktopeditors devhelp devilspie devilspie2 dex2jar d-feet dia dig
digikam dillo dino dino-im discord Discord discord-canary DiscordCanary
discord-common display display-im6_q16 dnox dnscrypt-proxy dnsmasq Documents
dolphin dolphin-emu dooble dooble-qt4 dosbox dragon drawio drill dropbox
easystroke ebook-convert ebook-edit ebook-meta ebook-polish ebook-viewer
electron electron-mail electrum element-desktop elinks emacs email-common
empathy enchant enchant-2 enchant-lsmod enchant-lsmod-2 engrampa enox enpass
eo-common eog eom ephemeral epiphany equalx et etr etr-wrapper evince
...
fontforge font-manager fossamail FossaMail four-in-a-row fractal franz freecad
freecadcmd freeciv freeciv-gtk3 freeciv-mp-gtk3 freecol freemind
freeoffice-planmaker freeoffice-presentations freeoffice-textmaker freetube
freshclam Fritzing frogatto frozen-bubble ftp funnyboat gajim
gajim-history-manager galculator gallery-dl gapplication gcalccmd gcloud gconf
gconf-editor gconf-merge-schema gconf-merge-tree gconfpkg gconftool-2 geany
geary gedit geekbench geeqie gfeeds gget ghb ghostwriter gimp gimp-2_10
gimp-2_8 gist gist-paste git git-cola gitg github-desktop gitter Gitter gjs
...
gnome-twitch gnome-weather gnote gnubik godot goldendict goobox google-chrome
...
idea_sh imagej img2txt impressive imv inkscape inkview inox
io_github_lainsce_Notejot ipcalc ipcalc-ng iridium iridium-browser itch
jami-gnome jd-gui jdownloader JDownloader jerry jitsi jitsi-meet-desktop
jumpnbump jumpnbump-menu k3b kaffeine kalgebra kalgebramobile karbon kate kazam
kcalc kdeinit4 kdenlive kdiff3 keepass keepass2 keepassx keepassx2 keepassxc
...
latex latex-common lbunzip2 lbzcat lbzip2 leafpad less librecad libreoffice
librewolf librewolf-nightly lifeograph liferea lightsoff lincity-ng links
links2 links-common linphone lmms lobase localc lodraw loffice lofromtemplate
Logs loimpress lollypop lomath loweb lowriter lrunzip lrz lrzcat lrzip lrztar
lrzuntar lsar lugaru luminance-hdr lutris lximage-qt lxmusic lynx lyx lzcat
lzcmp lzdiff lzegrep lzfgrep lzgrep lzip lzless lzma lzmadec lzmainfo lzmore
lzop macrofusion Maelstrom magicor make makepkg man manaplus Maps marker
...
megaglest_editor meld mencoder mendeleydesktop menulibre meson meteo-qt
microsoft-edge microsoft-edge-beta microsoft-edge-dev midori min mindless
minecraft-launcher minetest minitube mirage mirrormagic mocp mousepad mp3splt
mp3splt-gtk mp3wrap mpd mpDris2 mpg123 mpg123-alsa mpg123_bin mpg123-id3dump
mpg123-jack mpg123-nas mpg123-openal mpg123-oss mpg123-portaudio mpg123-pulse
mpg123-strip mplayer mpsyt mpv mrrescue ms-excel ms-office ms-onenote
ms-outlook ms-powerpoint ms-skype ms-word mtpaint multimc multimc5 mumble mupdf
mupdf-gl mupdf-x11 mupdf-x11-curl mupen64plus muraster musescore musictube
musixmatch mutool mutt mypaint mypaint-ora-thumbnailer nano natron Natron
...
newsboat newsflash nextcloud nextcloud-desktop nheko nicotine nitroshare
nitroshare-cli nitroshare-nmh nitroshare-send nitroshare-ui node nodejs-common
nomacs noprofile notable notify-send npm nslookup nuclear nvim nvm nylas nyx
obs ocenaudio odt2txt oggsplt okular onboard onionshare-gui ooffice ooviewdoc
openarena openarena_ded openbox opencity openclonk open-invaders openmw
openmw-launcher openoffice_org openshot openshot-qt openstego openttd opera
opera-beta orage org_gnome_NautilusPreviewer ostrichriders otter-browser out123
p7zip palemoon pandoc parole patch pavucontrol pavucontrol-qt pcmanfm PCSX2
pcsxr pdfchain pdflatex pdfmod pdfsam pdftotext peek penguin-command photoflare
picard pidgin pinball pinball-wrapper ping pingus pinta pioneer pip pipe-viewer
pithos pitivi pix pkglog planmaker18 planmaker18free playonlinux pluma plv
pngquant polari ppsspp PPSSPPQt PPSSPPSDL pragha presentations18
...
qemu-system-x86_64 qgis qlipper QMediathekView qmmp qnapi QOwnNotes qpdfview
...
scorched3d-wrapper scorchwentbonkers scp Screenshot scribus sdat2img
seafile-applet seahorse seahorse-adventures seahorse-daemon seahorse-tool
seamonkey seamonkey-bin secret-tool server servo sftp sha1sum sha224sum
sha256sum sha384sum sha512sum shellcheck shortwave shotcut shotwell signal-cli
...
softmaker-common sol soundconverter sound-juicer spectacle spectral
spectre-meltdown-checker spotify sqlitebrowser ssh ssh-agent
standardnotes-desktop start-tor-browser start-tor-browser_desktop steam
steam-native steam-runtime stellarium strawberry straw-viewer strings studio_sh
...
tcpdump teams teams-for-linux teamspeak3 teeworlds telegram Telegram
telegram-desktop telnet terasology tex textmaker18 textmaker18free thunar
Thunar thunderbird thunderbird-beta thunderbird-wayland tilp tin tmux tor
tor-browser torbrowser tor-browser-ar tor-browser_ar tor-browser-ca
tor-browser_ca tor-browser-cs tor-browser_cs tor-browser-da tor-browser_da
tor-browser-de tor-browser_de tor-browser-el tor-browser_el tor-browser-en
tor-browser_en tor-browser-en-us tor-browser_en-US tor-browser-es
tor-browser_es tor-browser-es-es tor-browser_es-ES tor-browser-fa
tor-browser_fa tor-browser-fr tor-browser_fr tor-browser-ga-ie
tor-browser_ga-IE tor-browser-he tor-browser_he tor-browser-hu tor-browser_hu
tor-browser-id tor-browser_id tor-browser-is tor-browser_is tor-browser-it
tor-browser_it tor-browser-ja tor-browser_ja tor-browser-ka tor-browser_ka
tor-browser-ko tor-browser_ko torbrowser-launcher tor-browser-nb tor-browser_nb
tor-browser-nl tor-browser_nl tor-browser-pl tor-browser_pl tor-browser-pt-br
tor-browser_pt-BR tor-browser-ru tor-browser_ru tor-browser-sv-se
tor-browser_sv-SE tor-browser-tr tor-browser_tr tor-browser-vi tor-browser_vi
tor-browser-zh-cn tor-browser_zh-CN tor-browser-zh-tw tor-browser_zh-TW torcs
totem tracker transgui transmission-cli transmission-common transmission-create
...
transmission-show tremulous trojita truecraft ts3client_runscript_sh tshark
...
yt-dlp ytmdesktop zaproxy zart zathura zcat zcmp zdiff zeal ZeGrapher zegrep
zfgrep zforce zgrep zim zless zmore znew zoom zpaq zstd zstdcat zstdgrep
zstdless zstdmt zulip
)
