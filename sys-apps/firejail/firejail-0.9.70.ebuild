...
autokey-shell avidemux aweather awesome b2sum ballbuster ballbuster-wrapper
...
bleachbit blender blender-2_8 bless blobby blobwars bluefish bnox brackets
brasero brave brave-browser brave-browser-beta brave-browser-dev
brave-browser-nightly brave-browser-stable bsdcat bsdcpio bsdtar
build-systems-common bundle bunzip2 bzcat bzflag bzip2 cachy-browser caja
...
cameramonitor cantata cargo catfish cawbird celluloid checkbashisms cheese
cherrytree chromium chromium-browser chromium-browser-privacy chromium-common
chromium-common-hardened_inc chromium-freeworld cin cinelerra cksum clamav
clamdscan clamdtop clamscan clamtk claws-mail clawsker clementine clion
clion-eap clipgrab clipit cliqz clocks cmake cmus code code-oss codium cointop
...
eog eom ephemeral epiphany equalx et etr etr-wrapper evince evince-previewer
...
flashpeak-slimjet flowblade fluxbox font-manager fontforge fossamail
...
geany geary gedit geekbench geeqie gfeeds gget ghb ghostwriter gimp gimp-2_10
gimp-2_8 gist gist-paste git git-cola gitg github-desktop gitter gjs gl-117
gl-117-wrapper glaxium glaxium-wrapper globaltime gmpc gnome-2048 gnome-books
...
gnome-font-viewer gnome-hexgl gnome-keyring gnome-keyring-3 gnome-klotski
...
gnome-weather gnome_games-common gnote gnubik godot goldendict goobox
google-chrome google-chrome-beta google-chrome-stable google-chrome-unstable
google-earth google-earth-pro google-play-music-desktop-player googler
googler-common gpa gpg gpg-agent gpg2 gpicview gpredict gradio gramps
gravity-beams-and-evaporating-stars gsettings gsettings-data-convert
gsettings-schema-convert gtar gthumb gtk-pipe-viewer gtk-straw-viewer
...
links-common links2 linphone lmms lobase localc lodraw loffice lofromtemplate
loimpress lollypop lomath loweb lowriter lrunzip lrz lrzcat lrzip lrztar
...
lzop macrofusion magicor make makepkg man manaplus marker masterpdfeditor
masterpdfeditor4 masterpdfeditor5 mate-calc mate-calculator mate-color-select
mate-dictionary mathematica matrix-mirage mattermost-desktop mcabber mcomix
md5sum mdr mediainfo mediathekview megaglest megaglest_editor meld mencoder
mendeleydesktop menulibre meson meteo-qt microsoft-edge microsoft-edge-beta
microsoft-edge-dev midori min mindless minecraft-launcher minetest minitube
mirage mirrormagic mocp mousepad mp3splt mp3splt-gtk mp3wrap mpDris2 mpd mpg123
mpg123-alsa mpg123-id3dump mpg123-jack mpg123-nas mpg123-openal mpg123-oss
mpg123-portaudio mpg123-pulse mpg123-strip mpg123_bin mplayer mpsyt mpv
mrrescue ms-excel ms-office ms-onenote ms-outlook ms-powerpoint ms-skype
ms-word mtpaint multimc multimc5 mumble mupdf mupdf-gl mupdf-x11 mupdf-x11-curl
...
ping ping-hardened_inc pingus pinta pioneer pip pipe-viewer pithos pitivi pix
pkglog planmaker18 planmaker18free playonlinux pluma plv pngquant polari ppsspp
...
qemu-launcher qemu-system-x86_64 qgis qlipper qmmp qnapi qpdfview qrencode
qt-faststart qtox quadrapassel quassel quaternion quiterss quodlibet qupzilla
qutebrowser raincat rambox ranger redeclipse rednotebook redshift regextester
remmina retroarch rhythmbox rhythmbox-client ricochet riot-desktop riot-web
ripperx ristretto rnano rocketchat rpcs3 rsync-download_only rtin rtorrent rtv
rtv-addons runenpass_sh rview rvim sayonara scallion scorched3d
...
telnet terasology tex textmaker18 textmaker18free thunar thunderbird
...
ts3client_runscript_sh tshark tutanota-desktop tuxguitar tvbrowser twitch
...
xfce4-screenshooter xiphos xlinks xmms xmr-stak xonotic xonotic-glx xonotic-sdl
...
zathura zcat zcmp zdiff zeal zegrep zfgrep zforce zgrep zim zless zmore znew
zoom zpaq zstd zstdcat zstdgrep zstdless zstdmt zulip
)
