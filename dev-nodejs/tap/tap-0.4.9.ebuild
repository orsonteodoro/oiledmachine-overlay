...
NODE_MODULE_DEPEND="inherits:2.0.3 yamlish:0.0.7 slide:1.1.6 runforcover:0.0.2 nopt:2.0.0 mkdirp:0.3.0 difflet:0.2.0 deep-equal:0.0.0 buffer-equal:0.0.0 glob:3.2.1"
