...
NODE_MODULE_DEPEND="arr-diff:1.0.1 braces:1.8.0 debug:2.1.3 expand-brackets:0.1.1 filename-regex:2.0.0 is-glob:1.1.3 kind-of:1.1.0 object-omit:0.2.1 parse-glob:3.0.0 regex-cache:0.4.0"
