...
U_OS_REL="24.04"
DRIVER_PV="6.4.3" # Folder name
KERNEL_PV="6.15" # Equivalent for vanilla kernel based on amdkfd last commits
KVS=(
...
MY_PV="6.12.12.60403-2194681"  # The 4th component is the ROCm version 6.04.03 == 6.4.3.
