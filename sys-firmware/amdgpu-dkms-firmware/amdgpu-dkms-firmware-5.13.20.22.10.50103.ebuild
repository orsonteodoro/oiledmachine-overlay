...
"
# Update also https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-5.1.3/drivers/gpu/drm/amd/amdgpu/amdgpu_cgs.c
...
pkg_setup() {
	...
	then
		last_cfg="linux-firmware-20220509"
	fi
