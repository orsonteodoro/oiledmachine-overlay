...
DRIVER_PV="5.3.3"
ROCM_PV="5.3.3"
MY_PV="5.18.2.22.40.50303-1504718" # The 4th component is the rock version 5.03.03 == 5.3.3.
DEB_OS_REL="22.04"
...
"
# Update also https://github.com/RadeonOpenCompute/ROCK-Kernel-Driver/blob/rocm-5.3.3/drivers/gpu/drm/amd/amdgpu/amdgpu_cgs.c
...
pkg_setup() {
	...
	then
		last_cfg="linux-firmware-20221012"
	fi
