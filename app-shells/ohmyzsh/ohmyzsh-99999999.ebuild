...
pkg_postinst() {
	...
	optfeature "autopep8 plugin support" "dev-python/autopep8"
	optfeature "aws plugin support" "dev-python/awscli"
	...
	optfeature "celery plugin support" "dev-python/celery"
	...
	optfeature "colorize plugin support" "dev-python/pygments"
	...
	optfeature "django plugin support" "dev-python/django"
	...
	optfeature "fabric plugin support" "dev-python/fabric"
	...
	optfeature "invoke plugin support" "dev-python/invoke"
	...
	optfeature "jira plugin support" "dev-python/jira"
	...
	optfeature "paver plugin support" "dev-python/paver"
	optfeature "pep8 plugin support" "dev-python/pep8"
	...
	optfeature "pip plugin support" "dev-python/pip"
	optfeature "pip plugin support" "net-misc/curl"
	optfeature "pipenv plugin support" "dev-python/pipenv"
	...
	optfeature "poetry plugin support" "dev-python/poetry"
	optfeature "pre-commit plugin support" "dev-vcs/pre-commit"
	optfeature "pyenv plugin support" "dev-lang/python"
	optfeature "pylint plugin support" "dev-python/pylint"
	optfeature "python plugin support" "dev-lang/python"
	optfeature "rails plugin support" "dev-lang/ruby"
	optfeature "rails plugin support" "dev-ruby/rails"
	optfeature "rails plugin support" "dev-ruby/rake"
	...
	optfeature "ruby plugin support" "dev-ruby/rubygems"
	...
	optfeature "virtualenvwrapper plugin support" "dev-python/virtualenvwrapper"
	...
	optfeature "watson plugin support" "dev-python/td-watson"
