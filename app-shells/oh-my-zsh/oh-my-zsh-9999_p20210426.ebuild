...
EGIT_COMMIT="95a06f3927a286db257dc99791b02caba757fe33"
...
wezmx wezm wuffers xiong-chiamiov-plus xiong-chiamiov ys zhann )
...
mercurial meteor minikube mix mix-fast mongocli mosh mvn mysql-macports \
n98-magerun \
...
\n\
If you agree, you may download ${FN_SRC}\n\
from oh-my-zsh's GitHub page located at ${P_URL}\n\
which the download URL should be ${A_URL}\n\
and rename it to ${FN_DST} and place them in ${distdir}\n\
or you can \`wget -O ${distdir}/${FN_DST} ${A_URL}\`\n\
\n"
}
