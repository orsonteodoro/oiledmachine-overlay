...
einfo "| Symmetric block  | AES-128                       | Grover  | Double key length (e.g. AES-128 -> AES-256,                       | Archives, KDBX notes, KDBX passwords (default)                  |"
einfo "|                  | aes-xts-plain64 [256-bit key] |         | aes-xts-plain64 [256-bit key] -> aes-xts-plain64 [512-bit key])   | Full disk encryption                                            |"
einfo "| Symmetric stream | Chacha20 [128-bit]            | Grover  | Double key length (e.g. Chacha20 [128-bit] -> Chacha20 [256-bit]) | KDBX4 passwords (alt)                                           |"
einfo "| Hash             | SHA-256                       | Grover  | Double key length (e.g. SHA-256 -> SHA-512)                       | LUKS2 integrity                                                 |"
einfo "| KDF              | PBKDF2                        | Grover  | Switch to a memory-hard algorithm (e.g. Argon2id, Argon2d)        | LUKS2 keys, KDBX master password, user password database tables |"
einfo
