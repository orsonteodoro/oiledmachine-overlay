...
einfo
einfo "| Use case        | GPU farm mitigation (today) | Quantum mitigation (future-proofing) | Format                                         |"
einfo "| ---             | ---                         | ---                                  | ---                                            |"
einfo "| Login           | 16-20                       | 20+                                  | The built in key generator                     |"
einfo "| Master password | 20+ (5 words min)           | 25+ (6-7 words min)                  | Your own collection of words that no one knows |"
einfo
