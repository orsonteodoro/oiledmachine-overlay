...
pkg_setup() {
	ewarn "sys-kernel/linux-firmware package is not recommended for the source of amdgpu firmware."
	ewarn "The proper paring of firmware for DC_VER=~3.2.140 is the sys-firmware/amdgpu-firmware."
