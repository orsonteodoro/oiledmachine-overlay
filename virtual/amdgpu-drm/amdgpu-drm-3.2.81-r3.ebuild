...
AMDGPU_DKMS_PV="20.20" # DC_VER = 3.2.81
ROCK_DKMS_PV="3.5" # DC_VER = 3.2.81
VANILLA_KERNEL_PV="5.8" # DC_VER = 3.2.84
LINUX_FIRMWARE_PV_MIN="20200619" # matches last commit/tag AMDGPU_DKMS_PV in linux-firmware git
LINUX_FIRMWARE_PV_MAX="20200619"
