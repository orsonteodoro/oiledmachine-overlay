...
AMDGPU_DKMS_PV="20.45" # DC_VER = 3.2.99
ROCK_DKMS_PV="3.9" # DC_VER = 3.2.99
VANILLA_KERNEL_PV="5.10"  # DC_VER = 3.2.104
LINUX_FIRMWARE_PV_MIN="20201119" # matches last commit/tag AMDGPU_DKMS_PV in linux-firmware git
LINUX_FIRMWARE_PV_MAX="20201119"
