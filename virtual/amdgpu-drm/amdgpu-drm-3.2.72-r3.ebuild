...
AMDGPU_DKMS_PV="20.10" # DC_VER = 3.2.72
ROCK_DKMS_PV="3.3" # DC_VER = 3.2.72
VANILLA_KERNEL_PV="5.7" # DC_VER = 3.2.76
LINUX_FIRMWARE_PV_MIN="20200417" # matches last commit/tag AMDGPU_DKMS_PV in linux-firmware git
LINUX_FIRMWARE_PV_MAX="20200417"
