...
AMDGPU_DKMS_PV="21.20" # DC_VER = 3.2.131
ROCK_DKMS_PV="4.3" # DC_VER = 3.2.135.1
VANILLA_KERNEL_PV="5.13"  # DC_VER = 3.2.132
LINUX_FIRMWARE_PV_MIN="20210629" # matches last commit/tag AMDGPU_DKMS_PV in linux-firmware git
