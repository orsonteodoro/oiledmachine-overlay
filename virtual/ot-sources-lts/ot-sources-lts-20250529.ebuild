...
RDEPEND="
	5_4? (
		~sys-kernel/ot-sources-5.4.293
	)
	5_10? (
		~sys-kernel/ot-sources-5.10.237
	)
	5_15? (
		~sys-kernel/ot-sources-5.15.184
	)
	6_1? (
		~sys-kernel/ot-sources-6.1.140
	)
	6_6? (
		~sys-kernel/ot-sources-6.6.92
	)
	6_12? (
		~sys-kernel/ot-sources-6.12.31
	)
"
