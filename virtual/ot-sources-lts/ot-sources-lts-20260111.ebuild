...
"
IUSE=" 5_10 5_15 6_1 6_6 6_12"
RDEPEND="
	5_10? (
		~sys-kernel/ot-sources-5.10.247
	)
	5_15? (
		~sys-kernel/ot-sources-5.15.197
	)
	6_1? (
		~sys-kernel/ot-sources-6.1.160
	)
	6_6? (
		~sys-kernel/ot-sources-6.6.120
	)
	6_12? (
		~sys-kernel/ot-sources-6.12.65
	)
"
