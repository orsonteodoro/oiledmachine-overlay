...
FFMPEG_SUBSLOT="58.60.60" # libavutil_major.libavcodec_major.libavformat_major
...
RDEPEND+="
	...
	libplacebo? (
		>=media-libs/libplacebo-${LIBPLACEBO_PV}:=[$MULTILIB_USEDEP]
	)
	librtmp? (
