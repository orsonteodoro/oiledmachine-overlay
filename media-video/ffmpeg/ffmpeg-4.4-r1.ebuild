...
if [ "${PV#9999}" != "${PV}" ] ; then
	...
	https://github.com/FFmpeg/FFmpeg/commit/9ffa49496d1aae4cbbb387aac28a9e061a6ab0a6.patch -> ${PN}-9ffa494.patch
	"
fi
# 9ffa494 Fix for CVE-2021-38171
...
PATCHES=(
	...
	"${DISTDIR}"/${PN}-9ffa494.patch
	"${FILESDIR}/${PN}-4.4-fPIC.patch"
)
