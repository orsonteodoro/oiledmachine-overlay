...
inherit bash-completion-r1 chkl gnome2-utils meson optfeature secure-version systemd tmpfiles udev
...
RDEPEND="
	${COMMON_DEPEND}
	system-wide? (
		alsa? ( >=media-sound/alsa-utils-${ALSA_UTILS_PV}:= )
		acct-user/pulse:*
		acct-group/audio:*
