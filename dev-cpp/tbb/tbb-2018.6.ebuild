...
PV2="$(ver_cut 2)"
MY_PV="${PV1}_U${PV2}"
SLOT_MAJOR="2" # Same as SONAME_SUFFIX, See https://github.com/oneapi-src/oneTBB/blob/2018_U6/include/tbb/tbb_stddef.h#L30
SOVER_MINOR="."$(ver_cut 2 ${PV}) # The distro messes up on this component.
SOVER_TBB="2" # See https://github.com/oneapi-src/oneTBB/blob/2018_U6/build/linux.inc#L114
SOVER_TBBMALLOC="2" # See https://github.com/oneapi-src/oneTBB/blob/2018_U6/build/linux.inc#L126
SOVER_TBBBIND="2" # See https://github.com/oneapi-src/oneTBB/blob/2018_U6/build/linux.inc#L119
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-2018.6-fix-cmake-config.patch"
)
