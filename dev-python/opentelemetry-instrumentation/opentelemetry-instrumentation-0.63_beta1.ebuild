...
RDEPEND+="
	...
	~dev-python/opentelemetry-semantic-conventions-${PV}:${PROTOBUF_CPP_SLOT}[${PYTHON_USEDEP}]
...
BDEPEND+="
	test? (
		...
		~dev-python/gevent-25.5.1[${PYTHON_USEDEP}]
		...
		<dev-python/wrapt-2.1.3[${PYTHON_USEDEP}]
