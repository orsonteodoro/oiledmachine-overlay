...
MY_PN="opentelemetry_instrumentation_redis"
MY_PV="${PV/_beta/b}"
...
HOMEPAGE="
	...
	https://pypi.org/project/opentelemetry-instrumentation-redis
"
LICENSE="
	Apache-2.0
"
...
RDEPEND+="
	...
	instruments? (
		>=dev-python/redis-2.6[${PYTHON_USEDEP}]
	)
"
DEPEND+="
	${RDEPEND}
...
BDEPEND+="
	test? (
		...
		~dev-python/fakeredis-2.23.3[${PYTHON_USEDEP}]
