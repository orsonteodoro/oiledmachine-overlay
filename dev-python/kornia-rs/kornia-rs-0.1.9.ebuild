...
_production_unpack() {
	...
	# Lockfile upgrade steps:

	# Delete examples folder in files/${PV}
	# Remove example lines in members in files/${PV}/Cargo.toml
}
