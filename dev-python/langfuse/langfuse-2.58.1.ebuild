...
RDEPEND+="
	...
	>=dev-python/python-3.9[${PYTHON_USEDEP}]
	>=dev-python/requests-2[${PYTHON_USEDEP}]
	>=dev-python/wrapt-1.14[${PYTHON_USEDEP}]
	langchain? (
		>=dev-python/langchain-0.0.309[${PYTHON_USEDEP}]
	)
	llama-index? (
...
BDEPEND+="
	...
	dev? (
		...
		>=dev-python/langchain-anthropic-0.1.4[${PYTHON_USEDEP}]
		>=dev-python/langchain-aws-0.1.3[${PYTHON_USEDEP}]
		>=dev-python/langchain-groq-0.1.3[${PYTHON_USEDEP}]
		>=dev-python/langchain-cohere-0.3.3[${PYTHON_USEDEP}]
		>=dev-python/langchain-community-0.2.14[${PYTHON_USEDEP}]
		>=dev-python/langchain-google-vertexai-1.0.0[${PYTHON_USEDEP}]
		>=dev-python/langchain-mistralai-0.0.1[${PYTHON_USEDEP}]
		>=dev-python/langchain-ollama-0.2.0[${PYTHON_USEDEP}]
		...
		>=sci-libs/huggingface_hub-0.16.4[${PYTHON_USEDEP}]
	)
	doc? (
