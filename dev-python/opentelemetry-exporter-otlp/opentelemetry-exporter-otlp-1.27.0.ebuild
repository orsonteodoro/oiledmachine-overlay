...
"
RDEPEND+="
	~dev-python/opentelemetry-exporter-otlp-proto-grpc-${PV}:${PROTOBUF_CPP_SLOT}[${PYTHON_USEDEP}]
	dev-python/opentelemetry-exporter-otlp-proto-grpc:=

	~dev-python/opentelemetry-exporter-otlp-proto-http-${PV}:${PROTOBUF_CPP_SLOT}[${PYTHON_USEDEP}]
