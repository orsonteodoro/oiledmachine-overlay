...
BDEPEND="
	${RDEPEND}
	>=dev-build/meson-0.18.0[${PYTHON_USEDEP}]
	...
	ci? (
		...
		~dev-python/scipy-openblas32-0.3.31.188.0[${PYTHON_USEDEP}]
		~dev-python/scipy-openblas64-0.3.31.188.0[${PYTHON_USEDEP}]
	)
	ci32? (
		dev-python/spin[${PYTHON_USEDEP}]
		~dev-python/scipy-openblas32-0.3.31.188.0[${PYTHON_USEDEP}]
	...
	doc? (
		...
		~dev-python/scipy-doctest-1.8.0[${PYTHON_USEDEP}]
	...
	linter? (
		...
		~dev-util/ruff-0.14.0[${PYTHON_USEDEP}]
	...
	test? (
		...
		~dev-python/hypothesis-6.142.2[${PYTHON_USEDEP}]
