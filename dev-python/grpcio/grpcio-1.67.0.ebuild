...
# See https://github.com/grpc/grpc/blob/v1.67.0/bazel/grpc_python_deps.bzl#L45
# See https://github.com/grpc/grpc/tree/v1.67.0/third_party
RDEPEND+="
	>=dev-cpp/abseil-cpp-20240116.0:0/20240116[cxx17(+)]
