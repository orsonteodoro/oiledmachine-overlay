...
RDEPEND+="
	...
	(
		!examples? (
			>=dev-python/jax-0.4.19[${PYTHON_SINGLE_USEDEP}]
		)
		examples? (
			>=dev-python/jax-0.4.19[${PYTHON_SINGLE_USEDEP},cuda?]
...
BDEPEND+="
	doc? (
		...
		')
		>=dev-python/jax-0.4[${PYTHON_SINGLE_USEDEP}]
	...
	test? (
		...
		sci-ml/tensorflow[${PYTHON_SINGLE_USEDEP},python]
		sci-ml/tensorflow-datasets[${PYTHON_SINGLE_USEDEP}]
	)
"
