...
PYTHON_COMPAT=( "python3_11" ) # Up to 3.10
...
if [[ "${PV}" =~ "9999" ]] ; then
	...
	EGIT_REPO_URI="https://github.com/aboutcode-org/container-inspector.git"
	FALLBACK_COMMIT="8d823c6eef3f94d76d01cd64f0d674d2cf7c114b" # Aug 8, 2024
	...
	S="${WORKDIR}/${PN}-${PV}"
	SRC_URI="
https://github.com/aboutcode-org/container-inspector/archive/refs/tags/v${PV}.tar.gz
	-> ${P}.tar.gz
	"
fi
...
HOMEPAGE="
	...
	https://pypi.org/project/container-inspector
"
LICENSE="
	Apache-2.0
"
...
RDEPEND+="
	...
	>=dev-python/commoncode-31.2.1[${PYTHON_USEDEP}]
	>=dev-python/construct-2.10.68[${PYTHON_USEDEP}]
	>=dev-python/cryptography-37.0.4[${PYTHON_USEDEP}]
	>=dev-python/debian-inspector-31.0.0_beta1[${PYTHON_USEDEP}]
	...
	>=dev-python/intbitset-3.1.0[${PYTHON_USEDEP}]
	...
	>=dev-python/libfwsi-python-20220123[${PYTHON_USEDEP}]
	...
	>=dev-python/regipy-3.0.2[${PYTHON_USEDEP}]
