...
RDEPEND="
	...
	dev-cpp/abseil-cpp:=
	dev-libs/protobuf:${PROTOBUF_CPP_SLOT}[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP},cxx_standard_cxx14?,cxx_standard_cxx17?]
	dev-libs/protobuf:=
	>=dev-python/cython-0.29.8:${CYTHON_SLOT}[${PYTHON_USEDEP}]
	dev-python/cython:=
	dev-python/protobuf:${PROTOBUF_PYTHON_SLOT}/4.21[${PYTHON_USEDEP}]
	dev-python/protobuf:=
	~dev-python/grpcio-${PV}:${PROTOBUF_CPP_SLOT}[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP},${PYTHON_USEDEP},cxx_standard_cxx14?,cxx_standard_cxx17?]
	dev-python/grpcio:=
"
DEPEND="
	${RDEPEND}
