...
RDEPEND="
	>=dev-cpp/abseil-cpp-20240722.0:${ABSEIL_CPP_SLOT}[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP}]
	dev-cpp/abseil-cpp:=
	...
	dev-python/protobuf:=
	~dev-python/grpcio-${PV}:${GRPC_SLOT}[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP},${PYTHON_USEDEP}]
	dev-python/grpcio:=
"
DEPEND="
	${RDEPEND}
