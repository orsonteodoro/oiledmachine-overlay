...
# TODO:  Update CUDA and ROCm sections
...
COMMUNITY_LLMS=(
	...
	"ALIENTELLIGENCE-gamemasterroleplaying"
...
if [[ "${PV}" =~ "9999" ]] ; then
	...
	S="${WORKDIR}/${P}"
	S_LLAMA_CPP="${WORKDIR}/llama.cpp-${LLAMA_CPP_TAG}"
	...
	EGO_SUM=(
		...
		"github.com/tree-sitter/go-tree-sitter v0.24.0/go.mod"
		"github.com/tree-sitter/go-tree-sitter v0.25.0"
		"github.com/tree-sitter/go-tree-sitter v0.25.0/go.mod"
		"github.com/tree-sitter/tree-sitter-c v0.21.5-0.20240818205408-927da1f210eb"
		"github.com/tree-sitter/tree-sitter-c v0.21.5-0.20240818205408-927da1f210eb/go.mod"
		"github.com/tree-sitter/tree-sitter-c v0.23.4"
		"github.com/tree-sitter/tree-sitter-c v0.23.4/go.mod"
		"github.com/tree-sitter/tree-sitter-cpp v0.22.4-0.20240818224355-b1a4e2b25148"
		"github.com/tree-sitter/tree-sitter-cpp v0.22.4-0.20240818224355-b1a4e2b25148/go.mod"
		"github.com/tree-sitter/tree-sitter-cpp v0.23.4"
		"github.com/tree-sitter/tree-sitter-cpp v0.23.4/go.mod"
		"github.com/tree-sitter/tree-sitter-embedded-template v0.21.1-0.20240819044651-ffbf64942c33"
		"github.com/tree-sitter/tree-sitter-embedded-template v0.21.1-0.20240819044651-ffbf64942c33/go.mod"
		"github.com/tree-sitter/tree-sitter-embedded-template v0.23.2"
		"github.com/tree-sitter/tree-sitter-embedded-template v0.23.2/go.mod"
		"github.com/tree-sitter/tree-sitter-go v0.21.3-0.20240818010209-8c0f0e7a6012"
		"github.com/tree-sitter/tree-sitter-go v0.21.3-0.20240818010209-8c0f0e7a6012/go.mod"
		"github.com/tree-sitter/tree-sitter-go v0.23.4"
		"github.com/tree-sitter/tree-sitter-go v0.23.4/go.mod"
		"github.com/tree-sitter/tree-sitter-html v0.20.5-0.20240818004741-d11201a263d0"
		"github.com/tree-sitter/tree-sitter-html v0.20.5-0.20240818004741-d11201a263d0/go.mod"
		"github.com/tree-sitter/tree-sitter-html v0.23.2"
		"github.com/tree-sitter/tree-sitter-html v0.23.2/go.mod"
		"github.com/tree-sitter/tree-sitter-java v0.21.1-0.20240824015150-576d8097e495"
		"github.com/tree-sitter/tree-sitter-java v0.21.1-0.20240824015150-576d8097e495/go.mod"
		"github.com/tree-sitter/tree-sitter-java v0.23.5"
		"github.com/tree-sitter/tree-sitter-java v0.23.5/go.mod"
		"github.com/tree-sitter/tree-sitter-javascript v0.21.5-0.20240818005344-15887341e5b5"
		"github.com/tree-sitter/tree-sitter-javascript v0.21.5-0.20240818005344-15887341e5b5/go.mod"
		"github.com/tree-sitter/tree-sitter-javascript v0.23.1"
		"github.com/tree-sitter/tree-sitter-javascript v0.23.1/go.mod"
		"github.com/tree-sitter/tree-sitter-json v0.21.1-0.20240818005659-bdd69eb8c8a5"
		"github.com/tree-sitter/tree-sitter-json v0.21.1-0.20240818005659-bdd69eb8c8a5/go.mod"
		"github.com/tree-sitter/tree-sitter-json v0.24.8"
		"github.com/tree-sitter/tree-sitter-json v0.24.8/go.mod"
		"github.com/tree-sitter/tree-sitter-php v0.22.9-0.20240819002312-a552625b56c1"
		"github.com/tree-sitter/tree-sitter-php v0.22.9-0.20240819002312-a552625b56c1/go.mod"
		"github.com/tree-sitter/tree-sitter-php v0.23.11"
		"github.com/tree-sitter/tree-sitter-php v0.23.11/go.mod"
		"github.com/tree-sitter/tree-sitter-python v0.21.1-0.20240818005537-55a9b8a4fbfb"
		"github.com/tree-sitter/tree-sitter-python v0.21.1-0.20240818005537-55a9b8a4fbfb/go.mod"
		"github.com/tree-sitter/tree-sitter-python v0.23.6"
		"github.com/tree-sitter/tree-sitter-python v0.23.6/go.mod"
		"github.com/tree-sitter/tree-sitter-ruby v0.21.1-0.20240818211811-7dbc1e2d0e2d"
		"github.com/tree-sitter/tree-sitter-ruby v0.21.1-0.20240818211811-7dbc1e2d0e2d/go.mod"
		"github.com/tree-sitter/tree-sitter-ruby v0.23.1"
		"github.com/tree-sitter/tree-sitter-ruby v0.23.1/go.mod"
		"github.com/tree-sitter/tree-sitter-rust v0.21.3-0.20240818005432-2b43eafe6447"
		"github.com/tree-sitter/tree-sitter-rust v0.21.3-0.20240818005432-2b43eafe6447/go.mod"
		"github.com/tree-sitter/tree-sitter-rust v0.23.2"
		"github.com/tree-sitter/tree-sitter-rust v0.23.2/go.mod"
...
LLM_LICENSES="
	...
	ollama_llms_falcon3? (
		Falcon-3-TII-Falcon-License-December-2024
		TII-Falcon-3-License-December-2024-ACCEPTABLE-USE-POLICY
	)
	...
	ollama_llms_nemotron-3-nano? (
		NVIDIA-Nemotron-Open-Model-License
	)
	ollama_llms_nemotron-3-super? (
		NVIDIA-Nemotron-Open-Model-License
	)
	...
	ollama_llms_opencoder? (
		OpenCoder-20240716
	)
	ollama_llms_openhermes? (
		Apache-2.0
	)
	ollama_llms_openthinker? (
		Apache-2.0
	)
	...
	ollama_llms_snowflake-arctic-embed2? (
		Apache-2.0
	)
	ollama_llms_solar? (
		CC-BY-NC-4.0
...
"
PATCHES=(
	"${FILESDIR}/${PN}-0.32.4-cmd-changes.patch"
...
#			|| die
	...
	if use claude-desktop ; then
		sed -i -e "\|// DISABLE_CLAUDE_DESKTOP|d" "cmd/launch/claude_desktop.go" || die
	fi
	if use cline ; then
	...
	if use codex-app ; then
		sed -i -e "\|// DISABLE_CODEX_APP|d" "cmd/launch/codex_app.go" || die
	fi
	if use copilot ; then
	...
	if use omp ; then
		sed -i -e "\|// DISABLE_OMP|d" "cmd/launch/omp.go" || die
	fi
	...
	if use qwen-code ; then
		sed -i -e "\|// DISABLE_QWEN_CODE|d" "cmd/launch/qwen.go" || die
	fi
	if use vscode ; then
...
eerror "Re-emerge sys-apps/firejail::oiledmachine-overlay for the ollama profile."
	...
	# Speed up build by building only the GPU kernels we need.
	...
	if use cuda ; then
		if has_version "=dev-util/nvidia-cuda-toolkit-13*" ; then
			...
			sed -i \
				-e "s|75-virtual;80-virtual;86-virtual;89-virtual;90-virtual;90a-virtual;100-virtual;103-virtual;110-virtual;120-virtual;121-virtual|${CMAKE_CUDA_ARCHITECTURES}|g" \
				"CMakePresets.json" \
				|| die
			...
			export CMAKE_CUDA_ARCHITECTURES="$(get_cuda_flags)"
			sed -i \
				-e "s|50-virtual;52-virtual;60-virtual;61-virtual;70;75;80;86;89;90;90a;120|${CMAKE_CUDA_ARCHITECTURES}|g" \
				"CMakePresets.json" \
				|| die
		fi
	elif use rocm ; then
einfo "ROCM_SLOT: ${ROCM_SLOT}"
		...
		sed -i \
			-e "s|gfx908:xnack-;gfx90a:xnack+;gfx90a:xnack-;gfx942;gfx950;gfx1010;gfx1012;gfx1030;gfx1100;gfx1101;gfx1102;gfx1103;gfx1150;gfx1151;gfx1200;gfx1201|${AMDGPU_TARGETS}|g" \
			"CMakePresets.json" \
			|| die
...
einfo "LDFLAGS: ${LDFLAGS}"
		...
		unset OLLAMA_SKIP_CUDA_GENERATE
		if has_version "=dev-util/nvidia-cuda-toolkit-13*" ; then
einfo "Building for CUDA v13"
			local preset_name="llama_cuda_v13_linux"
			edo cmake \
				-S "${S}/llama/server" \
				-B "${S}_build_cuda" \
				--preset "${preset_name}" \
...
einfo "Building for CUDA v12"
			local preset_name="llama_cuda_v12_linux"
			edo cmake \
				-S "${S}/llama/server" \
				-B "${S}_build_cuda" \
				--preset "${preset_name}" \
...
einfo "Building for ROCm"
		...
		local preset_name="rocm_v7_2_linux"
		edo cmake \
			-S "${S}/llama/server" \
			-B "${S}_build_rocm" \
			--preset "${preset_name}" \
...
einfo
einfo "| RAM scale      | Recommended scale for model sweet spot |"
einfo "|----------------|----------------------------------------|"
einfo "|     100 MB RAM |                             1 MB model |"
einfo "|       1 GB RAM |                            10 MB model |"
einfo "|      10 GB RAM |                           100 MB model |"
einfo "|     100 GB RAM |                             1 GB model |"
einfo "|       1 TB RAM |                            10 GB model |"
einfo
