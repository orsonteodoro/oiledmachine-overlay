...
# See https://github.com/tensorflow/tensorflow/blob/v2.17.1/third_party/xla/xla/stream_executor/device_description.h#L212
	gfx900
	gfx906
	gfx908
	gfx90a
...
CUDA_TARGETS_COMPAT=(
# See https://github.com/tensorflow/tensorflow/blob/v2.17.1/.bazelrc#L246  # Supported upstream
# See https://github.com/tensorflow/tensorflow/blob/v2.17.1/.bazelrc#L670  # Unsupported upstream
	sm_60 # Supported
	sm_70 # Supported
	sm_80 # Supported
	sm_89 # Supported
...
# https://github.com/tensorflow/tensorflow/blob/v2.17.1/ci/official/requirements_updater/requirements.in
...
CUDA_PV="12.3"			# From https://github.com/tensorflow/tensorflow/blob/v2.17.1/tensorflow/tools/pip_package/setup.py#L176
...
GRPCIO_PV="1.24.3"		# From https://github.com/tensorflow/tensorflow/blob/v2.17.1/tensorflow/tools/pip_package/setup.py#L84
GRPCIO_PV_MAX="1.53"		# From https://github.com/tensorflow/tensorflow/blob/v2.17.1/tensorflow/tools/pip_package/setup.py#L84 ; < (Exclusive) ; Upstream is wrong
...
#PLATFORMS_PV="0.0.6"		# From https://github.com/tensorflow/runtime/blob/4662f7552dc2e420ee20361c077b7aeb334a1087/third_party/rules_cuda/cuda/dependencies.bzl#L66 with EGIT_COMMIT_TF_RUNTIME
...
RULES_PYTHON_PV="0.1.0"		# From https://github.com/tensorflow/tensorflow/blob/v2.17.1/WORKSPACE#L19
