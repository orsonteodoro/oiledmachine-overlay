...
KLEIDIAI_COMMIT="eaf63a6ae9a903fb4fa8a4d004a974995011f444"
LEVEL_ZERO_COMMIT="c0c23ad24e06a6109550381f9997b0b74fba90d7"
LEVEL_ZERO_NPU_EXTENSIONS_COMMIT="c0156a3390ae39671ff8f2a6f5471f04bb65bb12"
...
ONEDNN_1_COMMIT="5baba714e16e11309774a62783f363cad30e97c7"
ONEDNN_2_COMMIT="fb61a91dd068f9f5abfe2629edbd7cdf53712c7a"
ONNX_COMMIT="b8baa8446686496da4cc8fda09f2b6fe65c2a02c"
OPENCL_CLHPP_COMMIT="c7b4aded1cab9560b226041dd962f63375a9a384"
...
$(_gen_gh_uri ARM-software kleidiai ${KLEIDIAI_COMMIT})
$(_gen_gh_uri herumi xbyak_riscv ${XBYAK_RISCV_COMMIT})
openmp? (
	amd64? (
...
src_unpack() {
	...
	dep_prepare_cp "${WORKDIR}/kleidiai-${KLEIDIAI_COMMIT}" "${S}/src/plugins/intel_cpu/thirdparty/kleidiai"
	...
	dep_prepare_cp "${WORKDIR}/xbyak_riscv-${XBYAK_RISCV_COMMIT}" "${S}/src/plugins/intel_cpu/thirdparty/xbyak_riscv"
