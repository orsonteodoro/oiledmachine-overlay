...
PROTOBUF_CPP_SLOT="3"
PYTHON_COMPAT=( "python3_"{10..12} ) # NumPy needs < 3.13.  Based on https://github.com/openvinotoolkit/openvino/blob/2024.6.0/docs/dev/build_linux.md#software-requirements
