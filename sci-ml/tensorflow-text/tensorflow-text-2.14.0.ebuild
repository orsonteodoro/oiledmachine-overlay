...
ABSEIL_CPP_COMMIT="b971ac5250ea8de900eae9f95e06548d14cd95fe"		# https://github.com/tensorflow/tensorflow/blob/v2.14.0/third_party/absl/workspace.bzl#L10
APPLE_SUPPORT_PV="1.6.0"						# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L838
BAZEL_PV="6.1.0"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/.bazelversion
BAZEL_SKYLIB_PV="1.3.0"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace3.bzl#L26
BAZEL_TOOLCHAINS_COMMIT="8c717f8258cd5f6c7a45b97d974292755852b658"	# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace1.bzl#L30
BENCHMARK_COMMIT="f7547e29ccaed7b64ef4f7495ecfff1c9f6f3d03"		# https://github.com/tensorflow/tensorflow/blob/v2.14.0/third_party/benchmark/workspace.bzl#L7
CPPITERTOOLS_PV="2.0"							# https://github.com/tensorflow/text/blob/v2.14.0/WORKSPACE#L32
DARTS_CLONE_COMMIT="e40ce4627526985a7767444b6ed6893ab6ff8983"		# https://github.com/tensorflow/text/blob/v2.14.0/WORKSPACE#L43
...
DOUBLE_CONVERSION_PV="3.2.0"						# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L737
...
HIGHWAYHASH_COMMIT="c13d28517a4db259d738ea4886b1f00352a3cc33"		# https://github.com/tensorflow/tensorflow/blob/v2.14.0/third_party/highwayhash/workspace.bzl#L8
...
OOURAFFT_PV="1.0"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L596
PLATFORMS_PV="0.0.6"							# https://github.com/tensorflow/runtime/blob/769f5cc9b8732933140b09e8808d13614182b496/third_party/rules_cuda/cuda/dependencies.bzl#L67
PROTOBUF_PV="3.21.9"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L480
PYBIND11_BAZEL_COMMIT="72cbbf1fbc830e487e3012862b7b720001b70672"	# https://github.com/tensorflow/tensorflow/blob/v2.14.0/third_party/pybind11_bazel/workspace.bzl#L9
PYBIND11_PV="2.10.0"							# https://github.com/tensorflow/text/blob/v2.14.0/WORKSPACE#L94
PYTHON_COMPAT=( "python3_11" )
RE2_COMMIT="03da4fc0857c285e3a26782f6bc8931c4c950df4"			# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L272
RUY_COMMIT="3286a34cc8de6149ac6844107dfdffac91531e72"			# https://github.com/tensorflow/tensorflow/blob/v2.14.0/third_party/ruy/workspace.bzl#L11
RULES_ANDROID_PV="0.1.1"						# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L816
RULES_APPLE_PV="2.3.0"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L824
RULES_CC_COMMIT="081771d4a0e9d7d3aa0eed2ef389fa4700dfb23e"		# https://github.com/tensorflow/runtime/blob/769f5cc9b8732933140b09e8808d13614182b496/third_party/rules_cuda/cuda/dependencies.bzl#L42
RULES_CC_PV="0.0.2"							# https://github.com/bazelbuild/bazel/blob/6.1.0/distdir_deps.bzl#L57
RULES_CLOSURE_COMMIT="308b05b2419edb5c8ee0471b67a40403df940149"		# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace3.bzl#L14
...
RULES_GO_PV="0.34.0"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L904
...
RULES_JVM_EXTERNAL_PV="4.3"						# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace3.bzl#L53
RULES_LICENSE_PV="0.0.1"						# https://github.com/bazelbuild/rules_pkg/blob/0.7.0/pkg/deps.bzl#L43
RULES_PKG_PV="0.7.1"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace3.bzl#L33
RULES_PROTO_COMMIT="11bf7c25e666dd7ddacbcd4d4c4a9de7a25175f8"		# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace0.bzl#L120
RULES_PYTHON_PV="0.1.0"							# https://github.com/llvm/llvm-project/blob/668e33c6401abe7844691fb7d47a3cf2d2012dbc/third-party/benchmark/WORKSPACE#L35
RULES_SWIFT_PV="1.0.0"							# https://github.com/tensorflow/tensorflow/blob/v2.14.0/tensorflow/workspace2.bzl#L831
SENTENCEPIECE_PV="0.1.96"						# https://github.com/tensorflow/text/blob/v2.14.0/WORKSPACE#L23
TENSORFLOW_HUB_PV="0.13.0"						# https://github.com/tensorflow/text/blob/v2.14.0/WORKSPACE#L67
TENSORFLOW_PV="2.14.0"							# https://github.com/tensorflow/text/blob/v2.14.0/WORKSPACE#L78
TENSORFLOW_RUNTIME_COMMIT="769f5cc9b8732933140b09e8808d13614182b496"	# https://github.com/tensorflow/tensorflow/blob/v2.14.0/third_party/tf_runtime/workspace.bzl#L9
...
https://github.com/tensorflow/hub/archive/v${TENSORFLOW_HUB_PV}.zip -> tensorflow-hub-${TENSORFLOW_HUB_PV}.zip
...
https://mirror.bazel.build/github.com/bazelbuild/rules_license/releases/download/${RULES_LICENSE_PV}/rules_license-${RULES_LICENSE_PV}.tar.gz
