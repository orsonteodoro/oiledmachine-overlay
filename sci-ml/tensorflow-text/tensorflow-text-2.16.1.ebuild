...
BAZEL_PV="6.5.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/.bazelversion
BAZEL_SKYLIB_PV="1.3.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace3.bzl#L26
BAZEL_TOOLCHAINS_COMMIT="8c717f8258cd5f6c7a45b97d974292755852b658"	# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace1.bzl#L28
BENCHMARK_COMMIT="f7547e29ccaed7b64ef4f7495ecfff1c9f6f3d03"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/benchmark/workspace.bzl#L7
CPPITERTOOLS_PV="2.0"							# https://github.com/tensorflow/text/blob/v2.16.1/WORKSPACE#L32
DARTS_CLONE_COMMIT="e40ce4627526985a7767444b6ed6893ab6ff8983"		# https://github.com/tensorflow/text/blob/v2.16.1/WORKSPACE#L43
...
DOUBLE_CONVERSION_PV="3.2.0"						# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L644
EIGEN_COMMIT="aa6964bf3a34fd607837dd8123bc42465185c4f8"			# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/eigen3/workspace.bzl#L10
FARMHASH_COMMIT="0d859a811870d10f53a594927d0d0b97573ad06d"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/farmhash/workspace.bzl#L10
FLATBUFFERS_COMMIT="7d6d99c6befa635780a4e944d37ebfd58e68a108"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/flatbuffers/workspace.bzl#L8
GCC_COMPAT=( {12..9} )
GIFLIB_PV="5.2.1"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L350
GOOGLEAPIS_COMMIT="6b3fdcea8bc5398be4e7e9930c693f0ea09316a0"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L318
GRPC_COMMIT="b54a5b338637f92bfcf4b0bc05e0f57a5fd8fadd"			# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L447
HIGHWAYHASH_COMMIT="c13d28517a4db259d738ea4886b1f00352a3cc33"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/highwayhash/workspace.bzl#L8
ICU_PV="64-2"								# https://github.com/tensorflow/text/blob/v2.16.1/WORKSPACE#L11
LIBJPEG_TURBO_PV="2.1.4"						# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/jpeg/workspace.bzl#L8
LLVM_COMMIT="8697bbe2d4aed109520e83c6beab52196ec5b702"			# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/llvm/workspace.bzl#L7
ML_DTYPES_COMMIT="2ca30a2b3c0744625ae3d6988f5596740080bbd0"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/py/ml_dtypes/workspace.bzl#L10
NASM_PV="2.14.02"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/nasm/workspace.bzl#L11
NSYNC_PV="1.25.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L395
OOURAFFT_PV="1.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L502
PROTOBUF_PV="3.21.9"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L386
PYBIND11_BAZEL_COMMIT="72cbbf1fbc830e487e3012862b7b720001b70672"	# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/pybind11_bazel/workspace.bzl#L9
PYBIND11_PV="2.10.0"							# https://github.com/tensorflow/text/blob/v2.16.1/WORKSPACE#L81
PYTHON_COMPAT=( "python3_"{11..12} )
RE2_COMMIT="03da4fc0857c285e3a26782f6bc8931c4c950df4"			# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L280
RUY_COMMIT="3286a34cc8de6149ac6844107dfdffac91531e72"			# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/ruy/workspace.bzl#L11
RULES_ANDROID_PV="0.1.1"						# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L730
RULES_APPLE_PV="2.3.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L738
RULES_CC_PV="0.0.2"							# https://github.com/bazelbuild/bazel/blob/6.5.0/distdir_deps.bzl#L58
RULES_CLOSURE_COMMIT="308b05b2419edb5c8ee0471b67a40403df940149"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace3.bzl#L18
...
RULES_GO_PV="0.34.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L809
RULES_JAVA_PV="5.5.1"							# https://github.com/bazelbuild/bazel/blob/6.5.0/distdir_deps.bzl#L69
RULES_JVM_EXTERNAL_PV="4.3"						# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace3.bzl#L53
RULES_LICENSE_PV="0.0.7"						# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace3.bzl#L38
RULES_PKG_PV="0.7.1"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace3.bzl#L47
RULES_PROTO_COMMIT="11bf7c25e666dd7ddacbcd4d4c4a9de7a25175f8"		# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace0.bzl#L120
RULES_PYTHON_PV="0.1.0"							# https://github.com/llvm/llvm-project/blob/8697bbe2d4aed109520e83c6beab52196ec5b702/third-party/benchmark/WORKSPACE#L35
RULES_SWIFT_PV="1.5.0"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L745
SENTENCEPIECE_PV="0.1.96"						# https://github.com/tensorflow/text/blob/v2.16.1/WORKSPACE#L23
TENSORFLOW_PV="2.16.1"							# https://github.com/tensorflow/text/blob/v2.16.1/WORKSPACE#L64
TENSORFLOW_RUNTIME_COMMIT="5f7d3578b66bda0b83787a069f66c7c02a05128d"	# https://github.com/tensorflow/tensorflow/blob/v2.16.1/third_party/tf_runtime/workspace.bzl#L9
UPB_COMMIT="9effcbcb27f0a665f9f345030188c0b291e32482"			# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L817
ZLIB_PV="1.2.13"							# https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/workspace2.bzl#L493
...
https://github.com/google/flatbuffers/archive/${FLATBUFFERS_COMMIT}.tar.gz -> flatbuffers-${FLATBUFFERS_COMMIT}.tar.gz
