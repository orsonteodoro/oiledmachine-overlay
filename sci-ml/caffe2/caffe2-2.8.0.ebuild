...
# See https://github.com/ROCm/aotriton/blob/6fca155f4deeb8d9529326f7b69f350aeeb93477/CMakeLists.txt#L61
	"gfx90a"   # Full support
	"gfx942"   # Full support
	#"gfx950"  # Full support
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-2.8.0-aotriton-deps-v2.patch"
