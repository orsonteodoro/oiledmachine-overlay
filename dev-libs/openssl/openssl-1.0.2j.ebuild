...
IUSE="+asm bindist gmp kerberos rfc3779 sctp cpu_flags_x86_sse2 sslv2 +sslv3 static-libs test +tls-heartbeat vanilla zlib spotify"
...
multilib_src_configure() {
	#if use spotify; then
	#	append-ldflags -Wl,--version-script=openssl.ld
	#fi
	unset APPS #197996
