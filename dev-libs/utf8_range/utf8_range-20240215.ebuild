...
# The tarball is same as protobuf 25.3.
...
if [[ "${PV}" =~ "9999" ]] ; then
	...
	EGIT_SUBMODULES=()
	FALLBACK_COMMIT="4a2aef570deb2bfb8927426558701e8bfc26f2a4" # Feb 15, 2024
	S="${WORKDIR}/protobuf-9999/third_party/utf8_range"
else
	EGIT_COMMIT="4a2aef570deb2bfb8927426558701e8bfc26f2a4" # Feb 15, 2024
	SRC_URI="
