...
# The tarball is same as protobuf 23.4.
...
if [[ "${PV}" =~ "9999" ]] ; then
	...
	EGIT_SUBMODULES=()
	FALLBACK_COMMIT="2c5fa078d8e86e5f4bd34e6f4c9ea9e8d7d4d44a" # Jun 14, 2023
	S="${WORKDIR}/protobuf-9999/third_party/utf8_range"
else
	EGIT_COMMIT="2c5fa078d8e86e5f4bd34e6f4c9ea9e8d7d4d44a" # Jun 14, 2023
	SRC_URI="
...
SLOT="0/4.23" # Subslot is protobuf slot.
