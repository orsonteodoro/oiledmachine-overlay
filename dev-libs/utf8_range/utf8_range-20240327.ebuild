...
if [[ "${PV}" =~ "9999" ]] ; then
	...
	EGIT_SUBMODULES=()
	FALLBACK_COMMIT="2434ef2adf0c74149b9d547ac5fb545a1ff8b6b5" # Mar 27, 2023
	S="${WORKDIR}/protobuf-9999/third_party/utf8_range"
else
	EGIT_COMMIT="2434ef2adf0c74149b9d547ac5fb545a1ff8b6b5" # Mar 27, 2023
	SRC_URI="
...
RDEPEND+="
	>=dev-cpp/abseil-cpp-20240116.0:0/20240116
"
BDEPEND+="
