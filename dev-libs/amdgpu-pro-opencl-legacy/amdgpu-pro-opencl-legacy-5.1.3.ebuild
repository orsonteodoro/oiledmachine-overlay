...
einfo "(4) mkdir -p /usr/portage/package.license && echo \"${CATEGORY}/${PN} opencl-legacy-amdgpu-pro-icd-LICENSE all-rights-reserved\" >> /usr/portage/package.license/${PN}"
