...
inherit cflags-hardened check-compiler-switch edo flag-o-matic multiprocessing ninja-utils python-r1
inherit toolchain-funcs verify-sig

# We don't list 32-bit because of unpatched vulnerabilities in those arches.
KEYWORDS="
~amd64 ~arm64 ~hppa ~loong ~ppc64 ~riscv ~s390 ~sparc
"
S="${WORKDIR}/${MY_P}"
SRC_URI="
...
eerror "GCC version is too old to compile Botan!"
		die
	elif tc-is-clang && ver_test $(clang-version) -lt 14 ; then
eerror "Botan needs >=gcc-11 or >=clang-14 to compile."
eerror "Please upgrade Clang: emerge -v1 llvm-core/clang"
eerror "Clang version is too old to compile Botan!"
		die
	fi
}
