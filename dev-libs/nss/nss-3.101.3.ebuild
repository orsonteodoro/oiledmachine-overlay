...
SRC_URI="
https://archive.mozilla.org/pub/security/nss/releases/${RTM_NAME}/src/nss-3.101_3.tar.gz
	-> ${P}.tar.gz
	cacert? (
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-3.101.3-update-expected-error-code-in-pkg12util-pbmac1-tests.patch"
)
