...
pkg_setup() {
	ewarn "This ebuild in the past may not work today 2021-05-05.  To be replaced with newer version."
	dotnet_pkg_setup
}
...
src_prepare() {
	...
	#eapply "${FILESDIR}/${PN}-3.5.1-monodevelop-6-addin.patch" \
	#	|| die #not ready yet
	eapply "${FILESDIR}/${PN}-3.5.1-monodevelop-5-addin.patch" \
		|| die
	...
	xml ed -L -d "//Import[@file='templates/MonoGametvOSProject.xpt.xml']" \
	  MonoDevelop.MonoGame.addin.xml

	# IOS is not supported.
	xml ed -d "/Addin/Runtime/Import[contains(@file,'iOS')]" \
	  MonoDevelop.MonoGame.addin.xml \
	  | xml ed -d "/Addin/Module/Runtime/Import[contains(@assembly,'iOS')]/../.." \
	  | xml ed -d "/Addin/Module/Dependencies/Addin[contains(@id,'IPhone')]" \
	  > MonoDevelop.MonoGame.addin.xml.tmp
	cp MonoDevelop.MonoGame.addin.xml.tmp MonoDevelop.MonoGame.addin.xml

	xml ed -L \
	  -d "/Addin/Module/Extension/ProjectTemplate[contains(@id,'MonoGameForMobileSAPProject')]/../.." \
	  MonoDevelop.MonoGame.addin.xml #iOS
	xml ed -L \
	  -d "/Addin/Runtime/Import[contains(@file,'MobileOnly')]" \
	  MonoDevelop.MonoGame.addin.xml #iOS
	xml ed -L \
	  -d "/Addin/Runtime/Import[contains(@file,'Shared/Program.cs')]" \
	  MonoDevelop.MonoGame.addin.xml #iOS
	xml ed -L -d "/Addin/Runtime/Import[contains(@file,'Shared/Activity1.cs')]" \
	  MonoDevelop.MonoGame.addin.xml #iOS
	...
	xml ed -L -d "/Addin/Extension[@path='/MonoDevelop/Ide/ProjectTemplatePackageRepositories']" \
	...
	xml ed -L -u "/Project/Files/None/Link[text()='libassimp.so']" \
		-v "libassimp.so" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='libnvimage.so']" \
		-v "libnvimage.so" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='libnvmath.so']" \
		-v "libnvmath.so" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='libnvtt.so']" \
		-v "libnvtt.so" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='Nvidia.TextureTools.dll.config']" \
		-v "/usr/$(get_libdir)/mono/gac/Nvidia.TextureTools/*/Nvidia.TextureTools.dll.config" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='SharpFont.dll.config']" \
		-v "/usr/$(get_libdir)/mono/gac/SharpFont/*/SharpFont.dll.config" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='AssimpNet.dll.config']" \
		-v "/usr/$(get_libdir)/mono/gac/AssimpNet/*/AssimpNet.dll.config" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='ffmpeg']" \
		-v "ffmpeg" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	xml ed -L -u "/Project/Files/None/Link[text()='ffprobe']" \
		-v "ffprobe" \
		Build/Projects/MonoGame.Framework.Content.Pipeline.definition
	...
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='NDesk.Options']/@Path" \
	  -v "$(ls /usr/$(get_libdir)/mono/gac/NDesk.Options/*/NDesk.Options.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.core']/@Path" \
	  -v "$(ls /usr/share/nunit-2/nunit.core.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition #nunit2
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.core.interfaces']/@Path" \
	  -v "$(ls /usr/share/nunit-2/nunit.core.interfaces.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition #nunit2
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.framework']/@Path" \
	  -v "$(ls /usr/share/nunit-2/nunit.framework.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition #nunit2
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.util']/@Path" \
	...
	xml ed -s "/ExternalProject/Platform[@Type='Linux']" \
	  ...
	  | xml ed -i "/ExternalProject/Platform[@Type='Linux']/Binary[last()]" \
	    -t attr -n "Path" -v "$(ls /usr/share/nunit-3/nunit-v2-result-writer.dll | tail -n 1)" \
	...
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.core']" \
	  -v "$(ls /usr/share/nunit-2/nunit.core.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition #nunit 2
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.core.interfaces']" \
	  -v "$(ls /usr/share/nunit-2/nunit.core.interfaces.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition #nunit 2
	xml ed -L -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='nunit.util']" \
	  -v "$(ls /usr/share/nunit-2/nunit.util.dll | tail -n 1)" \
	  Build/Projects/MonoGame.Tests.References.definition #nunit 2

	# Lidgren is split off as a seperate package.
	#xml ed -L \
	#  -d "/ExternalProject/Platform[@Type='Linux']/Reference[@Include='Lidgren.Network']" \
	...
	xml ed -L \
	  -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='atk-sharp']/@Path" \
	...
	xml ed -L \
	  ...
	  Build/Projects/PipelineReferences.definition
	xml ed -L \
	  -d "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='glade-sharp']" \
	  Build/Projects/PipelineReferences.definition
	xml ed -L \
	  -u "/ExternalProject/Platform[@Type='Linux']/Binary[@Name='Mono.Posix']/@Path" \
	...
	cp Build/Projects/PipelineReferences.definition.t Build/Projects/PipelineReferences.definition

	xml ed -L -u "/Addin/@version" -v "${PV}" IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.addin.xml

	#line below is a continuation of ${PN}-3.5.1-monodevelop-5-addin.patch
	xml ed -L -d "//Dependencies" IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.addin.xml
	...
	xml ed -L -u "//Platform[@Type='Linux']/Binary[@Path='ThirdParty\Dependencies\assimp\AssimpNet.dll']/@Path" \
	  -v "/usr/$(get_libdir)/mono/assimp-net/AssimpNet.dll" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/Binary[@Path='ThirdParty\Dependencies\NVTT\Windows\Nvidia.TextureTools.dll']/@Path" \
	  -v "/usr/$(get_libdir)/mono/nvidia-texture-tools/monogame/Nvidia.TextureTools.dll" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/Binary[@Path='ThirdParty\Dependencies\SharpFont\x32\SharpFont.dll']/@Path" \
	  -v "/usr/$(get_libdir)/mono/sharpfont/SharpFont.dll" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/Binary[@Path='ThirdParty\Dependencies\PVRTexLibNET\PVRTexLibNET.dll']/@Path" \
	...
	xml ed -L -u "//Platform[@Type='Linux']/Binary[@Path='ThirdParty\Dependencies\ATI.TextureConverter\ATI.TextureConverter.dll']/@Path" \
	  ...
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\assimp\libassimp.so']/@Path" \
	  -v "/usr/$(get_libdir)/libassimp.so" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\NVTT\Linux\libnvcore.so']/@Path" \
	  -v "/usr/$(get_libdir)/libnvcore.so" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\NVTT\Linux\libnvimage.so']/@Path" \
	  -v "/usr/$(get_libdir)/libnvimage.so" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\NVTT\Linux\libnvmath.so']/@Path" \
	  -v "/usr/$(get_libdir)/libnvmath.so" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\NVTT\Linux\libnvtt.so']/@Path" \
	  -v "/usr/$(get_libdir)/libnvtt.so" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\NVTT\Windows\Nvidia.TextureTools.dll.config']/@Path" \
	  -v "/usr/$(get_libdir)/mono/gac/Nvidia.TextureTools/*/Nvidia.TextureTools.dll.config" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\SharpFont\x64\SharpFont.dll.config']/@Path" \
	  -v "/usr/$(get_libdir)/mono/gac/SharpFont/*/SharpFont.dll.config" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\assimp\AssimpNet.dll.config']/@Path" \
	  -v "/usr/$(get_libdir)/mono/gac/AssimpNet/*/AssimpNet.dll.config" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\FreeImage.NET\FreeImageNET.dll.config']/@Path" \
	  -v "/usr/$(get_libdir)/mono/gac/FreeImageNET/*/FreeImageNET.dll.config" \
	   Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\FreeImage.NET\Linux\x64\libfreeimage-3.17.0.so']/@Path" \
	  -v "$(ls /usr/lib/libfreeimage-*.so | tail -n 1)" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\ffmpeg\Linux\x64\ffmpeg']/@Path" \
	  -v "/usr/bin/ffmpeg" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	xml ed -L -u "//Platform[@Type='Linux']/NativeBinary[@Path='ThirdParty\Dependencies\ffmpeg\Linux\x64\ffprobe']/@Path" \
	  -v "/usr/bin/ffprobe" \
	  Build/Projects/Framework.Content.Pipeline.References.definition
	...
	xml ed -L \
	  ...
	  Build/Projects/MonoGame.Framework.definition
	xml ed -L \
	  -u "/Project/Files/None[@Include='..\ThirdParty\Dependencies\PVRTexLibNET\PVRTexLibNET.dll.config']/@Include" \
	  -v "/usr/$(get_libdir)/mono/gac/PVRTexLibNET/*/PVRTexLibNET.dll.config" \
	  Build/Projects/MonoGame.Framework.definition
	xml ed -L \
	...
	sed -i \
	  -e 's|xmlns="http://schemas.microsoft.com/developer/msbuild/2003"||g' \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L \
	  -u "//HintPath[text()='/Applications/Xamarin Studio.app/Contents/Resources/lib/monodevelop/bin/MonoDevelop.Core.dll']" \
	  -v "/usr/$(get_libdir)/monodevelop/bin/MonoDevelop.Core.dll" \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L \
	  -u "//HintPath[text()='/Applications/Xamarin Studio.app/Contents/Resources/lib/monodevelop/bin/MonoDevelop.Ide.dll']" \
	  -v "/usr/$(get_libdir)/monodevelop/bin/MonoDevelop.Ide.dll" \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L \
	  -u "//HintPath[text()='/Applications/Xamarin Studio.app/Contents/Resources/lib/monodevelop/AddIns/MonoDevelop.DesignerSupport/MonoDevelop.DesignerSupport.dll']" \
	  -v "/usr/$(get_libdir)/monodevelop/AddIns/MonoDevelop.DesignerSupport/MonoDevelop.DesignerSupport.dll" \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L \
	  -u "//HintPath[text()='/Applications/Xamarin Studio.app/Contents/Resources/lib/monodevelop/bin/ICSharpCode.NRefactory.dll']" \
	  -v "/usr/$(get_libdir)/monodevelop/bin/ICSharpCode.NRefactory.dll" \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L \
	  -u "//HintPath[text()='/Applications/Xamarin Studio.app/Contents/Resources/lib/monodevelop/bin/Mono.TextEditor.dll']" \
	  -v "/usr/$(get_libdir)/monodevelop/bin/Mono.TextEditor.dll" \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L \
	  -u "//HintPath[text()='/Applications/Xamarin Studio.app/Contents/Resources/lib/monodevelop/bin/Mono.Addins.dll']" \
	  -v "/usr/$(get_libdir)/mono/mono-addins/Mono.Addins.dll" \
	  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj

	xml ed -L \
	  -u "//Content[@Include='..\..\..\ThirdParty\GamepadConfig\Tao.Sdl.dll.config']/@Include" \
	...
	#  IDE/MonoDevelop/MonoDevelop.MonoGame/MonoDevelop.MonoGame.csproj
	xml ed -L -s "//Project" -t attr -n "xmlns" \
