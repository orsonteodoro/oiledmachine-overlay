...
PACKAGE_NAME="Google.Apis.Vision.v1"
DESCRIPTION="Google Cloud Vision Client Library for C#"
...
CDEPEND=">=dev-dotnet/google-apis-bin-1.20.0
         >=dev-dotnet/google-apis-auth-bin-1.20.0"
DEPEND="${CDEPEND}"
RDEPEND="${CDEPEND}"
