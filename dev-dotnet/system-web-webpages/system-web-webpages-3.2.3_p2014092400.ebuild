...
src_compile() {
	...
	sn -R "${DLL_PATH}/${DIR}/System.Web.WebPages.dll" "${FILESDIR}"/../../../eclass/mono.snk || die
	sn -R "${DLL_PATH}/${DIR}/System.Web.WebPages.Deployment.dll" "${FILESDIR}"/../../../eclass/mono.snk || die
	sn -R "${DLL_PATH}/${DIR}/System.Web.Helpers.dll" "${FILESDIR}"/../../../eclass/mono.snk || die
