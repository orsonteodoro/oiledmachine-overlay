...
PACKAGE_NAME="Microsoft.Net.Http"
DESCRIPTION="Microsoft HTTP Client Libraries includes HttpClient for sending requests over HTTP, as well as HttpRequestMessage and HttpResponseMessage for processing HTTP messages."
...
CDEPEND=">=dev-dotnet/microsoft-bcl-build-bin-1.0.14
