...
SRC_URI=\
"https://github.com/loresoft/msbuildtasks/archive/1.5.0.196.tar.gz \
	-> ${P}.tar.gz"
inherit gac
RESTRICT="mirror"
S="${WORKDIR}/${PN}-${PV}"
...
src_install() {
	...
	egacinstall \
	 "Source/MSBuild.Community.Tasks/obj/${DIR}/MSBuild.Community.Tasks.dll"
	...
	if use developer ; then
		...
		doins \
      Source/MSBuild.Community.Tasks/obj/Release/MSBuild.Community.Tasks.dll.mdb
	fi
