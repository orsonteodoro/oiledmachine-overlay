...
* Auto bumping packages:
  - If a package is known to have multiple critical/high vulnerabilities in a
    month or is a high value asset under security scrutiny, keep only one
    ebuild per LTS or stable.  The stable is preferred over the dev releases
