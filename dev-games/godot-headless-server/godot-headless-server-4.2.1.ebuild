...
IUSE_3D="
+3d +csg +cvtt +denoise +gltf +gridmap +lightmapper_cpu +mobile-vr +raycast
+recast +vhacd +xatlas
"
IUSE_BUILD="
${SANITIZERS[@]}
clang debug lld lto jit +neon +optimize-speed optimize-size portable
"
IUSE_CONTAINERS_CODECS_FORMATS="
+bmp +dds +etc +exr +hdr +jpeg +ktx +minizip -mp1 -mp2 +mp3 +ogg +pvrtc +s3tc
+svg +tga +theora +vorbis +webp
"
IUSE_GUI="
+advanced-gui
"
...
"
IUSE_LIBS="
+freetype +opensimplex +pcre2
"
IUSE_NET="
ca-certs-relax +enet +jsonrpc +mbedtls +multiplayer +upnp +webrtc +websocket
"
IUSE_SCRIPTING="
-gdscript gdscript_lsp +mono +visual-script
"
IUSE_SYSTEM="
system-clipper2 system-embree system-enet system-freetype system-libogg
