...
# https://raw.githubusercontent.com/4ian/GDevelop/v5.1.160/newIDE/electron-app/package-lock.json \
# and \
# strings /var/tmp/portage/dev-games/gdevelop-5.1.160/work/GDevelop-5.1.160/newIDE/electron-app/dist/linux-unpacked/* | grep -E "Chrome/[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+"
ELECTRON_APP_REACT_PV="15.5.4" # See \
# https://raw.githubusercontent.com/4ian/GDevelop/v5.1.158/newIDE/app/package-lock.json
NODE_ENV="development"
NODE_VERSION=14
NPM_MULTI_LOCKFILE=1
NPM_OFFLINE=0 # Offline is broken
...
https://registry.npmjs.org/util.promisify/-/util.promisify-1.1.1.tgz -> npmpkg-util.promisify-1.1.1.tgz
...
https://registry.npmjs.org/postcss/-/postcss-8.4.22.tgz -> npmpkg-postcss-8.4.22.tgz
https://registry.npmjs.org/postcss-value-parser/-/postcss-value-parser-3.3.1.tgz -> npmpkg-postcss-value-parser-3.3.1.tgz
https://registry.npmjs.org/bn.js/-/bn.js-4.12.0.tgz -> npmpkg-bn.js-4.12.0.tgz
...
__npm_src_unpack() {
	...
	if [[ "${NPM_UPDATE_LOCK}" == "1" ]] ; then
		...
		local lockfiles=(
			"GDevelop.js/package-lock.json" # Required #1
			"newIDE/app/package-lock.json" # Required #2
			"newIDE/electron-app/package-lock.json" # Required #3
