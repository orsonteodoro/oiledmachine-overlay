...
_install_export_templates() {
	insinto /usr/share/godot/${SLOT_MAJ}/linux32/templates
	exeinto /usr/share/godot/${SLOT_MAJ}/linux32/templates
...
einfo "  cp -aT /usr/share/godot/${SLOT_MAJ}/linux32/templates ~/.local/share/godot/templates/${PV}.${STATUS}${suffix}"
einfo
}
