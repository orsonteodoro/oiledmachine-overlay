...
* PGO/BOLT will increase the attack complexity lowering the CVSS score.  The mitigation is almost half the CVSS score when complexity increased in this narrative.
