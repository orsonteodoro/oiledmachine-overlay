...
**_serious bugs and fixes_** that cannot be simply fixed through automated means
but required manual intervention.  You may find this manually and reading the
full text by navigating to the .txt file at:
