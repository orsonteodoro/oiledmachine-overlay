...
| dev-java/libmaker | This is the Library editor for ENIGMA and GameMaker.  It was written in Java.  More information can be found at https://enigma-dev.org/docs/Wiki/Library_Maker. |
...
| sys-devel/clang | Kept around for llvm same version. |
