...
*sci-misc/setiathome-cpu - Seti@Home version 8 client for the CPUs.  Support for automated ebuild level GCC/LLVM PGO for all.  You need to choose your arch (ppc, ppc64, x32, x64); then choose only one SIMD (avx2, avx-btver2, avx-bdver3, avx-bdver2, avx-bdver1, avx, sse42, sse41, ssse3, sse3, sse2, sse, mmx, 3dnow, altivec, or none) ordered from best to worst.
