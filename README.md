...
*sci-misc/setiathome-cpu - Seti@Home version 8 client for the CPUs.  Support for automated ebuild level GCC/LLVM PGO for all.  You need to choose your arch (ppc, ppc64, x32 [which is x86], x64 [which is x86_64], arm); then choose only one SIMD (avx2, avx-btver2, avx-bdver3, avx-bdver2, avx-bdver1, avx, sse42, sse41, ssse3, sse3, sse2, sse, mmx, 3dnow, altivec, or none) ordered from best to worst.

*sci-misc/astropulse-cpu - Astropulse version 7 client for CPUs.  Support for automated ebuild level GCC/LLVM PGO for all.  Support for automated ebuild level GCC/LLVM PGO for all.  You need to choose your arch (ppc, ppc64, x32 [which is x86], x64 [which is x86_64], arm with armv6-neon-nopie, armv6-neon, armv6-vfp-nopie, armv6-vfp, armv7-neon, armv7-neon-nopie, armv7-vfpv3, armv7-vfpv3d16, armv7-vfpv3d16-nopie, armv7-vfpv4, armv7-vfpv4-nopie); then choose only one SIMD (avx2, avx-btver2, avx-bdver3, avx-bdver2, avx-bdver1, avx, sse42, sse41, ssse3, sse3, sse2, sse, mmx, 3dnow, altivec, or none) ordered from best to worst.
