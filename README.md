...
| acct-group/risuai | A group for Risuai |
...
| acct-user/risuai | A user for Risuai |
...
| dev-python/llama-cpp-python | Python bindings for llama.cpp |
...
| dev-python/PyKCS11 | PKCS#11 Wrapper for Python |
...
| dev-python/python-yubico | Python code to talk to YubiKeys |
...
| dev-python/zxcvbn-rs-py | Python bindings for zxcvbn-rs, the Rust implementation of zxcvbn |
...
| gnome-extra/secrets | Manage your passwords |
