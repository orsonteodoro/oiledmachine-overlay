...
*games-engines/urho3d - Another game engine.  I have split off most of 3rd party dependencies and in the testing phase right now.  I would say that I am 80% done.  I will upload new dependencies as well and other ebuilds that target Lua 5.2.  Gentoo currently favors Lua 5.1 but some dependendencies require 5.2. glVertexAttribDivisor seems bugged so you may need to run with -gl2 mode for demos.  knet/network seems broken.  It could be caused by me using the vanilla knet.  It took me about a week to split off the third party dependencies (angelscript, civetweb, bullet, knet, box2d, sdl2) from the last stable release of Urho3d.  My criticism is that they don't build their wrappers or subclass them but rather embed superficial hacks into the extra third party libraries making it difficult to upgrade them or sort out dependencies.  The ebuild favors the vanilla dependencies versus minor tweaks added to by the Urho3d.  The reason why it took me long is because the scripting portion was incomplete and Tolua++ doesn't really have an official project maintainer.  I was trying to convert the last Tolua++ to make it work with lua5.2 but I just scrapped my version and went with waltervn build.  After the testing I will upload the ebuild.  Around 80+ edits were required to get it turn it into your typical Gentoo ebuild.  I also tried to make the ebuild flexible so it can be used for web browsers, Android, Raspberry PI.  I really have no interest to confirm that this ebuild will work on those platforms.  I will leave that task for you.  I was already finished but I am delaying the release because the angelscript scripts do not work and the knet networking is broken.  I am thinking of hardmasking those use flags and releasing it anyway.
