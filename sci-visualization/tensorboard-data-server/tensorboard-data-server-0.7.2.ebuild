...
RUST_PV="1.71.1" # Bumped to 1.71.1 (llvm-16.0) since 1.65.0 (llvm-15.0) is not offered on distro.
RUST_MAX_VER="1.71.2" # Excludes
RUST_MIN_VER="${RUST_PV}"
PYTHON_COMPAT=( python3_{10..11} )

# To generate the .ebuild file:
# cd "${WORKDIR}/tensorboard/data/server"
...
if [[ "${TARBALL_TYPE}" == "tensorboard" ]] ; then
	SRC_URI+="
https://github.com/tensorflow/tensorboard/archive/refs/tags/${TENSORBOARD_TARBALL_PV}.tar.gz
	-> tensorboard-${TENSORBOARD_TARBALL_PV}.tar.gz
	"
	S="${S_PROJ}/tensorboard/data/server"
	S_PROJ="${WORKDIR}/tensorboard-${TENSORBOARD_TARBALL_PV}"
else
	SRC_URI+="
