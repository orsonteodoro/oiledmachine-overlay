...
# https://github.com/grpc/grpc-java/blob/v1.61.1/.github/workflows/testing.yml#L20

# For supported python versions, see
# https://github.com/grpc/grpc/blob/v1.61.2/setup.py#L100

# For supported ruby versions, see
# https://github.com/grpc/grpc/blob/v1.61.2/Rakefile#L147
...
RESTRICT="test"
SLOT_MAJ="0"
SLOT="${SLOT_MAJ}/38.161" # 0/$gRPC_CORE_SOVERSION.$(ver_cut 1-2 $PACKAGE_VERSION | sed -e "s|.||g")
# third_party last update: 20240119
RDEPEND+="
