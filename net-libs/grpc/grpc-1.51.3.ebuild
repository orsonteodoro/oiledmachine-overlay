...
RDEPEND+="
	>=dev-cpp/abseil-cpp-20220623.0:${ABSEIL_CPP_SLOT}[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP},${MULTILIB_USEDEP},cxx_standard_cxx14?,cxx_standard_cxx17?]
	dev-cpp/abseil-cpp:=
...
PDEPEND+="
	...
	python? (
		~dev-python/grpcio-${PV}[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP},${PYTHON_USEDEP},cxx_standard_cxx14?,cxx_standard_cxx17?]
		dev-python/grpcio:=
	)
	ruby? (
		ruby_targets_ruby32? (
