...
if [[ "${PV}" =~ "9999" ]] ; then
	...
	FALLBACK_COMMIT="0a0120fa92cd7f6ab244865688b351df634f0707"
	IUSE+=" fallback-commit"
	S="${WORKDIR}/${P}"
	inherit git-r3
else
	EGIT_COMMIT="0a0120fa92cd7f6ab244865688b351df634f0707"
	KEYWORDS="~amd64"
	S="${WORKDIR}/zig-autobuild-${EGIT_COMMIT}"
	SRC_URI="
https://github.com/oven-sh/zig/archive/refs/tags/autobuild-${EGIT_COMMIT}.tar.gz
...
DOCS=( "README.md" )
PATCHES=(
	"${FILESDIR}/${PN}-20250610-llvm-non-fatal.patch"
