...
CEF_VERSION_RAW="06/30/2022 - 103.0.8+g444ebe7+chromium-103.0.5060.66 / Chromium 103.0.5060.66"
...
# For details see:
# Chromium runtime:  https://github.com/chromium/chromium/blob/103.0.5060.66/build/install-build-deps.sh#L237
# Chromium buildtime:  https://github.com/chromium/chromium/blob/103.0.5060.66/build/install-build-deps.sh#L151
...
OPTIONAL_RDEPEND="
	>=gnome-base/gnome-keyring-3.12[${MULTILIB_USEDEP},pam]
