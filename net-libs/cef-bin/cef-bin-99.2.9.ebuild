...
CEF_VERSION_RAW="99.2.9+gf426765+chromium-99.0.4844.51 / Chromium 99.0.4844.51"
CHROMIUM_V="${CEF_VERSION_RAW##* }" # same as https://bitbucket.org/chromiumembedded/cef/src/f426765/CHROMIUM_BUILD_COMPATIBILITY.txt?at=4844
...
# For details see:
# Chromium runtime:  https://github.com/chromium/chromium/blob/99.0.4844.51/build/install-build-deps.sh#L237
# Chromium buildtime:  https://github.com/chromium/chromium/blob/99.0.4844.51/build/install-build-deps.sh#L151
