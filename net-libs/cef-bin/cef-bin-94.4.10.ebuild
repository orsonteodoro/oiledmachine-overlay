...
# 10/12/2021 - 94.4.10+g38a7995+chromium-94.0.4606.81 / Chromium 94.0.4606.81
CHROMIUM_V="94.0.4606.81" # same as https://bitbucket.org/chromiumembedded/cef/src/add734a/CHROMIUM_BUILD_COMPATIBILITY.txt?at=4515
CEF_COMMIT="g38a7995" # same as https://bitbucket.org/chromiumembedded/cef/commits/
...
# For details see:
# Chromium runtime:  https://github.com/chromium/chromium/blob/94.0.4606.81/build/install-build-deps.sh#L237
# Chromium buildtime:  https://github.com/chromium/chromium/blob/94.0.4606.81/build/install-build-deps.sh#L151
