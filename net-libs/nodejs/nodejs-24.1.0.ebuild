...
# Last deps commit date:  May 15, 2025
...
NGHTTP2_PV="1.64.0"
NGHTTP3_PV="1.6.0"
NPM_PV="11.3.0" # See https://github.com/nodejs/node/blob/v24.1.0/deps/npm/package.json
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-24.1.0-split-pointer-compression-and-v8-sandbox-options.patch"
