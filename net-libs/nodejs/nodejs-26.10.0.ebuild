...
# Last deps commit date:  Sep 20, 2026
...
COREPACK_PV="0.36.0"
NPM_PV="11.19.1" # See https://github.com/nodejs/node/blob/v26.10.0/deps/npm/package.json
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-26.10.0-split-pointer-compression-and-v8-sandbox-options.patch"
