...
# Last deps commit date:  Nov 27, 2024
...
MULTIPLEXER_VER="11"
NGHTTP2_PV="1.64.0"
NPM_PV="10.9.0" # See https://github.com/nodejs/node/blob/v22.12.0/deps/npm/package.json
...
set_jit_level() {
	...
	_jit_level_6() {
		# 100% performance
		myconf+=( $(enable_gdb) )
	# https://github.com/nodejs/node/blob/v22.12.0/deps/v8/BUILD.gn#L516
