...
IUSE+="
$(gen_iuse_pgo)
acorn +asm +corepack cpu_flags_x86_sse2 -custom-optimization debug doc -drumbrake fips +icu +jit
...
set_jit_level() {
	...
	_jit_level_6() {
		...
		myconf+=( $(usex drumbrake "--v8-enable-drumbrake" "") )
		myconf+=( $(enable_gdb) )
	# https://github.com/nodejs/node/blob/v23.5.0/deps/v8/BUILD.gn#L542
