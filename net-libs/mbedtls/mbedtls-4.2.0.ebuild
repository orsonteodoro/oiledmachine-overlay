...
if [[ "${PV}" =~ "9999" ]] ; then
	FALLBACK_COMMIT="ece41aa84d7879d7e55c59e955a5884b541f7f3b"
...
src_unpack() {
	...
	actual_sover=$(grep -r -e "MBEDTLS_CRYPTO_SOVERSION" "${S}/CMakeLists.txt" | grep -o -E -e "MBEDTLS_CRYPTO_SOVERSION [0-9]+" | cut -f 2 -d " ")
...
eerror "Expected SOVER:  ${expected_sover}"
	...
	actual_sover=$(grep -r -e "MBEDTLS_TLS_SOVERSION" "${S}/CMakeLists.txt" | grep -o -E -e "MBEDTLS_TLS_SOVERSION [0-9]+" | cut -f 2 -d " ")
...
eerror "Expected SOVER:  ${expected_sover}"
	...
	actual_sover=$(grep -r -e "MBEDTLS_X509_SOVERSION" "${S}/CMakeLists.txt" | grep -o -E -e "MBEDTLS_X509_SOVERSION [0-9]+" | cut -f 2 -d " ")
