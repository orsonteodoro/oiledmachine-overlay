...
+libhyphen -libwebrtc -mediarecorder -mediastream +minibrowser +opengl
openmp +pulseaudio -seccomp -spell test thunder +unified-builds vaapi
variation-fonts +v4l wayland +webassembly +webassembly-b3-jit +webcore
+webcrypto -webdriver +webgl -webgl2 webm-eme -webrtc webvtt -webxr +woff2
+X +yarr-jit
"
