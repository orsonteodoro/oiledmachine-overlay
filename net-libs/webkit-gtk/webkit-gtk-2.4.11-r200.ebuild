...
inherit autotools check-reqs flag-o-matic gnome2 multilib multilib-minimal pax-utils python-any-r1 ruby-single toolchain-funcs versionator virtualx
...
multilib_src_configure() {
	...
	gnome2_src_configure \
		...
		${ruby_interpreter} \
               ...
               --bindir=/usr/$(get_libdir)/webkit-gtk \
