...
inherit check-reqs cmake-utils eutils flag-o-matic gnome2 multilib multilib-minimal pax-utils python-any-r1 ruby-single toolchain-funcs versionator virtualx
