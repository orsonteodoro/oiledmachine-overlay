...
src_prepare() {
	...
	PATCH_PATHS=(
		...
		"${WORKDIR}/llvm-project-rocm-${PV}/lib/Target/AMDGPU/Disassembler/CMakeLists.txt"
		...
		"${WORKDIR}/llvm-project-rocm-${PV}/llvm/tools/llvm-dwarfdump/CMakeLists.txt"
		...
		"${WORKDIR}/llvm-project-rocm-${PV}/mlir/lib/Target/LLVM/CMakeLists.txt"
		"${WORKDIR}/llvm-project-rocm-${PV}/mlir/tools/mlir-rocm-runner/CMakeLists.txt"
