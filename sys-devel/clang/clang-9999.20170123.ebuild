...
SRC_URI=""
CLANG_EXTRA_TOOLS_COMMIT="d61565aaf0d7a19386eaaa23095283e1df122225"
LLVM_COMMIT="aeb6f08dc22af684eec3c868e042e6674644a859"
CLANG_COMMIT="4e48d6f54e0ceb42d7ee8ea466a118dd3bcf54d9"
...
src_unpack() {
	einfo "Fetching clang-extra-tools"
	EGIT_COMMIT="${CLANG_EXTRA_TOOLS_COMMIT}"
	git-r3_fetch "http://llvm.org/git/clang-tools-extra.git
		https://github.com/llvm-mirror/clang-tools-extra.git"
	if use test; then
		einfo "Fetching llvm"
		EGIT_COMMIT="${LLVM_COMMIT}"
		# needed for patched gtest
		git-r3_fetch "http://llvm.org/git/llvm.git
			https://github.com/llvm-mirror/llvm.git"
	fi
	einfo "Fetching clang"
	EGIT_COMMIT="${CLANG_COMMIT}"
	git-r3_fetch "http://llvm.org/git/clang.git
		https://github.com/llvm-mirror/clang.git"

	einfo "Checkout clang-extra-tools"
	EGIT_COMMIT="${CLANG_EXTRA_TOOLS_COMMIT}"
