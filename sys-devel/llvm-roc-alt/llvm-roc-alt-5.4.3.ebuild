...
DOWNLOAD_FOLDER_URI="http://repo.radeon.com/rocm/apt/5.4.3/pool/proprietary/r/rocm-llvm-alt"
DOWNLOAD_FILE="rocm-llvm-alt_15.0.0.22380.50403-121~22.04_amd64.deb"
LLVM_MAX_SLOT=15 # Based on sover and tarball name
MY_PN="rocm-llvm-alt"
...
# Links to GCC 11.1.0 (particularly libstdc++)
RDEPEND="
	${PYTHON_DEPS}
