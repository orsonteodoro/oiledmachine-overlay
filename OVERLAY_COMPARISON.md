...
| Containerization policy             | Decontainerize packages or is a bad habit (lowers security and increases blast radius, contributes to bad security architecture) | Containerize if EOL or if complex build, otherwise decontainerize |
