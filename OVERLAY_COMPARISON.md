...
| Documentation style                 | Simple, undocumented mods or undocumented known settings that lead to performance regressions | Transparent and comprehensive, mods and regressions are documented and warned to user |
