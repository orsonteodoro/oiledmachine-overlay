...
| C++ consistency                     | N, user is responsible, difficult to find when build      | Y, enforced by gcc_slot_* USE flags and REQUIRED_USE        |
|                                     | logging is off by default for used C++ standard.          |                                                             |
