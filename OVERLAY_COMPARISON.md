...
| Reproducible live ebuilds           | N, user is reponsible, quality is typically overlooked | Y, with USE=fallback-commit capable ebuilds, some ebuilds have high quality tested commit review to reduce build failure |
