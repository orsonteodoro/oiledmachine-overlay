...
| Secondary ebuild goals              | Portability | Feature complete (aka full version) ebuilds, power user customization, packaging power user or must have software, new/custom feature patches exclusives, dummy proofing / guardrails |
...
| Submission/contributor contracts    | Y                                          | N (no blackmail or further oppression, just follow the open source software license freedoms) |
