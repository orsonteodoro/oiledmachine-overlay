...
| Node/cargo lockfile security scanning | N (GitHub Dependabot which uses AI and EPSS which uses AI modeling)      | Y (GitHub Dependabot is used for security alerts but not editing.  Editing is done by hand by human or by the package manager.) |
