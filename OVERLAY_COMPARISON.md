...
| CI testing                          | Y (independent integration testing verification, sometimes security compiler warnings ignored) | N (avoid time/maintenance cost, time better spend on creative aspects of open source -- new projects or new ebuilds) |
...
| Node/cargo lockfile security scanning | N (GitHub Dependabot which uses AI and EPSS which uses ML)      | Y (GitHub Dependabot is used for security alerts but not editing.  Editing is done by hand by human or by the package manager.) |
