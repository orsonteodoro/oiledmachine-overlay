...
| Quality for package inclusion       | Actively maintained projects               | Ebuild forks to correct issues or new packages from awesome lists, hidden gems on GitHub, etc |
