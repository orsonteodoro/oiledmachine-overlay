...
EAPI=6
inherit eutils mono multilib-build gac git-r3
...
RDEPEND="
	...
	>=dev-util/monodevelop-monodevelop-6.1.2.44
...
"
USE_DOTNET="net45"
IUSE="${USE_DOTNET} debug bindist gamepad-config mgcb 2mgfx pipeline mp3compression abi_x86_64 abi_x86_32 +gac"
...
src_unpack() {
        ...
        EGIT_BRANCH="develop"
        EGIT_COMMIT="03adb18e45b22c217af01eb4398099fb543f5032"
        git-r3_fetch
        git-r3_checkout
...
src_prepare() {
	...
	#eapply "${FILESDIR}/monogame-3.5.1-monodevelop-6-addin.patch" || die
	...
	#eapply "${FILESDIR}"/monogame-3.4-addin5-compat.patch omt check me
