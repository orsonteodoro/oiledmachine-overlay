...
src_prepare() {
	...
	#need to test
	epatch "${FILESDIR}"/urho3d-1.5-conditional-sdl-extensions.patch || die p38
	epatch "${FILESDIR}"/urho3d-1.5-conditional-sdl-extensions-2.patch || die p39
...
if $(true); then #scripting engine fixes
	...
	epatch "${FILESDIR}"/urho3d-1.5-corner.patch || die p75
...
if use odbc; then
	...
	epatch "${FILESDIR}"/urho3d-9999-opassign-27edits.patch
	...
	epatch "${FILESDIR}"/urho3d-9999-scriptcpp-propaccessormode.patch
