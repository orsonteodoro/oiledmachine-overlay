...
DEPEND="
	...
	system-libs? (
		...
		>=sci-libs/kineto-0.4.1_p20230202
		cuda? (
...
src_prepare() {
	...
	if use system-libs ; then
		eapply "${FILESDIR}/caffe2-2.0.1-cuda-hardcoded-paths.patch"
		eapply "${FILESDIR}/caffe2-2.0.1-rocm-hardcoded-paths.patch"
	else
		eapply "${FILESDIR}/caffe2-2.0.1-cuda-hardcoded-paths.patch"
		eapply "${FILESDIR}/caffe2-2.0.1-rocm-hardcoded-paths.patch"
		eapply "${FILESDIR}/caffe2-2.0.1-cuda-hardcoded-paths-third-party.patch"
		eapply "${FILESDIR}/caffe2-2.0.1-rocm-hardcoded-paths-third-party.patch"
	fi
