...
# https://github.com/pytorch/pytorch/blob/v2.0.1/.ci/docker/common/install_rocm_magma.sh#L9 for magma
...
# Based on https://github.com/pytorch/pytorch/blob/v2.0.1/.ci/pytorch/build.sh#L148
	gfx700
	gfx701
	gfx801
	gfx802
...
GCC_SLOTS=( {15..7} ) # Upstream uses 9 or 7
...
CUDNN_FRONTEND_COMMIT="81a041a68245cd8f871c43bbbbd5b6b627979a30"
...
DYNOLOG_COMMIT="8a6d9f49ad4e70ea60bb7c158dd98f04b213520b" # kineto dep ; committer-date:<=2023-02-02
...
GLOO_COMMIT="10909297fedab0a680799211a299203e53515032"
GOOGLETEST_COMMIT_1="bdb3b0a4939228f28fcb38e786cc29b79db463ab" # gloo dep ; committer-date:<=2023-01-17
GOOGLETEST_COMMIT_2="5ec7f0c4a113e2f18ac2c6cc7df51ad6afc24081" # protobuf dep
GOOGLETEST_COMMIT_3="3f9c7fcaa3e5a40cd3afc9a12327399f7b2a3496" # kineto dep ; committer-date:<=2023-02-02
...
IDEEP_COMMIT="7bc3e12f7c0cad7fb24f8d4ab63dcd467ffa60c7"
IOS_CMAKE_COMMIT="8abaed637d56f1337d6e1d2c4026e25c1eade724"
FBGEMM_COMMIT="03b2046676707da64504e898490ab46104d4682a"
FFMPEG_COMPAT=(
...
FMT_COMMIT_1="a33701196adfad74917046096bf5a2aa0ab0bb50"
FMT_COMMIT_2="05e3a9233ac1dd0c2d9643e046dbb5f788c39f61" # kineto dep ; committer-date:<=2023-02-02
...
KINETO_COMMIT="2da532c91dee9dc36cccc6088206daa1b69e3966"
...
LLVM_COMPAT=(
	15 # ROCm slot
	12 10 9 8 7 # Upstream build.sh, pull.yml
)
...
MKL_DNN_COMMIT="6dbeffbae1f23cbbeae17adb7b5b13f1f37c080e"
MYPN="pytorch"
MYP="${MYPN}-${PV}"
...
ONNX_COMMIT_1="e192ba01e438d22ca2dedd7956e28e3551626c91"
...
PYBIND11_COMMIT_1="80dc998efced8ceb2be59756668a7e90e8bef917"
...
DEPEND="
	...
	system-libs? (
		...
		>=sci-misc/kineto-0.4.1_p20230202
		cuda? (
			>=dev-libs/cutlass-2.10.0
		)
		onednn? (
			>=sci-libs/ideep-0.8.0
		)
	)
"
gen_clang() {
...
src_prepare() {
	...
	if use system-libs ; then
		eapply "${FILESDIR}/${PN}-2.0.1-cuda-hardcoded-paths.patch"
		eapply "${FILESDIR}/${PN}-2.0.1-rocm-hardcoded-paths.patch"
	else
		eapply "${FILESDIR}/${PN}-2.0.1-cuda-hardcoded-paths.patch"
		eapply "${FILESDIR}/${PN}-2.0.1-rocm-hardcoded-paths.patch"
		eapply "${FILESDIR}/${PN}-2.0.1-cuda-hardcoded-paths-third-party.patch"
		eapply "${FILESDIR}/${PN}-2.0.1-rocm-hardcoded-paths-third-party.patch"
	fi
