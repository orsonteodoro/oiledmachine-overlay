...
# https://github.com/pytorch/pytorch/tree/v2.3.0/third_party
# https://github.com/pytorch/pytorch/blob/v2.3.0/.ci/docker/common/install_rocm_magma.sh#L10 for magma
...
# Based on https://github.com/pytorch/pytorch/blob/v2.3.0/.ci/pytorch/build.sh#L162
	gfx700
	gfx701
	gfx801
	gfx802
...
ROCM_SLOTS=(
# See https://github.com/pytorch/pytorch/blob/v2.3.0/.ci/docker/build.sh#L190
	"${HIP_6_0_VERSION}"
	"${HIP_5_7_VERSION}"
)
gen_rocm_slots() {
...
openblas -opencl -opencv +openmp rocm +qnnpack +xnnpack
ebuild-revision-2
"
