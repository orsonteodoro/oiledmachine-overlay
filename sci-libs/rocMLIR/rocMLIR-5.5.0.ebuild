...
# STATUS for USE=system-mlir: 37/119 complete for vanilla llvm toolchain compatibility
# Ebuild provided for ebuild developers help to complete USE=system-mlir.
...
_LLVM_SYSTEM_PATCHES=(
	"${FILESDIR}/rocMLIR-5.5.0-fix-bin-linking.patch"
	"${FILESDIR}/rocMLIR-5.5.0-fix-sover-and-rpath.patch"
	"${FILESDIR}/rocMLIR-5.5.0-use-system-mlir.patch"
	"${FILESDIR}/rocMLIR-5.5.0-target-changes.patch"
	"${FILESDIR}/rocMLIR-5.5.0-NoSideEffect-renamed.patch"
	"${FILESDIR}/rocMLIR-5.5.0-RecursiveSideEffects-renamed.patch"
	"${FILESDIR}/rocMLIR-5.5.0-Arithmetic-renamed.patch"
	"${FILESDIR}/rocMLIR-5.5.0-BlockAndValueMapping-renamed.patch"
	"${FILESDIR}/rocMLIR-5.5.0-llvm-none.patch"
)
...
# OILEDMACHINE-OVERLAY-STATUS:  builds-without-problems with USE=-system-mlir
