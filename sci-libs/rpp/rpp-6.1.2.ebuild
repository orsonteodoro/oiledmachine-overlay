...
# TODO:  recheck/patch hardcoded paths in source code level from /opt/rocm/ to /opt/rocm-6.1.2
...
# See https://github.com/GPUOpen-ProfessionalCompute-Libraries/rpp/blob/rocm-6.1.2/docs/release.md?plain=1#L18
LLVM_COMPAT=( 17 )
