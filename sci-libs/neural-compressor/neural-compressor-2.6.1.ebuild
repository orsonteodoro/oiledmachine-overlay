...
RDEPEND+="
	...
	$(python_gen_cond_dep '
		...
		ort? (
			...
			>=sci-libs/onnxruntime-1.17.1[${PYTHON_USEDEP},extensions,training-ort]
			dev-python/numpy[${PYTHON_USEDEP}]
			dev-python/py-cpuinfo[${PYTHON_USEDEP}]
			dev-python/psutil[${PYTHON_USEDEP}]
			dev-python/pydantic[${PYTHON_USEDEP}]
			sci-libs/onnxruntime-extensions[${PYTHON_USEDEP}]
		)
		pytorch? (
...
BDEPEND+="
	$(python_gen_cond_dep '
		...
		test? (
			...
			>=sci-libs/intel-extension-for-pytorch-1.10[${PYTHON_USEDEP}]
			>=sci-libs/onnx-1.15.0[${PYTHON_USEDEP}]
			>=sci-libs/onnxruntime-1.17.1[${PYTHON_USEDEP}]
			...
			sci-libs/tf_slim[${PYTHON_USEDEP}]
