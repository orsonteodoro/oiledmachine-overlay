...
RDEPEND="
	...
	rocm? (
		...
		~sci-libs/rocPRIM-${PV}:${ROCM_SLOT}[${ROCPRIM_5_6_AMDGPU_USEDEP}]
		~sci-libs/rocRAND-${PV}:${ROCM_SLOT}[${ROCRAND_5_6_AMDGPU_USEDEP}]
		~sci-libs/rocSPARSE-${PV}:${ROCM_SLOT}[${ROCSPARSE_5_6_AMDGPU_USEDEP}]
	)
"
DEPEND="
	${RDEPEND}
