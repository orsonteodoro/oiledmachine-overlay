...
RDEPEND="
	...
	rocm? (
		...
		~sci-libs/rocPRIM-${PV}:${ROCM_SLOT}[${ROCPRIM_4_5_AMDGPU_USEDEP}]
		~sci-libs/rocRAND-${PV}:${ROCM_SLOT}[${ROCRAND_4_5_AMDGPU_USEDEP}]
		~sci-libs/rocSPARSE-${PV}:${ROCM_SLOT}[${ROCSPARSE_4_5_AMDGPU_USEDEP}]
	)
"
DEPEND="
	${RDEPEND}
