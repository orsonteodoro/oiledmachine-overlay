...
RDEPEND="
	...
	rocm? (
		...
		~sci-libs/rocBLAS-${PV}:${ROCM_SLOT}[${ROCBLAS_5_2_AMDGPU_USEDEP}]
		~sci-libs/rocPRIM-${PV}:${ROCM_SLOT}[${ROCPRIM_5_2_AMDGPU_USEDEP}]
		~sci-libs/rocRAND-${PV}:${ROCM_SLOT}[${ROCRAND_5_2_AMDGPU_USEDEP}]
		~sci-libs/rocSPARSE-${PV}:${ROCM_SLOT}[${ROCSPARSE_5_2_AMDGPU_USEDEP}]
	)
"
DEPEND="
	${RDEPEND}
