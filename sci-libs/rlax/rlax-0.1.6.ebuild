...
RDEPEND+="
	...
	>=sci-libs/chex-0.0.8[${PYTHON_USEDEP}]
	>=sci-libs/distrax-0.0.2[${PYTHON_USEDEP}]
	>=sci-libs/jax-0.3.0[${PYTHON_USEDEP}]
	>=sci-libs/jaxlib-0.1.37[${PYTHON_USEDEP}]
	sci-libs/dm_env[${PYTHON_USEDEP}]
	examples? (
		>=sci-libs/dm_env-1.2[${PYTHON_USEDEP}]
	)
"
DEPEND+="
	${RDEPEND}
...
BDEPEND+="
	...
	test? (
		>=sci-libs/dm-haiku-0.0.4[${PYTHON_USEDEP}]
		>=sci-libs/optax-0.0.9[${PYTHON_USEDEP}]
	)
"
DOCS=( "README.md" )
