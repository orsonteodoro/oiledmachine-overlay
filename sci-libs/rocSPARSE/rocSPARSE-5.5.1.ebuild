...
RDEPEND="
	...
	~sci-libs/rocPRIM-${PV}:${ROCM_SLOT}[${ROCPRIM_5_5_AMDGPU_USEDEP},rocm(+)]
...
BDEPEND="
	${HIPCC_DEPEND}
	>=dev-build/cmake-3.5
	sys-devel/gcc:${HIP_5_5_GCC_SLOT}[fortran]
...
"/usr/${CHOST}/gcc-bin/${HIP_5_5_GCC_SLOT}/gfortran" \${args}
EOF
	...
	ln -s \
		"${WORKDIR}/bin/${CHOST}-gfortran" \
		"${WORKDIR}/bin/gfortran-${HIP_5_5_GCC_SLOT}" \
		|| die
}
