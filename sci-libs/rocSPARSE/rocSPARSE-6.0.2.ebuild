...
RDEPEND="
	...
	~sys-libs/llvm-roc-libomp-${PV}:${ROCM_SLOT}[${LLVM_ROC_LIBOMP_6_0_AMDGPU_USEDEP}]
...
"/usr/${CHOST}/gcc-bin/${HIP_6_0_GCC_SLOT}/gfortran" \${args}
EOF
	...
	ln -s \
		"${WORKDIR}/bin/${CHOST}-gfortran" \
		"${WORKDIR}/bin/gfortran-${HIP_6_0_GCC_SLOT}" \
		|| die
}
