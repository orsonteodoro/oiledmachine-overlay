...
FIN_COMMIT="afc1a8d87e6d00c82903942007bb370ee1f6c760"
...
RDEPEND="
	...
	composable-kernel? (
		sci-libs/composable_kernel:${ROCM_SLOT}[${COMPOSABLE_KERNEL_6_0_AMDGPU_USEDEP}]
	)
	kernels? (
		~sci-libs/miopenkernels-${PV}:${ROCM_SLOT}[${MIOPENKERNELS_6_0_AMDGPU_USEDEP}]
	)
	opencl? (
		~dev-libs/rocm-opencl-runtime-${PV}:${ROCM_SLOT}[${LLVM_ROC_LIBOMP_6_0_AMDGPU_USEDEP}]
	)
	rocm? (
		~dev-util/hip-${PV}:${ROCM_SLOT}[rocm]
		~sci-libs/rocBLAS-${PV}:${ROCM_SLOT}[${ROCBLAS_6_0_AMDGPU_USEDEP},rocm]
	)
"
DEPEND="
	${RDEPEND}
