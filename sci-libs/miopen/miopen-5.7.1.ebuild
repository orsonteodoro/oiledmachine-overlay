...
RDEPEND="
	...
	composable-kernel? (
		sci-libs/composable_kernel:${ROCM_SLOT}[${COMPOSABLE_KERNEL_5_7_AMDGPU_USEDEP}]
	)
	kernels? (
		~sci-libs/miopenkernels-${PV}:${ROCM_SLOT}[${MIOPENKERNELS_5_7_AMDGPU_USEDEP}]
	)
	opencl? (
		~dev-libs/rocm-opencl-runtime-${PV}:${ROCM_SLOT}[${LLVM_ROC_LIBOMP_5_7_AMDGPU_USEDEP}]
