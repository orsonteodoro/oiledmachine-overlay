...
"
SLOT="${ROCM_SLOT}/${PV}"
IUSE="comgr composable-kernel debug hiprtc kernels mlir opencl +rocm test ebuild-revision-8"
...
RDEPEND="
	...
	composable-kernel? (
		sci-libs/composable_kernel:${ROCM_SLOT}[${COMPOSABLE_KERNEL_5_4_AMDGPU_USEDEP}]
	)
	kernels? (
