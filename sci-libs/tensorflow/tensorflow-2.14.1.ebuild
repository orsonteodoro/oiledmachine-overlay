...
LLVM_COMPAT=( {16..15} ) # See https://github.com/tensorflow/tensorflow/blob/v2.14.1/tensorflow/tools/toolchains/remote_config/configs.bzl
...
# https://github.com/tensorflow/tensorflow/blob/v2.14.1/tensorflow/tools/pip_package/setup.py#L356				# cuda version
...
# https://github.com/tensorflow/tensorflow/blob/v2.14.1/third_party/flatbuffers/workspace.bzl
...
ONEDNN_PV="2.7.3"		# From https://github.com/tensorflow/tensorflow/blob/v2.14.1/tensorflow/workspace2.bzl ; mkl_dnn_v1
...
PLATFORMS_PV="0.0.6"		# From https://github.com/tensorflow/runtime/blob/769f5cc9b8732933140b09e8808d13614182b496/third_party/rules_cuda/cuda/dependencies.bzl#L66
...
RULES_PYTHON_PV="0.0.1"		# From https://github.com/tensorflow/tensorflow/blob/v2.14.1/tensorflow/workspace2.bzl x
...
PDEPEND="
	python? (
		$(python_gen_cond_dep '
			=dev-python/tensorflow-io-0.35.0[${PYTHON_USEDEP},tensorflow-io-gcs-filesystem]
		' python3_{10,11})
