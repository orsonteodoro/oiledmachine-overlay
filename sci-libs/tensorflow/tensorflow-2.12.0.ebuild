...
# manually disable some of the rows in python? in *DEPEND for the test USE flag
# to work by adding python_targets_python3_9 -python_targets_python3_10
# -python_targets_python3_11 to package.use.
...
# https://github.com/tensorflow/tensorflow/blob/v2.12.0/configure.py#L33
...
CUDA_PV="11.8"			# From https://github.com/tensorflow/tensorflow/blob/v2.12.0/tensorflow/tools/dockerfiles/partials/ubuntu/nvidia.partial.Dockerfile
