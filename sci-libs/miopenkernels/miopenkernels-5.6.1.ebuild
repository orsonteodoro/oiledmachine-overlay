...
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx1030-36kdb/miopen-hip-gfx1030-36kdb_2.20.0.50601-93~22.04_amd64.deb
		)
		amdgpu_targets_gfx900? (
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx900-56kdb/miopen-hip-gfx900-56kdb_2.20.0.50601-93~22.04_amd64.deb
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx900-64kdb/miopen-hip-gfx900-64kdb_2.20.0.50601-93~22.04_amd64.deb
		)
		amdgpu_targets_gfx906? (
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx906-60kdb/miopen-hip-gfx906-60kdb_2.20.0.50601-93~22.04_amd64.deb
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx906-64kdb/miopen-hip-gfx906-64kdb_2.20.0.50601-93~22.04_amd64.deb
		)
		amdgpu_targets_gfx908? (
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx908-120kdb/miopen-hip-gfx908-120kdb_2.20.0.50601-93~22.04_amd64.deb
		)
		amdgpu_targets_gfx90a? (
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx90a-104kdb/miopen-hip-gfx90a-104kdb_2.20.0.50601-93~22.04_amd64.deb
https://repo.radeon.com/rocm/apt/${MY_PV}/pool/main/m/miopen-hip-gfx90a-110kdb/miopen-hip-gfx90a-110kdb_2.20.0.50601-93~22.04_amd64.deb
		)
	"
fi
