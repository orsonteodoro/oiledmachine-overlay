...
REQUIREMENTS_RDEPEND="
	<sci-libs/gym-0.25.3[${PYTHON_USEDEP},atari,accept-rom-license]
	...
	>=sci-libs/jax-0.3.16[${PYTHON_USEDEP}]
	>=sci-libs/jaxlib-0.3.15[${PYTHON_USEDEP}]
...
RDEPEND+="
	...
	>=sci-libs/flax-0.2.0[${PYTHON_USEDEP}]
	>=sci-libs/jax-0.1.72[${PYTHON_USEDEP}]
	>=sci-libs/jaxlib-0.1.51[${PYTHON_USEDEP}]
	>=sci-libs/tensorflow-2.2.0[${PYTHON_USEDEP}]
	>=sci-libs/tensorflow-probability-0.13.0[${PYTHON_USEDEP}]
	>=sci-libs/tf_slim-1.0[${PYTHON_USEDEP}]
"
DEPEND+="
	${RDEPEND}
"
