...
einfo
einfo "  SUPER + R          -- Runs an app command"
einfo "  SUPER + Q          -- Runs the terminal"
einfo "  SUPER + left       -- Focus on left window"
einfo "  SUPER + right      -- Focus on right window"
einfo "  SUPER + up         -- Focus on top window"
einfo "  SUPER + down       -- Focus on bottom window"
einfo "  SUPER + M          -- Quit"
...
einfo "  SUPER + SHIFT + 0  -- Move window to virtual desktop 0"
einfo "  SUPER + 1          -- Use virtual desktop 1"
einfo "  SUPER + 2          -- Use virtual desktop 2"
einfo "  ..."
einfo "  SUPER + 9          -- Use virtual desktop 9"
einfo "  SUPER + 0          -- Use virtual desktop 0"
einfo
ewarn
ewarn "The Hyprlang config style is deprecated and will be removed in the future."
ewarn "Migrate the config to the newest LUA based config style."
ewarn
	...
	optfeature "a screen locker" "gui-apps/hyprlock"
	optfeature "a themable status bar with clock and plugins" "gui-apps/noctalia"
	optfeature "a utility to change or set the wallpaper" "gui-apps/swaybg"
}
