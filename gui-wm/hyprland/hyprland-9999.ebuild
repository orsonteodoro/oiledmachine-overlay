...
ewarn
	...
	optfeature "a Qt themable status bar with clock and plugins, version 4.x" "gui-apps/noctalia-shell"
	optfeature "a Wayland themable status bar with clock and plugins, version 5.x" "gui-apps/noctalia"
