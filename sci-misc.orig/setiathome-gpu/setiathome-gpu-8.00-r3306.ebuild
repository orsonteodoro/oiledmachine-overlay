...
src_unpack() {
	...
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-1.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-2.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-3.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-4.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-5.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-6.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-7.patch
	eapply "${FILESDIR}"/setiathome-gpu-8.0-gpu-opengl-on-opencl-8.patch
