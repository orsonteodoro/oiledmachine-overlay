...
SRC_URI="https://bitbucket.org/ckolivas/${PN}/get/v${PV}.tar.bz2 -> ${PN}.${PV}.tar.bz2"
...
S="${WORKDIR}/ckolivas-ckpool-ee10a5b339ae"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-0.9.4-external-jansson.patch
