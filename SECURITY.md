...
* EPSS scores of [1%, 5%) may be optionally or conveniently triaged, but
  provided as a carrot on a stick motivator to achieve 80%-90% coverage of the
  in the wild set or the observed vulnerabilities in the model/example.
...
| Biometric                             | GDPR, HIPAA, PIPL   | Discrimination, physical, security      | CN, EU/UK, US      | Login, machine learning, computer vision                                                              |
| Birth dates                           | GDPR, HIPAA, [20]   | Discrimination, financial               | Many countries     | Web browser/server/database, genelogical apps                                                         |
| Children's data                       | [4]                 | Anonymity, physical                     | AU, CN, EU, UK, US | Web browser/server/database                                                                           |
...
| Cookies (Session replay, behavioral)  | GDPR, [21]          | Discrimination, ownership, reputational | CN, EU/UK          | Debugging websites, spying, malicious threat actor abuse, AI guardrails, rate limiting                |
| Cookies (Session tokens)              | GDPR, [14][21]      | Impersonation, Reputation               | CN, EU/UK          | Web, one time login                                                                                   |
...
| CPU details                           |                     | Security                                |                    | Debug logs/dumps, fingerprinting users, entropy, attacker reconnaissance, hardware flaw explotation   |
...
| Email address                         | GDPR, [7]           | Anonymity, emotional, financial         | CA, EU/UK, JP, US  | Web browser/server/database                                                                           |
| Email content                         | CCPA/CPRA (US-CA)   | Reputational                            | US                 | Web browser/server/database, LLMs                                                                     |
| Employee/User PII                     | [11]                | Anonymity, reputational                 | Worldwide          | Cryptocurrency                                                                                        |
...
| IP or MAC addresses                   | GDPR, [6]           | Anonymity, discrimination, financial    | EU/UK, US          | Web browser/server/database                                                                           |
...
| Login / screen names                  | GDPR, [9]           | Emotional, financial, reputational      | US                 | Web browser/server/database                                                                           |
| Multi-factor Authentication (MFA/2FA) | PCI DSS, [11]       | Financial                               | Worldwide          | Fintech, cryptocurrency, login                                                                        |
| Password                              | GDPR, [10]          | Data theft, financial, reputational     | Worldwide          | Web browser/server/database, clipboard, crypto/auth libs, password managers                           |
| Password recovery answers             |                     | Ownership, security                     |                    | Web login systems and databases                                                                       |
...
| Racial / ethicity                     | GDPR, [1]           | Discrimination, physical                | CN, EU/UK, US      | Web browser/server/database                                                                           |
| Real names                            | GDPR, HIPAA, [8]    | Anonymity, Financial, physical          | EU/UK, US          | Web browser/server/database, word processor, geneological, contacts app                               |
| Recovery seed phrases                 |                     | Financial                               |                    | Cryptocurrency, password managers                                                                     |
| Religious                             | GDPR, [2]           | Discrimination, physical                | CN, EU/UK, US      | Web browser/server/database                                                                           |
| Sex life / explicit content           | GDPR [16]           | Anonymity, Discrimination, physical     | CA, EU/UK, US      | Web browser/server/database, image viewers, codecs, movie editors/players                             |
