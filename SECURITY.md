...
| Privilege escalation           | PE                    | General or miscellaneous from least privileges or confinement (e.g. jail, in the sandbox, least permissions, unable to path traverse to private ssh keys) to privileged (e.g. root, outside the sandbox, full access permissions, able to path traverse to private ssh keys in home) |
