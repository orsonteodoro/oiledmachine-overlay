...
| Children's data                       | [4]                 | Anonymity, physical                     | AU, CN, EU, UK, US | Database, server, web browser                                                                         |
...
| Cookies (Session replay, behavioral)  | GDPR, [21]          | Discrimination, ownership, reputational | CN, EU/UK          | AI guardrails, debugging websites, malicious threat actor abuse, rate limiting, spying                |
| Cookies (Session tokens)              | GDPR, [14][21]      | Impersonation, ownership, reputational  | CN, EU/UK          | One time login, web                                                                                   |
| Contact info (address, phone)         | GDPR, [17]          | Emotional, physical                     | CA, EU/UK, US      | Address book app, database, server, web browser, word processor                                       |
...
| Email content                         | CCPA/CPRA (US-CA)   | Reputational                            | US                 | Database, LLMs, server, web browser                                                                   |
...
| IP or MAC addresses                   | GDPR, [6]           | Anonymity, discrimination, financial    | EU/UK, US          | Database, server, web browser                                                                         |
...
| Login / screen names                  | GDPR, [9]           | Emotional, financial, reputational      | US                 | Database, server, web browser                                                                         |
| Multi-factor Authentication (MFA/2FA) | PCI DSS, [11]       | Financial                               | Worldwide          | Cryptocurrency, fintech, login                                                                        |
| Password                              | GDPR, [10]          | Data theft, financial, reputational     | Worldwide          | Clipboard, crypto/auth libs, database, password managers, server, web browser                         |
...
| Physcial location                     | GDPR, [3]           | Physical                                | CN, EU/UK, UA, US  | Database, geolocation, GPS, server, web browser                                                       |
| Political                             | GDPR, PIPL          | Discrimination, physical                | CN, EU/UK, UA      | Database, server, web browser                                                                         |
