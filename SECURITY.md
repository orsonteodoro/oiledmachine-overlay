...
7. SB - Security Bypass
8. SBE - Sandbox Escape
9. ID - Information Disclosure
10. DT - Data Tampering
11. DoS - Denial of Service in less common use cases
...
| Browsing history                           | GDPR, [8]           | Discrimination                          | EU, US              | Web                                                                                                   |
...
cracking or actually have or pretend to have the keys and the ciphertext
in possesion during the breach.
...
SANDBOX_DENY="/home:/root:/boot/keys:/boot/documents:/media:/home/johndoe:/backup:/home/johndoe/bank:/home/johndoe/.ssh:/home/johndoe/Downloads:/home/johndoe/passwords.kdbx:/mnt/wallet:/backups"
```
...
| Path traversal                 | PT                    | Possibly reading of a sensitive files, secrets, credentials, data theft, creating drop zones, zombification                                  |
| Privilege escalation           | PE                    | General or miscellaneous from least privileges or confinement (e.g. jail, in the sandbox, least permissions, unable to path traverse to private ssh keys or password database) to privileged (e.g. root, outside the sandbox, full access permissions, able to path traverse to private ssh keys or password database) |
