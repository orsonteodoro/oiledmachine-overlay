...
ROCK_V_MAX="4.2.0" # inclusive, limited by PKG_VER_ROCM_LLVM_MAJ
...
+opengl opengl_mesa +opengl_pro osmesa +pro-stack rocm strict-pairing
+system-llvm +system-llvm-roc system-roct system-hsa-rt +vaapi vaapi_r600
...
REQUIRED_USE="
	...
	vdpau? ( llvm open-stack ^^ ( vdpau_r300 vdpau_r600 vdpau_radeonsi ) )
	vdpau_r300? ( vdpau )
	vdpau_r600? ( vdpau )
