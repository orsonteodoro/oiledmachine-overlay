...
src_install() {
	...
	if use abi_x86_32 ; then
		exeinto /usr/lib32/opengl/amdgpu/lib/
		doexe opt/amdgpu/lib/i386-linux-gnu/BugpointPasses.so
		doexe opt/amdgpu/lib/i386-linux-gnu/libLLVM-7.so
		doexe opt/amdgpu/lib/i386-linux-gnu/libLTO.so.7
		doexe opt/amdgpu/lib/i386-linux-gnu/LLVMHello.so
		doexe opt/amdgpu/lib/i386-linux-gnu/TestPlugin.so
		exeinto /usr/lib32/opengl/amdgpu/lib/llvm-7.0/lib/
		doexe opt/amdgpu/lib/i386-linux-gnu/llvm-7.0/lib/BugpointPasses.so
		doexe opt/amdgpu/lib/i386-linux-gnu/llvm-7.0/lib/libLLVM-7.so
		doexe opt/amdgpu/lib/i386-linux-gnu/llvm-7.0/lib/libLTO.so.7
		doexe opt/amdgpu/lib/i386-linux-gnu/llvm-7.0/lib/LLVMHello.so
		doexe opt/amdgpu/lib/i386-linux-gnu/llvm-7.0/lib/TestPlugin.so
	fi
