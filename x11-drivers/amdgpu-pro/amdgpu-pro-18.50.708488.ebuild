...
IUSE="+gles2 +opencl +opengl openmax +vdpau +vaapi +vulkan hsa rocm rocr freesync pal orca vega +amf +egl wayland"
...
S="${WORKDIR}"
REQUIRED_USE="!rocm !rocr || ( pal orca rocm )" #incomplete
#!hsa
...
src_unpack() {
	...
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libglapi1-amdgpu-pro_18.50-708488_amd64.deb"
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libglapi-amdgpu-mesa_18.2.0-708488_amd64.deb"

	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libglapi1-amdgpu-pro_18.50-708488_i386.deb"
	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libglapi-amdgpu-mesa_18.2.0-708488_i386.deb"


	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/glamor-amdgpu_1.19.0-708488_amd64.deb"
	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/glamor-amdgpu_1.19.0-708488_i386.deb"

	# Pin version (contains version requirements)
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/amdgpu-pro-pin_18.50-708488_all.deb"
	...
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-client0_1.15.0-708488_amd64.deb"
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-egl1_1.15.0-708488_amd64.deb"
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-server0_1.15.0-708488_amd64.deb"
	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-cursor0_1.15.0-708488_amd64.deb"
	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-dev_1.15.0-708488_amd64.deb"
	if use abi_x86_32 ; then
		unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-client0_1.15.0-708488_i386.deb"
		unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-egl1_1.15.0-708488_i386.deb"
		unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-server0_1.15.0-708488_i386.deb"
		#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-cursor0_1.15.0-708488_i386.deb"
		#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-dev_1.15.0-708488_i386.deb"
	fi
	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/libwayland-amdgpu-doc_1.15.0-708488_all.deb"
	#unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/wayland-protocols-amdgpu_1.16-708488_all.deb"

	# todo llvm7
echo << EOF > /dev/null
libs
./libllvm7.0-amdgpu_7.0-708488_i386.deb : libllvm7.0-amdgpu
./libllvm7.0-amdgpu_7.0-708488_amd64.deb : libllvm7.0-amdgpu

devel
./llvm-amdgpu-7.0_7.0-708488_amd64.deb : llvm-amdgpu-7.0
./llvm-amdgpu-7.0-runtime_7.0-708488_amd64.deb : llvm-amdgpu-7.0-runtime min
./llvm-amdgpu-7.0-runtime_7.0-708488_i386.deb : llvm-amdgpu-7.0-runtime min
./llvm-amdgpu-runtime_7.0-708488_i386.deb : llvm-amdgpu-runtime default
./llvm-amdgpu_7.0-708488_i386.deb : llvm-amdgpu default
EOF
...
src_install() {
	...
	if use amf ; then
		exeinto /usr/lib64/opengl/amdgpu/lib
		doexe opt/amdgpu-pro/lib/x86_64-linux-gnu/libamfrt64.so.18.50
		dosym libamfrt64.so.18.50 /usr/lib64/opengl/amdgpu/lib/libamfrt64.so.18
		dosym libamfrt64.so.18.50 /usr/lib64/opengl/amdgpu/lib/libamfrt64.so
		dosym libamfrt64.so.18.50 /usr/lib64/opengl/amdgpu/lib/libamfrt64.so.1 # from Gentoo QA notice when installing
	fi

	# Install glamor
	exeinto /usr/lib64/opengl/amdgpu/modules/
	...
	exeinto /usr/lib64/opengl/amdgpu/lib/
	doexe opt/amdgpu/lib/x86_64-linux-gnu/BugpointPasses.so
	doexe opt/amdgpu/lib/x86_64-linux-gnu/libLLVM-7.so
	doexe opt/amdgpu/lib/x86_64-linux-gnu/libLTO.so.7
	doexe opt/amdgpu/lib/x86_64-linux-gnu/LLVMHello.so
	doexe opt/amdgpu/lib/x86_64-linux-gnu/TestPlugin.so
	exeinto /usr/lib64/opengl/amdgpu/lib/llvm-7.0/lib/
	doexe opt/amdgpu/lib/x86_64-linux-gnu/llvm-7.0/lib/BugpointPasses.so
	doexe opt/amdgpu/lib/x86_64-linux-gnu/llvm-7.0/lib/libLLVM-7.so
	doexe opt/amdgpu/lib/x86_64-linux-gnu/llvm-7.0/lib/libLTO.so.7
	doexe opt/amdgpu/lib/x86_64-linux-gnu/llvm-7.0/lib/LLVMHello.so
	doexe opt/amdgpu/lib/x86_64-linux-gnu/llvm-7.0/lib/TestPlugin.so
