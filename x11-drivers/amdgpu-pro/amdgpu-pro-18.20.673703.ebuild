...
HOMEPAGE="https://www.amd.com/en/support/kb/release-notes/rn-prorad-lin-18-20"
PKG_VER=${PV:0:5}
PKG_REV=${PV:6:6}
PKG_ARCH="ubuntu"
PKG_ARCH_VER="18.04"
...
src_unpack() {
	...
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/xserver-xorg-amdgpu-video-amdgpu_1.4.0-${PKG_REV}_amd64.deb"
	...
	unpack_deb "amdgpu-pro-${PKG_VER_STRING_DIR}/ids-amdgpu_1.0.0-${PKG_REV}_all.deb"
}
