...
pkg_pretend() {
	...
	WARNING_DRM="CONFIG_DRM must be disabled or compiled as a module and not loaded for direct
		rendering to work."
...
src_prepare() {
	...
	epatch "${FILESDIR}/ati-drivers-15.11-cpu_has_pge-4.7.0-kernel.patch"
...
pkg_postinst() {
	...
	ewarn "To fix OpenCL emerge =dev-libs/ati-opencl-15.9 from the oiledmachine-overlay and eselect-opencl from the oiledmachine-overlay."
	ewarn "Then, switch to ocl-icd through eselect-opencl."
