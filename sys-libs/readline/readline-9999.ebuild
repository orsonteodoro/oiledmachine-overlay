...
CFLAGS_HARDENED_VULNERABILITY_HISTORY="AFO SYM"
...
inherit cflags-hardened flag-o-matic multilib multilib-minimal preserve-libs secure-version toolchain-funcs verify-sig
...
if [[ ${PV} == 9999 ]] ; then
	FALLBACK_COMMIT="553d6bb272f26400d6d4d1cac7c1df84c447449b"
	EGIT_BRANCH="master" # The distro is using the wrong branch.
...
RDEPEND=">=sys-libs/ncurses-${NCURSES_PV}:=[static-libs?,unicode(+)?,${MULTILIB_USEDEP}]"
DEPEND="${RDEPEND}"
BDEPEND="
	virtual/pkgconfig
