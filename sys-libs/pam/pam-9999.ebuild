...
CFLAGS_HARDENED_USE_CASES="login security-critical sensitive-data system-set untrusted-data"
CFLAGS_HARDENED_VULNERABILITY_HISTORY="AB AFC AFR CRSH DOS H ID PE RC SYM"
...
inherit cflags-hardened chkl db-use flag-o-matic meson-multilib secure-version user-info
...
DEPEND="
	...
	audit? ( >=sys-process/audit-${AUDIT_PV}:=[${MULTILIB_USEDEP}] )
