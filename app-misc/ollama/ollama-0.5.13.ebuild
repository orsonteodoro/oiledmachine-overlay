...
command-r-plus command-r7b command-r7b-arabic dbrx deepscaler deepseek-coder deepseek-coder-v2
deepseek-llm deepseek-r1 deepseek-v2 deepseek-v2.5 deepseek-v3 disinfozone-telos dolphin-llama3
...
orca2 paraphrase-multilingual partai-dorna-llama3 phi phi3 phi3.5 phi4 phi4-mini
...
#	KEYWORDS="~amd64 ~arm64" # Ebuild is still in development
	S="${WORKDIR}/${P}"
