...
Artalius-lixi aya bakllava artifish-mlewd-v2.4 benevolentjoker-belial
benevolentjoker-bethanygpt benevolentjoker-nsfwmonika
...
goliath granite-code granite3-dense granite3-moe hemanth-chessplayer hermes3
hookingai-monah-8b internlm2 jimscard-adult-film-screenwriter-nsfw
jimscard-whiterabbit-neo joefamous-grok-1 leeplenty-lumimaid-v0.2 llama-guard3
llama-pro llama2 llama2-chinese llama2-uncensored llama3 llama3-chatqa
llama3-gradient llama3-groq-tool-use llama3.1 llama3.2 llava llava-llama3
llava-phi3 magicoder mannix-replete-adapted-llama3-8b mannix-llamax3-8b-alpaca
mannix-smaug-qwen2-72b mannix-replete-coder-llama3-8b mathstral meditron
medllama2 megadolphin minicpm-v mistral mistral-large mistral-nemo
...
paraphrase-multilingual partai-dorna-llama3 phi phi3 phi3.5 phind-codellama qwen
qwen2 qwen2-math qwen2.5 qwen2.5-coder reader-lm reefer-her2 reefer-minimonica
reefer-monica reflection rfc-whiterabbitneo rouge-replete-coder-qwen2-1.5b
samantha-mistral sammcj-smaug-mixtral-v0.1 savethedoctor-whiterabbitneo13bq8_0
shieldgemma smollm snowflake-arctic-embed solar solar-pro sparksammy-samantha
sparksammy-samantha-3.1 sparksammy-samantha-eggplant
...
stablelm2 starcoder starcoder2 starling-lm themanofrod-travel-agent tinydolphin
...
"
PATCHES=(
	"${FILESDIR}/${PN}-0.3.14-hardcoded-paths.patch"
	...
	"${FILESDIR}/${PN}-0.3.14-nvcc-flags.patch"
)
...
# ld: /opt/rocm-6.1.2/lib/libamdhip64.so: undefined reference to `hsa_status_string'
	...
	if use cpu_flags_x86_avx512bw ; then
		...
		_NVCC_FLAGS+=" -Xcompiler -mavx512bw"
	fi
...
einfo "LDFLAGS: ${LDFLAGS}"
	...
	local cpu_args=()
	local gpu_args=()
	if use native || is-flagq '-march=native' ; then
