...
einfo "Generating lockfile"
	...
	cargo add "http@=1.2.0" --package "gst-plugin-speechmatics"
	cargo add "http@=1.2.0" --package "gst-plugin-webrtc"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-audiofx"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-closedcaption"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-flavors"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-ndi"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-mpegtslive"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-rtp"
	cargo add "smallvec@=1.14.0" --package "gst-plugin-sodium"
	cargo add "serde@=1.0.218" --package "gst-plugin-aws"
	cargo add "serde@=1.0.218" --package "gst-plugin-closedcaption"
	cargo add "serde@=1.0.218" --package "gst-plugin-fmp4"
	cargo add "serde@=1.0.218" --package "gst-plugin-json"
	cargo add "serde@=1.0.218" --package "gst-plugin-sodium"
	cargo add "serde@=1.0.218" --package "gst-plugin-speechmatics"
	cargo add "serde@=1.0.218" --package "gst-plugin-tracers"
	cargo add "serde@=1.0.218" --package "gst-plugin-webrtc"
	cargo add "serde@=1.0.218" --package "gst-plugin-webrtc-signalling-protocol"
	cargo add "serde@=1.0.218" --package "gst-plugin-webrtc-signalling"
	cargo add "tokio@=1.43.0" --package "gst-plugin-aws"
	cargo add "tokio@=1.43.0" --package "gst-plugin-inter"
	cargo add "tokio@=1.43.0" --package "gst-plugin-quinn"
	cargo add "tokio@=1.43.0" --package "gst-plugin-reqwest"
	cargo add "tokio@=1.43.0" --package "gst-plugin-rtp"
	cargo add "tokio@=1.43.0" --package "gst-plugin-rtsp"
	cargo add "tokio@=1.43.0" --package "gst-plugin-speechmatics"
	cargo add "tokio@=1.43.0" --package "gst-plugin-spotify"
	cargo add "tokio@=1.43.0" --package "gst-plugin-tracers"
	cargo add "tokio@=1.43.0" --package "gst-plugin-webrtchttp"
	cargo add "tokio@=1.43.0" --package "gst-plugin-webrtc"
	cargo add "tokio@=1.43.0" --package "gst-plugin-webrtc-signalling"
	die
}
