...
declare -A CARGO_PATHS=(
	...
	[gdk4-win32]="gtk4-rs-%commit%/gdk4-win32"
	[gdk4-win32-sys]="gtk4-rs-%commit%/gdk4-win32/sys"
	...
	[gstreamer-allocators-sys]="gstreamer-rs-%commit%/gstreamer-allocators/sys"
	[gstreamer-allocators]="gstreamer-rs-%commit%/gstreamer-allocators"
	[gstreamer-analytics-sys]="gstreamer-rs-%commit%/gstreamer-analytics/sys"
	[gstreamer-analytics]="gstreamer-rs-%commit%/gstreamer-analytics"
	...
	[gstreamer-tag]="gstreamer-rs-%commit%/gstreamer-tag"
	[gstreamer-tag-sys]="gstreamer-rs-%commit%/gstreamer-tag/sys"
	[gstreamer-utils]="gstreamer-rs-%commit%/gstreamer-utils"
	[gstreamer-validate]="gstreamer-rs-%commit%/gstreamer-validate"
	[gstreamer-validate-sys]="gstreamer-rs-%commit%/gstreamer-validate/sys"
