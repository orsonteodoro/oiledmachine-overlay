...
inherit check-compiler-switch cmake crossdev flag-o-matic flag-o-matic-om libstdcxx-slot llvm llvm.org python-any-r1
inherit toolchain-funcs

KEYWORDS="
amd64 arm arm64 ~loong ppc64 ~riscv x86 ~arm64-macos ~x64-macos
"
