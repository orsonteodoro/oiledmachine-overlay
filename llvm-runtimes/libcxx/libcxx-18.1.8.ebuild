...
inherit check-compiler-switch cflags-hardened cmake-multilib flag-o-matic libcxx-slot libstdcxx-slot llvm.org llvm-utils python-any-r1 toolchain-funcs
...
einfo "Detected compiler switch.  Disabling LTO."
	...
	# Match Chromium's default security level
