...
# See https://gitlab.freedesktop.org/mesa/mesa/-/blob/mesa-25.1.9/.gitlab-ci/container/gitlab-ci.yml?ref_type=tags
...
CFLAGS_HARDENED_VULNERABILITY_HISTORY="AFW BO BOR DOS IO NPD OOBA SYM"
CXX_STANDARD=17
