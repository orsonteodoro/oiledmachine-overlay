...
#   https://github.com/AcademySoftwareFoundation/OpenShadingLanguage/blob/v1.13.2.2-dev/src/cmake/externalpackages.cmake
QT5_MIN="5.6"
PATCHES=(
)
...
"
SRC_URI="
https://github.com/AcademySoftwareFoundation/OpenShadingLanguage/archive/refs/tags/v${MY_PV}.tar.gz
	-> ${P}.tar.gz
"
