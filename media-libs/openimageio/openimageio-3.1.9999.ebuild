...
# Requirements:
# https://github.com/AcademySoftwareFoundation/OpenImageIO/blob/dev-3.1/INSTALL.md
...
RDEPEND+="
	...
	openvdb? (
		=media-gfx/openvdb-13*:=[${LIBCXX_USEDEP},${LIBSTDCXX_USEDEP}]
		tbb? (
