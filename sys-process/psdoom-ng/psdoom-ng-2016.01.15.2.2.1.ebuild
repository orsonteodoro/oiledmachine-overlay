...
"
IUSE="psdoom-wads"
SRC_URI="https://github.com/chocolate-doom/chocolate-doom/archive/chocolate-doom-2.2.1.tar.gz"

S="${WORKDIR}/chocolate-doom-chocolate-doom-2.2.1"
src_unpack() {
	unpack "chocolate-doom-2.2.1.tar.gz"
	cd "${S}"
	epatch "${FILESDIR}"/psdoom-ng-2016.01.15.2.2.1.patch
