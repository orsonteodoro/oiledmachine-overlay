...
einfo "QA:  Change \"serialize-javascript\": \"^4.0.0\" to \"serialize-javascript\": \"^7.1.1\" in package-lock.json"
...
# OILEDMACHINE-OVERLAY-TEST:  PASSED (interactive) 5.1.6 (20260917 with Electron 44.4.1)
