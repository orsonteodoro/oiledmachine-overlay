...
#   grep "resolved" /var/tmp/portage/media-gfx/blockbench-4.9.4/work/blockbench-4.9.4/package-lock.json | cut -f 4 -d '"' | cut -f 1 -d "#" | sort | uniq
...
https://registry.npmjs.org/@types/webxr/-/webxr-0.5.15.tgz -> npmpkg-@types-webxr-0.5.15.tgz
...
https://registry.npmjs.org/electron/-/electron-26.6.10.tgz -> npmpkg-electron-26.6.10.tgz
