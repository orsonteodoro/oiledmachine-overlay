...
# This Firejail profile is for the sheepit-client using tarballs from the Sheep
# it service.
...
#1234567890123456789012345678901234567890123456789012345678901234567890123456789
# Blocked for now because the vanilla tarballs are assumed to be working.
# For dependencies of extra libs added by the Sheep it service:
#private-lib gcc,libasound.so.*,libasyncns.so.*,libbsd.so.*,libc.so.*
#private-lib libcaca.so.*,libdbus-*.so.*,libdirect-*.so.*,libdirectfb-*.so.*
#private-lib libdl.so.*,libFLAC.so.*,libfusion-*.so.*,libglapi.so.*,
#private-lib libGL.so.*,libGLX.so.*,libGLdispatch.so.*,libICE.so.*,libm.so.*
#private-lib libncursesw.so.*,libogg.so.*,libopus.so.*,libpthread.so.*
#private-lib libpulsecommon-*.*,libpulse.so.*,libpulse-simple.so.*
#private-lib libresolv.so.*,librt.so.*,libSM.so.*,libslang.so.*,libsndfile.so.*
#private-lib libstdc++.so.*,libtinfo.so.*,libtinfow.so.*,libts-0.0.so.*
#private-lib libuuid.so.*,libvorbisenc.so.*,libvorbis.so.*,libwrap.so.*
