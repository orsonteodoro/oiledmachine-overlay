...
IUSE="aalib dia djvu exif fbcon gif graphicsmagick imagemagick jpeg pdf png postscript readline sdl static svg tiff xfig font"
...
src_prepare() {
	eapply "${FILESDIR}/${P}-poppler031.patch"
...
src_install() {
	...
	if use font ; then
		...
		cp "${S}/var/fonts/Lat15-Terminus16.psf" "${D}/usr/share/${PN}"
	fi
}
